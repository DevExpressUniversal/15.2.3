	...
	class CodedUIMessagesHandler {
		...
		protected static DXControlsSupported GetCodedUIEnum(object control) {
			if(!controlsAddedToDictionary) {
				ControlsToCodedUIEnum.Add(typeof(TreeList), DXControlsSupported.TreeList);
				ControlsToCodedUIEnum.Add(typeof(TreeListCustomizationListBox), DXControlsSupported.TreeListCustomizationListBox);
				ControlsToCodedUIEnum.Add(typeof(TreeListCustomizationForm), DXControlsSupported.TreeListCustomizationForm);
