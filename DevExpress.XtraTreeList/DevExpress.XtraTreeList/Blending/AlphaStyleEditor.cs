...
namespace DevExpress.XtraTreeList.Blending {
	internal class AlphaStyleEditor : DevExpress.XtraEditors.XtraForm {
		...
		public AlphaStyleEditor(AlphaStyles styles, IServiceProvider provider, TreeList treeList) {
			InitializeComponent();
			defaultFont = (Font)lblPreview.Font.Clone();
			this.provider = provider;
			if(treeList == null) {
				this.treeList = ((XtraTreeListBlending)styles.parent).TreeListControl;
				isRefresh = true;
			} else this.treeList = treeList;
			if(this.treeList == null) {
				btnOpenNewBitmap.Enabled = false;
				xtraTabControl1.SelectedTabPageIndex = 1;
			} else 
				pnlImage.BackgroundImage = this.treeList.BackgroundImage;
		...
		private void FillStyles() {
			if(treeList != null) {
				string s = "";
				for(int i = 0; i < XtraTreeListBlending.defaultStyleNames.Length; i++) { 
					s = XtraTreeListBlending.defaultStyleNames[i];
					AppearanceObject obj = treeList.ViewInfo.PaintAppearance.GetAppearance(s);
		...
		private void InitializeComponent() {
			...
			this.btnCancel.Location = new System.Drawing.Point(196, 251);
			this.btnCancel.Name = "btnCancel";
			this.btnCancel.Size = new System.Drawing.Size(68, 23);
			this.btnCancel.TabIndex = 2;
			this.btnCancel.Text = "&Cancel";
			this.btnOK.DialogResult = System.Windows.Forms.DialogResult.OK;
			this.btnOK.Location = new System.Drawing.Point(124, 251);
			this.btnOK.Name = "btnOK";
			this.btnOK.Size = new System.Drawing.Size(68, 23);
			this.btnOK.TabIndex = 1;
			this.btnOK.Text = "&OK";
			this.btnOK.Click += new System.EventHandler(this.btnOK_Click);
			this.btnClearPicture.Location = new System.Drawing.Point(190, 36);
			...
			this.btnOpenNewBitmap.Location = new System.Drawing.Point(190, 8);
			...
			this.pnlImage.Size = new System.Drawing.Size(176, 204);
			this.pnlImage.TabIndex = 0;
			this.pnlImage.BackgroundImageChanged += new System.EventHandler(this.pnlImage_BackgroundImageChanged);
			this.btnDefault.Location = new System.Drawing.Point(137, 186);
			...
			this.pnlPreview.Location = new System.Drawing.Point(138, 101);
			this.pnlPreview.Name = "pnlPreview";
			this.pnlPreview.Size = new System.Drawing.Size(120, 79);
			...
			this.lblPreview.Size = new System.Drawing.Size(120, 79);
			...
			0,
			0});
			this.numStyles.Location = new System.Drawing.Point(190, 54);
			...
			this.tbStyles.Location = new System.Drawing.Point(134, 4);
			...
			this.xtraTabControl1.Size = new System.Drawing.Size(271, 245);
			...
			this.xtraTabPage1.Size = new System.Drawing.Size(265, 219);
			...
			this.xtraTabPage2.Size = new System.Drawing.Size(265, 219);
		...
		private Font PreviewFont(DevExpress.XtraEditors.ListBoxControl lb) {
			if(treeList == null || lb.SelectedIndices.Count != 1)
				return defaultFont;
			else 
				return (Font)treeList.ViewInfo.PaintAppearance.GetAppearance(lb.SelectedItem.ToString()).Font.Clone();
		}
		private Color PreviewBackColor(DevExpress.XtraEditors.ListBoxControl lb) {
			if(treeList == null || lb.SelectedIndices.Count != 1)
				...
				return Color.FromArgb(tbStyles.Value, treeList.ViewInfo.PaintAppearance.GetAppearance(lb.SelectedItem.ToString()).BackColor);
		}
		private Color PreviewForeColor(DevExpress.XtraEditors.ListBoxControl lb) {
			if(treeList == null || lb.SelectedIndices.Count != 1)
				return SystemColors.WindowText;
			else 
				return treeList.ViewInfo.PaintAppearance.GetAppearance(lb.SelectedItem.ToString()).ForeColor;
		}
		private void btnOK_Click(object sender, System.EventArgs e) {
			Apply();
		}
		private void Apply() {
			if(((XtraTreeListBlending)mainStyles.parent).TreeListControl != null) 
				((XtraTreeListBlending)mainStyles.parent).TreeListControl.BackgroundImage = pnlImage.BackgroundImage;
			...
			if(provider != null) { 
				...
				((XtraTreeListBlending)styles.parent).RefreshStyles();
			}
			if(!isRefresh) {
				((XtraTreeListBlending)styles.parent).RefreshStyles();
				treeList.BackgroundImage = pnlImage.BackgroundImage;
			}
			SetEnabled(false);
		}
		...
		private void btnDefault_Click(object sender, System.EventArgs e) {
			XtraTreeListBlending.FillAlphaStyles(styles, XtraTreeListBlending.defaultStyleNames, XtraTreeListBlending.defaultAlpha);
			lockStyles = true;
