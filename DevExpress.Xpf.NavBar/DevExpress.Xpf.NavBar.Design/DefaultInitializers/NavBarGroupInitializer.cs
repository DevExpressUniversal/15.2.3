...
namespace DevExpress.Xpf.NavBar.Design {
	class NavBarGroupInitializer : DefaultInitializer {
		public override void InitializeDefaults(ModelItem item, Microsoft.Windows.Design.EditingContext context) {
			...
			if(string.IsNullOrEmpty(item.Name))
				item.Properties["Name"].SetValue(BarManagerDesignTimeHelper.GetUniqueName(item));
			item.Properties["Header"].SetValue(item.Name);
		}
	}
}
