...
namespace DevExpress.XtraReports.Web.Azure.WebDocumentViewer {
	public interface IAzureFileStorageManager {
		Stream GetDocument(string path);
		string SaveDocument(string fileName, Stream documentStream);
		void DeleteDocument(string path);
		Stream GetReport(string path);
		string SaveReport(string fileName, Stream reprotStream);
