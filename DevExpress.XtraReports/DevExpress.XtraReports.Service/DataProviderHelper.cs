...
namespace DevExpress.XtraReports.Service {
	public static class DataProviderHelper {
		public static DbConnectionDataProvider CreateDbConnectionDataProvider(string connectionString) {
			IDisposable[] disposableObjectCollection = null;
			IDataStore dataStore = XpoDefault.GetConnectionProvider(connectionString, AutoCreateOption.None, out disposableObjectCollection);
			IDataStoreSchemaExplorer schemaExplorer = (IDataStoreSchemaExplorer)dataStore;
			return new DbConnectionDataProvider(
