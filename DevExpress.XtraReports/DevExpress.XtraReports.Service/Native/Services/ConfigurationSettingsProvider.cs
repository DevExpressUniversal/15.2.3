...
namespace DevExpress.XtraReports.Service.Native.Services {
	public class ConfigurationSettingsProvider : IConfigurationSettingsProvider {
		...
		public ConfigurationSettingsProvider() {
			configurationSettings = new PermissionChecker(new ConfigurationPermission(PermissionState.Unrestricted)).IsPermissionGranted
				? (IConfigurationSettings)new ConfigurationSettings()
				: new StubConfigurationSettings();
		}
