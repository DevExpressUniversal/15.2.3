...
namespace DevExpress.XtraReports.Service.Native.Services {
	public interface IIntermediateReportService {
		#region IReportService
		ReportParameterContainer GetReportParameters(InstanceIdentity instanceIdentity, IDelegateOverriddenFunctionalityReportService functionality);
		ParameterLookUpValues[] GetLookUpValues(InstanceIdentity instanceIdentity, ReportParameter[] parameterValues, string[] requiredParameterPaths, IDelegateOverriddenFunctionalityReportService functionality);
		DocumentId StartBuild(InstanceIdentity instanceIdentity, ReportBuildArgs buildArgs, IDelegateOverriddenFunctionalityReportService functionality);
