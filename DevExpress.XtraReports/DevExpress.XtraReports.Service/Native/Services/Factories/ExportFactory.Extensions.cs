...
namespace DevExpress.XtraReports.Service.Native.Services.Factories {
	public static class ExportFactoryExtensions {
		public static IExportMediator CreateExportMediator(this IExportFactory service, ExportId exportId) {
			return service.CreateExportMediator(exportId, MediatorInitialization.Exist);
		}
	}
}
