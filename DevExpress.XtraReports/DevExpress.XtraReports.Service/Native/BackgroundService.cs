...
namespace DevExpress.XtraReports.Service.Native {
	class BackgroundService : IBackgroundService {
		readonly IDocumentMediator mediator;
		readonly XtraReport report;
		bool isStopping;
		public BackgroundService(IDocumentMediator mediator, XtraReport report) {
			this.mediator = mediator;
			this.report = report;
		}
		public virtual void PerformAction() {
			if(!isStopping && mediator.DocumentRequestingAction == RequestingAction.Stop) {
