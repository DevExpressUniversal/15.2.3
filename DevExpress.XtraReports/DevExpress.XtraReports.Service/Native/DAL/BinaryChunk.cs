...
namespace DevExpress.XtraReports.Service.Native.DAL {
	public class BinaryChunk : ExtendedXPObject, IBinaryContentProvider {
		BinaryChunkOwner owner;
		public BinaryChunk(Session session)
			: base(session) {
		}
		[Delayed]
		public byte[] Content {
		...
		[Association(BinaryChunkOwner.BinaryChunkToBinaryChunkOwnerAssociationName)]
		public BinaryChunkOwner Owner {
			get { return owner; }
