...
namespace DevExpress.XtraReports.Web.Native.ParametersPanel {
	class DesignTimeParametersProvider : IParametersProvider {
		...
		public ASPxParameterInfo[] GetParameters(Func<ParameterPath, ASPxEditBase, ASPxParameterInfo> map) {
			var parameter = new Parameter { Name = "parameter" };
			var parameterInfo = new ASPxParameterInfo(parameter, parameter.Name, new ASPxTextBox(), null);
