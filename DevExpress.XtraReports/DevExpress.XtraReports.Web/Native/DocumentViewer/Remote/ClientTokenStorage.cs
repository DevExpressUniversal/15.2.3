...
namespace DevExpress.XtraReports.Web.Native.DocumentViewer.Remote {
	public class ClientTokenStorage : ITokenStorage {
		...
		readonly Action<string> onReceiveToken;
		internal ClientTokenStorage(RSRemoteDocumentInformation rsRemoteDocumentInformation, Action<string> onReceiveToken) {
			...
			this.onReceiveToken = onReceiveToken;
		}
		public string Token {
			get { return rsRemoteDocumentInformation.Token; }
			set {
				rsRemoteDocumentInformation.Token = value;
