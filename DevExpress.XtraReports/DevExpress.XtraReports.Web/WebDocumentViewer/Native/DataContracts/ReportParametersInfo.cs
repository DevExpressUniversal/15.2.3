...
namespace DevExpress.XtraReports.Web.WebDocumentViewer.Native.DataContracts {
	[DataContract]
	public class ReportParametersInfo : IKnownTypes {
		public ReportParametersInfo() {
		}
		public ReportParametersInfo(Type[] knownTypes) {
			KnownTypes = knownTypes;
		}
		[DataMember(Name = "parameters")]
		public TypedReportParameter[] Parameters { get; set; }
		[DataMember(Name = "shouldRequestParameters")]
		public bool ShouldRequestParameters { get; set; }
		[DataMember(Name = "knownEnums")]
