...
namespace DevExpress.XtraReports.Web.WebDocumentViewer.Native.Services {
	public class DocumentBuilder : IDocumentBuilder {
		...
		public DocumentBuilder(IReportHashCodeGenerator reportHashCodeGenerator, IDocumentManagementService documentManagementService, IDocumentStorage documentStorage, UrlResolver urlResolver) {
