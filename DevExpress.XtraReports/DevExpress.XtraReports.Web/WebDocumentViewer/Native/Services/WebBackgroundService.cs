...
namespace DevExpress.XtraReports.Web.WebDocumentViewer.Native.Services {
	public class WebBackgroundService : IBackgroundService {
		readonly PrintingSystemBase printingSystem;
		Func<bool> isCancellationRequested;
		bool stopped;
		public WebBackgroundService(PrintingSystemBase printingSystem, Func<bool> isCancellationRequested) {
			this.printingSystem = printingSystem;
			this.isCancellationRequested = isCancellationRequested;
		}
		public void PerformAction() {
			if(!stopped && this.isCancellationRequested()) {
				if(printingSystem != null && printingSystem.Document != null)
