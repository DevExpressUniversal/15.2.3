...
namespace DevExpress.XtraReports.Web.DocumentViewer.Ribbon {
	public class DocumentViewerRibbonToggleButtonBase : RibbonToggleButtonItem {
		...
		protected override string GetSubGroupName() {
			return string.IsNullOrEmpty(base.SubGroupName) ? DefaultGroupName : base.GetSubGroupName();
		}
