...
namespace DevExpress.XtraReports.Web {
	public class ReportDesignerClientSideEvents : CallbackClientSideEventsBase {
		const string
			SaveCommandExecuteName = "SaveCommandExecute",
...
#if !SL
	[DevExpressXtraReportsWebLocalizedDescription("ReportDesignerClientSideEventsCustomizeMenuActions")]
#endif
		[DefaultValue("")]
		[NotifyParentProperty(true)]
		[Editor("DevExpress.Web.Design.CommonDesignerEditor, " + AssemblyInfo.SRAssemblyWebDesignFull, typeof(UITypeEditor))]
