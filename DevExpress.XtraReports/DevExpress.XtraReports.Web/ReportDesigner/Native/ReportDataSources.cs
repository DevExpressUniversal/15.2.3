...
namespace DevExpress.XtraReports.Web.ReportDesigner.Native {
	public class ReportDataSources {
		public Dictionary<string, DataSourceRefInfo[]> DataSourceRefs { get; private set; }
		public IDictionary<string, object> DataSources { get; private set; }
		public ReportDataSources(Dictionary<string, DataSourceRefInfo[]> dataSourceRefs, IDictionary<string, object> dataSources) {
