...
namespace DevExpress.XtraReports.Web.ReportDesigner.Native.DataContracts {
	[DataContract]
	public class WizardGeneratedReportDesignerModel {
		[DataMember(Name = "reportModel")]
		public string ReportModelJson { get; set; }
		[DataMember(Name = "dataSourceRefs")]
		public DataSourceRefInfo[] DataSourceRefInfo { get; set; }
	}
}
