...
namespace DevExpress.XtraReports.Web.ReportDesigner.Native.DataContracts {
	...
	public class RequestState {
		[DataMember(Name = "reportExtensions")]
		public Dictionary<string, string> ReportExtensions { get; set; }
	}
	public static class RequestStateExtensions {
		public static Dictionary<string, string> SafeGetReportExtensions(this RequestState state) {
			return state != null ? state.ReportExtensions : null;
		}
	}
}
