...
namespace DevExpress.XtraReports.Web.ReportDesigner.Native.Services {
	public interface IReportScriptsService {
		ScriptsErrorModel[] Validate(string reportLayout);
		ScriptsCompleteModel[] GetCompleters(ReportScriptsIntellisenseContract model);
	}
}
