...
namespace DevExpress.XtraReports.ReportGeneration.Wizard.Presenters {
	public class WizardOptionsStylesPage<TModel> : WizardPageBase<IWizardViewOptionsStyles, TModel> where TModel : ReportGridDataModel {
		public WizardOptionsStylesPage(IWizardViewOptionsStyles view) : base(view){
		...
		protected virtual void UpdateReportPreview(object sender){
			((IWizardViewOptionsStyles) sender).Report = Model.GetFakedReportWithStyles(View.Options);
		}
		...
		public override Type GetNextPageType(){
			return typeof(WizardEndPage<TModel>);
		}
