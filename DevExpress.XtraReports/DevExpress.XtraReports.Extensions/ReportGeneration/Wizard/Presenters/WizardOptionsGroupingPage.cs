...
namespace DevExpress.XtraReports.ReportGeneration.Wizard.Presenters {
	public class WizardOptionsGroupingPage<TModel> : WizardPageBase<IWizardViewOptionsGrouping, TModel> where TModel : ReportGridDataModel {
		public WizardOptionsGroupingPage(IWizardViewOptionsGrouping view) : base(view){
		...
		protected virtual void UpdateReportPreview(object sender){
			((IWizardViewOptionsGrouping) sender).Report = Model.GetGroupedFakedReport(View.Options);
		}
		...
		public override Type GetNextPageType(){
			return typeof(WizardOptionsStylesPage<TModel>);
		}
