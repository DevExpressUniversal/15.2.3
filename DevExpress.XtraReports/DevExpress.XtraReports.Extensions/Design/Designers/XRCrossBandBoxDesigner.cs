...
namespace DevExpress.XtraReports.Design {
	[MouseTarget(typeof(CrossBandBoxMouseTarget))]
	public class XRCrossBandBoxDesigner : XRCrossBandControlDesigner {
		public override Size DefaultControlSize {
			get { return new Size(50, 50); }
		}
		protected override void RegisterActionLists(DesignerActionListCollection list) {
			list.Add(new XRCrossBandBoxDesignerActionList(this));
		...
		protected override string[] GetFilteredProperties() {
			return new string[] { XRComponentPropertyNames.BackColor };
		}
	}
}
