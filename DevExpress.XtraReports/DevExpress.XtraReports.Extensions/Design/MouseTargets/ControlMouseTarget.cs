...
namespace DevExpress.XtraReports.Design.MouseTargets {
	public class ControlMouseTarget : MouseTargetBase {
		public ControlMouseTarget(XRControl xrControl, IServiceProvider servProvider)
		...
		public override bool ContainsPoint(Point pt, BandViewInfo viewInfo) {
			...
			return adapter.GetClientBandBounds(viewInfo).Contains(pt);
		}
	}
}
