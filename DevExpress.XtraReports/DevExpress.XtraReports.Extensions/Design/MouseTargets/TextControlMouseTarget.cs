...
namespace DevExpress.XtraReports.Design.MouseTargets {
	class TextControlMouseTarget : ControlMouseTarget {
		new XRTextControlDesigner Designer {
			get { return (XRTextControlDesigner)base.Designer; }
		}
		public TextControlMouseTarget(XRControl xrControl, IServiceProvider servProvider)
