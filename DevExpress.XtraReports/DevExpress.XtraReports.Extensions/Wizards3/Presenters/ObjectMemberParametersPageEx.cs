...
namespace DevExpress.XtraReports.Wizards3.Presenters {
	class ObjectMemberParametersPageEx<TModel> : ObjectMemberParametersPage<TModel> where TModel : XtraReportModel {
		...
		#region Overrides of ObjectMemberParametersPage<TModel>
