...
namespace DevExpress.XtraReports.Wizards3.Presenters {
	...
	{
		public ConfigureQueryPageEx(IConfigureQueryPageView view, IWizardRunnerContext context, SqlWizardOptions options, IDBSchemaProvider dbSchemaProvider, IParameterService parameterService, ICustomQueryValidator customQueryValidator) : base(view, context, options, dbSchemaProvider, parameterService, customQueryValidator) { }
		...
		public override Type GetNextPageType() {
			return IsSchemaReady ? typeof(SelectColumnsPage<TModel>) : typeof(ConfigureSqlParametersPage<TModel>);
		}
	}
}
