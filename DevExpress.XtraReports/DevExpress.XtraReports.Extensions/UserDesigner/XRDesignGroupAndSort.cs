...
namespace DevExpress.XtraReports.UserDesigner {
	...
	public class XRDesignGroupAndSort : GroupSortUserControl, IDesignControl {
	...
	DevExpressXtraReportsExtensionsLocalizedDescription("XRDesignGroupAndSortXRDesignPanel"),
		...
		public XRDesignGroupAndSort() : base() {
			this.treeListItemHelper = new XRDesignTreeListItemHelper(ReportToolItemKindHelper.GroupAndSort, this);
		}
