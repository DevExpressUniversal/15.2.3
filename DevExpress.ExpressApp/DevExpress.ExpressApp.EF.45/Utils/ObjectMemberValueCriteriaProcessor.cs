...
namespace DevExpress.ExpressApp.EF.Utils {
	public class ObjectMemberValueCriteriaProcessor : CriteriaProcessorBase {
		...
		protected override void Process(OperandProperty operand) {
			...
			if((memberInfo != null) && (memberInfo.MemberTypeInfo.IsDomainComponent)) {
		...
		protected override void Process(AggregateOperand operand) {
			...
			ObjectMemberValueCriteriaProcessor aggregatedCriteriaProcessor = new ObjectMemberValueCriteriaProcessor(typesInfo, collectionElementType);
