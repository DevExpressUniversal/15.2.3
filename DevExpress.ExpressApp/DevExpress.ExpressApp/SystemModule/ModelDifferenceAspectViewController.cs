...
namespace DevExpress.ExpressApp.SystemModule {
	public class ModelDifferenceAspectViewController : ViewController {
		...
		public ModelDifferenceAspectViewController()
			: base() {
			TypeOfView = typeof(ObjectView);
			TargetViewNesting = Nesting.Any;
			TargetObjectType = typeof(IModelDifferenceAspect);
		}
	}
}
