...
namespace DevExpress.ExpressApp.Editors {
	...
	public interface IComplexListEditor {
		void Setup(CollectionSourceBase collectionSource, XafApplication application);
	}
	public interface IDetailViewItemsHolder {
		IList<ViewItem> Items { get; }
	}
	public interface IActionSource {
		IList<ActionBase> Actions { get; }
	}
	public interface ISupportViewShowing {
