...
namespace DevExpress.ExpressApp.Model.NodeGenerators {
	public static class ModelNodeIdHelper {
		public static string GetTypeId(Type type) {
			return ModelBOModelClassNodesGenerator.GetTypeId(type);
		}
		...
		public static string GetNestedListViewId(Type type, string propertyName) {
			return ModelNestedListViewNodesGeneratorHelper.GetNestedListViewId(type, propertyName);
		}
	}
}
