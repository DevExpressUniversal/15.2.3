...
namespace DevExpress.ExpressApp.EF {
	public class EFServerCollection : ILinqServerModeFrontEndOwner, IListSource {
		...
		private ServerModeSourceAdderRemover serverModeSourceAdderRemover;
		private void InitQueryableSource() {
			...
			queryableSource = objectSpace.GetObjectsQuery(objectType, memberNames, criteria, null);
		}
		public EFServerCollection(EFObjectSpace objectSpace, Type objectType, CriteriaOperator criteria, IList<SortProperty> sorting) {
			...
			serverModeSourceAdderRemover = new ServerModeSourceAdderRemover(entityServerModeFrontEnd, objectSpace, objectType);
			InitQueryableSource();
