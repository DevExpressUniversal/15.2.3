...
namespace DevExpress.ExpressApp.EF.Utils {
	public class ServerModeSourceAdderRemover : IListServer, IListServerHints, IBindingList, ITypedList, IDXCloneable {
		...
		public ServerModeSourceAdderRemover(Object serverModeSource, EFObjectSpace objectSpace, Type objectType) {
			...
			foreach(IMemberInfo memberInfo in EFObjectSpace.GetDefaultDisplayableMembers(typeInfo)) {
		...
		public Object DXClone() {
			...
			return new ServerModeSourceAdderRemover(dxCloneable.DXClone(), objectSpace, objectType);
		}
	}
}
