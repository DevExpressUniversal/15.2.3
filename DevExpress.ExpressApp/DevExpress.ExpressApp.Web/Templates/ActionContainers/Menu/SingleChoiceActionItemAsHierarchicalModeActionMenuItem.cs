...
namespace DevExpress.ExpressApp.Web.Templates.ActionContainers.Menu {
	public class SingleChoiceActionItemAsHierarchicalModeActionMenuItem : SingleChoiceActionItemAsOperationActionMenuItem {
		public SingleChoiceActionItemAsHierarchicalModeActionMenuItem(SingleChoiceAction action)
			: base(action) {
		...
		private void action_SelectedItemChanged(object sender, EventArgs e) {
			MenuChoiceActionHelper.UpdateSelectedItem(MenuItem.Items);
		}
