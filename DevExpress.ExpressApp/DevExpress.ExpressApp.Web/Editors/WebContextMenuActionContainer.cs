...
namespace DevExpress.ExpressApp.Web.Editors {
	public class WebContextMenuActionContainer : IActionContainer {
		private string name = "PopupMenu";
		private List<ActionBase> actions = new List<ActionBase>();
		public WebContextMenuActionContainer() { }
		public WebContextMenuActionContainer(string name) {
			this.name = name;
		}
