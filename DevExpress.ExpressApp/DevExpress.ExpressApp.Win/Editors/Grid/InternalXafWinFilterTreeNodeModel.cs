...
namespace DevExpress.ExpressApp.Win.Editors {
	class InternalXafWinFilterTreeNodeModel : WinFilterTreeNodeModelBase {
		...
		public FilterColumnCollection CreateFilterColumnCollection() {
			FilterColumnCollection result = (FilterColumnCollection)FilterProperties;
			object sourceControl = SourceControl;
