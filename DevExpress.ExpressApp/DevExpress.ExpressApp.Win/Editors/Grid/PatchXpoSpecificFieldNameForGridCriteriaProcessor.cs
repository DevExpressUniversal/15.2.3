...
namespace DevExpress.ExpressApp.Win.Editors {
	class PatchXpoSpecificFieldNameForGridCriteriaProcessor : DevExpress.Persistent.Base.CriteriaProcessorBase {
		System.Collections.Generic.List<string> existingLookupFieldNames;
		public PatchXpoSpecificFieldNameForGridCriteriaProcessor(System.Collections.Generic.List<string> existingLookupFieldNames) {
