...
namespace DevExpress.ExpressApp.Win.Editors {
	public class CreateCustomColumnEventArgs : EventArgs {
		private IGridColumnModelSynchronizer gridColumnInfo;
		private GridColumn column;
		private IModelColumn modelColumn;
		private ITypeInfo objectTypeInfo;
		public CreateCustomColumnEventArgs(IModelColumn modelColumn, ITypeInfo objectTypeInfo) {
