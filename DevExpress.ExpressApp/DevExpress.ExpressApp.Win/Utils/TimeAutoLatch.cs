...
namespace DevExpress.ExpressApp.Win.Utils {
	public class TimeLatch {
		...
		public static int DefaultTimeout = SystemInformation.DoubleClickTime;
		public TimeLatch() {
		...
		public bool IsTimeIntervalExpired {
			get {
				return (((DateTime.Now.Ticks - lastEventTicks) / TimeSpan.TicksPerMillisecond) > timeoutInMilliseconds || (DateTime.Now.Ticks - lastEventTicks) < 0);
			}
		}
	}
}
