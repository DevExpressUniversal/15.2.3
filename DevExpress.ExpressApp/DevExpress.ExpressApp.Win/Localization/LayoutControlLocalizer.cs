...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraLayout Control")]
	public class LayoutControlLocalizer : DevExpress.XtraLayout.Localization.LayoutResLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						...
						"DevExpress.XtraLayout.LocalizationRes",
						"LayoutStringId.",
						typeof(DevExpress.XtraLayout.Localization.LayoutResLocalizer).Assembly);
				}
