...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraBars DocumentManager Control")]
	public class DocumentManagerControlLocalizer : DevExpress.XtraBars.Docking2010.DocumentManagerResXLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						...
						"DevExpress.XtraBars.Docking2010.LocalizationRes",
						"DocumentManagerStringId.",
						typeof(DevExpress.XtraBars.Docking2010.DocumentManagerResXLocalizer).Assembly);
				}
