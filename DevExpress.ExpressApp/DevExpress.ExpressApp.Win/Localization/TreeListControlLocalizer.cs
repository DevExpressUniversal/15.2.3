...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraTreeList Control")]
	public class TreeListControlLocalizer : DevExpress.XtraTreeList.Localization.TreeListResLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						...
						"DevExpress.XtraTreeList.LocalizationRes",
						"TreeListStringId.",
						typeof(DevExpress.XtraTreeList.Localization.TreeListResLocalizer).Assembly);
				}
