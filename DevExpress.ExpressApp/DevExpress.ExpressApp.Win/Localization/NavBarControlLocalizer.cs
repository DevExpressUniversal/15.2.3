...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraNavBar Control")]
	public class NavBarControlLocalizer : DevExpress.XtraNavBar.NavBarResLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						...
						"DevExpress.XtraNavBar.LocalizationRes",
						"NavBarStringId.",
						typeof(DevExpress.XtraNavBar.NavBarResLocalizer).Assembly);
				}
