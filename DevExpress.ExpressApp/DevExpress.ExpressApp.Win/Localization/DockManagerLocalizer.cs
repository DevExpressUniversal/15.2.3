...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraBars DockManager")]
	public class DockManagerLocalizer : DevExpress.XtraBars.Docking.DockManagerResXLocalizer, IXafResourceLocalizer {
		...
		IXafResourceManagerParameters IXafResourceManagerParametersProvider.XafResourceManagerParameters {
			get {
				if(parameters == null) {
					parameters = new XafResourceManagerParameters(
						"DevExpress.XtraBars.Docking",
						"DevExpress.XtraBars.Docking.LocalizationRes",
						"DockManagerStringId.",
						typeof(DevExpress.XtraBars.Docking.DockManagerResXLocalizer).Assembly);
				}
				return parameters;
			}
		}
