...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraGrid Control")]
	public class GridControlLocalizer : DevExpress.XtraGrid.Localization.GridResLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						"DevExpress.XtraGrid",
						"DevExpress.XtraGrid.LocalizationRes",
						"GridStringId.",
						typeof(DevExpress.XtraGrid.Localization.GridResLocalizer).Assembly);
				}
