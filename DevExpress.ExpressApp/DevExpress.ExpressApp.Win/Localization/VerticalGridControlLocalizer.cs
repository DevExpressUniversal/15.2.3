...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraVerticalGrid Control")]
	public class VerticalGridControlLocalizer : DevExpress.XtraVerticalGrid.Localization.VGridResLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						...
						"DevExpress.XtraVerticalGrid.Localization.LocalizationRes",
						"VGridStringId.",
						typeof(DevExpress.XtraVerticalGrid.Localization.VGridResLocalizer).Assembly);
				}
