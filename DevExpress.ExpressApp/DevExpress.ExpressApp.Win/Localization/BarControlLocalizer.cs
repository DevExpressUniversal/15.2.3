...
namespace DevExpress.ExpressApp.Win.Localization {
	[DisplayName("XtraBars Control")]
	public class BarControlLocalizer : DevExpress.XtraBars.Localization.BarResLocalizer, IXafResourceLocalizer {
			...
			get {
				if(xafResourceManagerParameters == null) {
					xafResourceManagerParameters = new XafResourceManagerParameters(
						"DevExpress.XtraBars",
						"DevExpress.XtraBars.LocalizationRes",
						"BarString.",
						typeof(DevExpress.XtraBars.Localization.BarResLocalizer).Assembly);
				}
