...
namespace DevExpress.ExpressApp.Win.SystemModule {
	public class GridListEditorPreviewRowController : ListEditorPreviewRowViewController {
		protected override void SetPreviewColumn(IModelColumn previewColumnModel) {
			ListView listView = (ListView)View; 
			if(listView.Editor is WinColumnsListEditor) { 
				GridControl gridControl = ((WinColumnsListEditor)listView.Editor).Grid;
				if(gridControl != null) {
