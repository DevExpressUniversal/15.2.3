...
namespace DevExpress.ExpressApp.Win.Templates.Bars.Utils {
	public class RepositoryItemAdapter : RepositoryItemAdapterBase {
		...
		public RepositoryItemAdapter(RepositoryItem repositoryItem, Type parameterType) : base(repositoryItem, parameterType) { }
		public override void SetupRepositoryItem() {
			RepositoryItem.KeyDown += RepositoryItem_KeyDown;
		}
		public override void SetNullValuePrompt(string nullValuePrompt) {
			RepositoryItem.NullText = nullValuePrompt;
		}
