...
namespace DevExpress.ExpressApp.Win.Templates.Utils {
	public sealed class LoadingIndicatorHelper {
		private void documentManager_ViewChanged(object sender, ViewEventArgs args) {
			DisableLoadingIndicator(args.View);
		}
		private void DisableLoadingIndicator(BaseView view) {
			if(view != null && EasyTestRemotingRegistration.IsRegistered) {
		...
		public void Attach(DocumentManager documentManager) {
			...
			DisableLoadingIndicator(documentManager.View);
		}
	}
}
