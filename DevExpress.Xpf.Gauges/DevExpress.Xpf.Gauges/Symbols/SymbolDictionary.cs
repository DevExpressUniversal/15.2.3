...
namespace DevExpress.Xpf.Gauges {
	public class SymbolDictionary : WeakEventListenerCollection<SymbolSegmentsMapping> {
		readonly SymbolViewBase symbolView;
		DigitalGaugeControl Gauge { get { return symbolView != null ? symbolView.Gauge : null; } }
		...
		protected override bool PerformWeakEvent(Type managerType, object sender, EventArgs e) {
			...
			if (managerType == typeof(PropertyChangedWeakEventManager)) {
				if (sender is GaugeDependencyObject && Gauge != null)
					Gauge.UpdateViewSymbols();
				success = true;
			}
			return success;
		}
