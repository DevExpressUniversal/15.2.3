...
namespace DevExpress.Xpf.Gauges {
	public class LinearScaleRangeModel : ModelBase {
		public static readonly DependencyProperty PresentationProperty = DependencyPropertyManager.Register("Presentation",
			typeof(LinearScaleRangePresentation), typeof(LinearScaleRangeModel), new PropertyMetadata(null, NotifyPropertyChanged));
		public static readonly DependencyProperty OptionsProperty = DependencyPropertyManager.Register("Options",
			typeof(RangeOptions), typeof(LinearScaleRangeModel), new PropertyMetadata(null, NotifyPropertyChanged));
		[
		Browsable(false),
		...
		protected override GaugeDependencyObject CreateObject() {
			return new LinearScaleRangeModel();
		}
	}
