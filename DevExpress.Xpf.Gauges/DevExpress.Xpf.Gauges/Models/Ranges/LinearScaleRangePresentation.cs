...
namespace DevExpress.Xpf.Gauges {
	...
	public abstract class PredefinedLinearScaleRangePresentation : LinearScaleRangePresentation {
		public static readonly DependencyProperty FillProperty = DependencyPropertyManager.Register("Fill",
			typeof(Brush), typeof(PredefinedLinearScaleRangePresentation), new PropertyMetadata(null, FillPropertyChanged));
		...
		static void FillPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
			PredefinedLinearScaleRangePresentation presentation = d as PredefinedLinearScaleRangePresentation;
	...
	public class DefaultLinearScaleRangePresentation : PredefinedLinearScaleRangePresentation {
		protected override Brush DefaultFill {
			get {
				...
				brush.GradientStops.Add(new GradientStop() { Color = Color.FromArgb(0xFF, 0xBF, 0xE2, 0x88), Offset = 0 });
				brush.GradientStops.Add(new GradientStop() { Color = Color.FromArgb(0xFF, 0x9D, 0xC2, 0x61), Offset = 1 });
				return brush;
			}
		}
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new DefaultLinearScaleRangeControl();
		}
	...
	public class CustomLinearScaleRangePresentation : LinearScaleRangePresentation {
		public static readonly DependencyProperty RangeTemplateProperty = DependencyPropertyManager.Register("RangeTemplate",
			typeof(ControlTemplate), typeof(CustomLinearScaleRangePresentation));
		...
		protected override GaugeDependencyObject CreateObject() {
			return new CustomLinearScaleRangePresentation();
		}
	}
}
