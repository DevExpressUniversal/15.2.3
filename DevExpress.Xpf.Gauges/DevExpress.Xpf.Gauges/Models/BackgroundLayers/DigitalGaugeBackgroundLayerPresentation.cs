...
namespace DevExpress.Xpf.Gauges {
	...
	public abstract class PredefinedDigitalGaugeLayerPresentation : DigitalGaugeLayerPresentation {
		public static readonly DependencyProperty FillProperty = DependencyPropertyManager.Register("Fill",
			typeof(Brush), typeof(PredefinedDigitalGaugeLayerPresentation), new PropertyMetadata(null, FillPropertyChanged));
		...
		static void FillPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
			PredefinedDigitalGaugeLayerPresentation presentation = d as PredefinedDigitalGaugeLayerPresentation;
	...
	public class DefaultDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new DefaultDigitalGaugeBackgroundLayerControl();
		}
	...
	public class CleanWhiteDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new CleanWhiteDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new CleanWhiteDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class CosmicDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new CosmicDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new CosmicDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class SmartDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new SmartDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new SmartDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class ProgressiveDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new ProgressiveDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new ProgressiveDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class EcoDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new EcoDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new EcoDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class FutureDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new FutureDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new FutureDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class ClassicDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new ClassicDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new ClassicDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class IStyleDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new IStyleDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new IStyleDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class YellowSubmarineDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new YellowSubmarineDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new YellowSubmarineDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class MagicLightDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new MagicLightDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new MagicLightDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class RedClockDigitalGaugeBackgroundLayerPresentation : PredefinedDigitalGaugeLayerPresentation {
		...
		protected internal override PresentationControl CreateLayerPresentationControl() {
			return new RedClockDigitalGaugeBackgroundLayerControl();
		}
		protected override GaugeDependencyObject CreateObject() {
			return new RedClockDigitalGaugeBackgroundLayerPresentation();
		}
	}
	public class CustomDigitalGaugeLayerPresentation : DigitalGaugeLayerPresentation {
		public static readonly DependencyProperty GaugeLayerTemplateProperty = DependencyPropertyManager.Register("GaugeLayerTemplate",
			typeof(ControlTemplate), typeof(CustomDigitalGaugeLayerPresentation));
		...
		protected override GaugeDependencyObject CreateObject() {
			return new CustomDigitalGaugeLayerPresentation();
		}
	}
}
