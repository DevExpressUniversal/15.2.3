...
namespace DevExpress.Xpf.Gauges {
	public class LinearScaleLevelBarModel : ModelBase {
		public static readonly DependencyProperty PresentationProperty = DependencyPropertyManager.Register("Presentation",
			typeof(LinearScaleLevelBarPresentation), typeof(LinearScaleLevelBarModel), new PropertyMetadata(null, NotifyPropertyChanged));
		public static readonly DependencyProperty OptionsProperty = DependencyPropertyManager.Register("Options",
			typeof(LinearScaleLevelBarOptions), typeof(LinearScaleLevelBarModel), new PropertyMetadata(null, NotifyPropertyChanged));
		[
		Browsable(false),
		...
		protected override GaugeDependencyObject CreateObject() {
			return new LinearScaleLevelBarModel();
		}
	}
