...
namespace DevExpress.Xpf.Gauges {
	...
	public class DefaultFourteenSegmentsPresentation : FourteenSegmentsPresentation, IDefaultSymbolPresentation {
		public static readonly DependencyProperty FillActiveProperty = DependencyPropertyManager.Register("FillActive",
			typeof(Brush), typeof(DefaultFourteenSegmentsPresentation), new PropertyMetadata(null, FillActivePropertyChanged));
		public static readonly DependencyProperty FillInactiveProperty = DependencyPropertyManager.Register("FillInactive",
			typeof(Brush), typeof(DefaultFourteenSegmentsPresentation), new PropertyMetadata(null, FillInactivePropertyChanged));
		...
		static void FillActivePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
			DefaultFourteenSegmentsPresentation presentation = d as DefaultFourteenSegmentsPresentation;
		...
		protected internal override PresentationControl CreateSymbolPresentationControl() {
			return new DefaultFourteenSegmentsControl();
		}
	}
	public class CustomFourteenSegmentsPresentation : FourteenSegmentsPresentation {
		public static readonly DependencyProperty SymbolTemplateProperty = DependencyPropertyManager.Register("SymbolTemplate",
			typeof(ControlTemplate), typeof(CustomFourteenSegmentsPresentation));		
		...
		protected override GaugeDependencyObject CreateObject() {
			return new CustomFourteenSegmentsPresentation();
		}
	}
}
