...
namespace DevExpress.Xpf.Gauges {
	public class ArcScaleNeedleModel : ModelBase {
		public static readonly DependencyProperty PresentationProperty = DependencyPropertyManager.Register("Presentation",
			typeof(ArcScaleNeedlePresentation), typeof(ArcScaleNeedleModel), new PropertyMetadata(null, NotifyPropertyChanged));
		public static readonly DependencyProperty OptionsProperty = DependencyPropertyManager.Register("Options",
			typeof(ArcScaleNeedleOptions), typeof(ArcScaleNeedleModel), new PropertyMetadata(null, NotifyPropertyChanged));
		[
		Browsable(false),
		...
		protected override GaugeDependencyObject CreateObject() {
			return new ArcScaleNeedleModel();
		}
	}
