...
namespace DevExpress.Xpf.Gauges {
	public class LinearScaleRangeBarModel : ModelBase {
		public static readonly DependencyProperty PresentationProperty = DependencyPropertyManager.Register("Presentation",
			typeof(LinearScaleRangeBarPresentation), typeof(LinearScaleRangeBarModel), new PropertyMetadata(null, NotifyPropertyChanged));
		public static readonly DependencyProperty OptionsProperty = DependencyPropertyManager.Register("Options",
			typeof(LinearScaleRangeBarOptions), typeof(LinearScaleRangeBarModel), new PropertyMetadata(null, NotifyPropertyChanged));
		[
		Browsable(false),
		...
		protected override GaugeDependencyObject CreateObject() {
			return new LinearScaleRangeBarModel();
		}
	}
