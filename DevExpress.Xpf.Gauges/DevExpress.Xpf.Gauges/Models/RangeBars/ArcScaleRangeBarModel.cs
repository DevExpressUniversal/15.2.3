...
namespace DevExpress.Xpf.Gauges {
	public class ArcScaleRangeBarModel : ModelBase {
		public static readonly DependencyProperty PresentationProperty = DependencyPropertyManager.Register("Presentation",
			typeof(ArcScaleRangeBarPresentation), typeof(ArcScaleRangeBarModel), new PropertyMetadata(null, NotifyPropertyChanged));
		public static readonly DependencyProperty OptionsProperty = DependencyPropertyManager.Register("Options",
			typeof(ArcScaleRangeBarOptions), typeof(ArcScaleRangeBarModel), new PropertyMetadata(null, NotifyPropertyChanged));
		[
		Browsable(false),
		...
		protected override GaugeDependencyObject CreateObject() {
			return new ArcScaleRangeBarModel();
		}
	}
