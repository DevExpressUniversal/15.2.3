...
namespace DevExpress.Xpf.Gauges {
	public class LinearScaleModel : ScaleModel {
		public static readonly DependencyProperty LabelOptionsProperty = DependencyPropertyManager.Register("LabelOptions",
			typeof(LinearScaleLabelOptions), typeof(LinearScaleModel), new PropertyMetadata(null, NotifyPropertyChanged));
		public static readonly DependencyProperty LinePresentationProperty = DependencyPropertyManager.Register("LinePresentation",
			typeof(LinearScaleLinePresentation), typeof(LinearScaleModel), new PropertyMetadata(null, NotifyPropertyChanged));
		[
		Browsable(false),
