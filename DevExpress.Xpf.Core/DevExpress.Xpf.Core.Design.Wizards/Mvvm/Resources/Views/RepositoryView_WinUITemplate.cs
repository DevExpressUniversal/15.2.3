...
namespace DevExpress.Xpf.Core.Design.Wizards.Mvvm.Resources.Views
{
	...
	public partial class RepositoryView_WinUITemplate : RepositoryView_WinUITemplateBase
	{
...
");
			...
			this.Write("    <DockPanel>\r\n\t\t<dxmvvm:Interaction.Behaviors>\r\n\t\t\t<dxmvvm:LayoutSerialization" +
					"Service/>\r\n\t\t</dxmvvm:Interaction.Behaviors>\r\n        <dxwui:AppBar DockPanel.Do" +
					"ck=\"Bottom\" HideMode=\"AlwaysVisible\">\r\n");
...
if(!this.ExecuteCollectionViewHook(TemplatesCodeGen.STR_CollectionViewHook_GenerateEmptyString)) {
			this.Write(@"			<dxwui:AppBarButton Label=""Print Preview"" Command=""{Binding TableViewCommands.ShowPrintPreviewDialog, ElementName=tableView}"" Glyph=""{dx:DXImageGrayscale Image=Preview_32x32.png}"" IsEllipseEnabled=""False"" AllowGlyphTheming=""True"" GlyphStretch=""None"" HorizontalAlignment=""Center"" />
");
}
			this.Write("\t\t\t");
...
if(!this.ExecuteCollectionViewHook(TemplatesCodeGen.STR_CollectionViewHook_GenerateCustomContent)) {
			this.Write("        <dxg:GridControl Name=\"gridControl\" ItemsSource=\"{Binding ");
...
void PasteXamlNamespaces(XamlNamespaces xamlNamespaces) {
	...
	#region Base class
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "10.0.0.0")]
	public class RepositoryView_WinUITemplateBase
	{
		#region Fields
