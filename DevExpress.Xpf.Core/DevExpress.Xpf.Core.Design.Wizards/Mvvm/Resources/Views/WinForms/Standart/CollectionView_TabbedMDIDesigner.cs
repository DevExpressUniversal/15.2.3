...
namespace DevExpress.Xpf.Core.Design.Wizards.Mvvm.Resources.Views.WinForms.Standart
{
	...
	public partial class CollectionView_TabbedMDIDesigner : CollectionView_TabbedMDIDesignerBase
	{
...
foreach(var noVisibleColumn in NonVisibleTypes){
			...
			this.Write("\t\t\tthis.gridView.PopulateColumns(typeof(");
			this.Write(this.ToStringHelper.ToStringWithCulture(viewModelData.EntityTypeFullName));
...
");
	...
	#region Base class
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "10.0.0.0")]
	public class CollectionView_TabbedMDIDesignerBase
	{
		#region Fields
