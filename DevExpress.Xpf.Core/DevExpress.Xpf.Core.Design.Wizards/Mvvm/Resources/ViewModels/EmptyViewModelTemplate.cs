...
namespace DevExpress.Xpf.Core.Design.Wizards.Mvvm.Resources.ViewModels
{
	...
	public partial class EmptyViewModelTemplate : EmptyViewModelTemplateBase
	{
		public virtual string TransformText()
		{
	string viewModelName = this.GetTemplateInfo().Properties["ViewModelName"].ToString();
			...
			this.Write(" : ViewModelBase {\r\n    }\r\n}");
			return this.GenerationEnvironment.ToString();
		}
	}
	#region Base class
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "10.0.0.0")]
	public class EmptyViewModelTemplateBase
	{
		#region Fields
