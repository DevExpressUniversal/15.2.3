...
namespace DevExpress.Xpf.Core.Design.Wizards.Mvvm.Resources.DataModel
{
	...
	public partial class UnitOfWorkDesignTimeTemplate : UnitOfWorkDesignTimeTemplateBase
	{
	...
	this.PasteUsingList();
			...
			this.Write("DesignTimeUnitOfWork instance that represents the design-time implementation of t" +
					"he I");
			this.Write(this.ToStringHelper.ToStringWithCulture(entityModel.Name));
			this.Write("UnitOfWork interface.\r\n    /// </summary>\r\n    public class ");
			this.Write(this.ToStringHelper.ToStringWithCulture(entityModel.Name));
			this.Write("DesignTimeUnitOfWork : DesignTimeUnitOfWork, I");
			this.Write(this.ToStringHelper.ToStringWithCulture(entityModel.Name));
			this.Write("UnitOfWork {\r\n\r\n        /// <summary>\r\n        /// Initializes a new instance of " +
					"the ");
			this.Write(this.ToStringHelper.ToStringWithCulture(entityModel.Name));
			this.Write("DesignTimeUnitOfWork class.\r\n        /// </summary>\r\n        public ");
			this.Write(this.ToStringHelper.ToStringWithCulture(entityModel.Name));
...
if(entity.ReadOnly){
			...
			this.Write("(");
if(!entity.ReadOnly){
			this.Write(this.ToStringHelper.ToStringWithCulture(entity.GetPrimaryKeyConstructor()));
}
			this.Write("); }\r\n        }\r\n");
}
			this.Write("    }\r\n}\r\n");
	...
	#region Base class
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "10.0.0.0")]
	public class UnitOfWorkDesignTimeTemplateBase
	{
		#region Fields
