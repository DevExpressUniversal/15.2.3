...
namespace DevExpress.Xpf.Core.Design.Wizards.Mvvm.Resources.DataModel
{
	...
	public partial class UnitOfWorkTemplate : UnitOfWorkTemplateBase
	{
	...
	EntityModelData entityModel = this.GetTemplateInfo().Properties["EntityModelData"] as EntityModelData;
			...
			this.Write("UnitOfWork extends the IUnitOfWork interface with repositories representing speci" +
					"fic entities.\r\n    /// </summary>\r\n    public interface I");
			this.Write(this.ToStringHelper.ToStringWithCulture(entityModel.Name));
			this.Write("UnitOfWork : IUnitOfWork {\r\n");
	if(entityModel != null)
		foreach(EntitySetData entity in entityModel.Entities) {
			this.Write("        \r\n        /// <summary>\r\n        /// The ");
			this.Write(this.ToStringHelper.ToStringWithCulture(entity.Type));
			this.Write(" entities repository.\r\n        /// </summary>\r\n\t\tI");
if(entity.ReadOnly){
			this.Write("ReadOnly");
}
...
if(!entity.ReadOnly){
	...
	#region Base class
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "10.0.0.0")]
	public class UnitOfWorkTemplateBase
	{
		#region Fields
