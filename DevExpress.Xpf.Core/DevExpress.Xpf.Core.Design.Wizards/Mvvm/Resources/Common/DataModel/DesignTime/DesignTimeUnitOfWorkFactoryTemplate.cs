...
namespace DevExpress.Xpf.Core.Design.Wizards.Mvvm.Resources.Common.DataModel.DesignTime
{
	...
	public partial class DesignTimeUnitOfWorkFactoryTemplate : DesignTimeUnitOfWorkFactoryTemplateBase
	{
	...
	this.PasteAliasList(usingList, entityModel.FullName);
			this.Write(@"    class DesignTimeUnitOfWorkFactory<TUnitOfWork> : IUnitOfWorkFactory<TUnitOfWork> where TUnitOfWork : IUnitOfWork {
	...
	#region Base class
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "10.0.0.0")]
	public class DesignTimeUnitOfWorkFactoryTemplateBase
	{
		#region Fields
