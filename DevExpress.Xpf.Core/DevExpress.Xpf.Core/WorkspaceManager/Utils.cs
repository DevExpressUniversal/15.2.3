...
namespace DevExpress.Xpf.Core {
	internal static class ResourceUtils {
		static string assemblyShortName = null;
		static string AssemblyShortName {
			get {
				if(assemblyShortName == null) {
					Assembly assembly = typeof(ResourceUtils).Assembly;
...
#endif
			uriString.Append(string.Format("/{0};component/{1}", AssemblyShortName, relativeFile));
