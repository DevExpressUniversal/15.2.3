...
namespace DevExpress.Xpf.Core.Native {
	...
	public partial class DXClipboard {
		static IClipboardHelper dxClipboardHelper;
		static IClipboardHelper ClipboardHelper {
			get {
				if(dxClipboardHelper == null)
					dxClipboardHelper = CreateClipboardHelper();
				return dxClipboardHelper;
			}
		}
		public static bool ContainsText() {
			return ClipboardHelper.ContainsText();
		}
		...
		public static void SetDataFromClipboardDataProvider(IClipboardDataProvider сlipboardDataProvider) {
			ClipboardHelper.SetDataFromClipboardDataProvider(сlipboardDataProvider);
		}
