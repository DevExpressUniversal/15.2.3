...
namespace DevExpress.Xpf.Core.Native {
	public class RenderRealControlContext : RenderControlBaseContext {
		public ControlTemplate Template {
			get { return Control.Template; }
			set { Control.Template = value; }
		}
		new Control Control { get { return base.Control as Control; } }
		...
		protected internal override void AttachToVisualTree(FrameworkElement root) {
			...
			Control.DataContext = root.DataContext ?? DataContext ?? root;
		}
	}
}
