...
namespace DevExpress.Xpf.Core.Native {
	public abstract class LayoutProvider : MarkupExtension {
		public static readonly LayoutProvider GridInstance = new GridPanelLayoutProvider();
		public static readonly LayoutProvider DockInstance = new DockPanelLayoutProvider();
