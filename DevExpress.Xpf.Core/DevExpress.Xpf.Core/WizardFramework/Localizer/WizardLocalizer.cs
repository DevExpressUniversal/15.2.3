...
namespace DevExpress.Xpf.Core.WizardFramework.Localizer {
	public class WizardLocalizer : DXLocalizer<WizardStringId> {
		...
		protected override void PopulateStringTable() {
			AddString(WizardStringId.Cancel, "Cancel");
			AddString(WizardStringId.Prev, "Previous");
			AddString(WizardStringId.Next, "Next");
			AddString(WizardStringId.Finish, "Finish");
		}
		public override XtraLocalizer<WizardStringId> CreateResXLocalizer() {
			return new WizardResXLocalizer();
		}
