...
namespace DevExpress.Xpf.Editors.DateNavigator {
	public class DateNavigatorStyleSettings : DateNavigatorStyleSettingsBase {
		...
		protected override INavigationService CreateNavigationService() {
			return Navigator.IsMultiSelect ?
				(INavigationService)new MultipleSelectionNavigationStrategy(Navigator) :
				(INavigationService)new SingleSelectionNavigationStrategy(Navigator);
		}
	}
}
