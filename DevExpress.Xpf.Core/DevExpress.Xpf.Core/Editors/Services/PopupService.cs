...
namespace DevExpress.Xpf.Editors.Services {
	public class PopupService : BaseEditBaseService {
		new PopupBaseEdit OwnerEdit { get { return base.OwnerEdit as PopupBaseEdit; } }
		public PopupService(TextEditBase editor) : base(editor) {
		}
		public void SetPopupSource(IPopupSource popupSource) {
			if (OwnerEdit == null)
				return;
			OwnerEdit.PopupSettings.SetPopupSource(popupSource);
			if (popupSource != null)
				OwnerEdit.ShowPopup();
		}
		public void AcceptPopupValue() {
			if (OwnerEdit == null)
				return;
			OwnerEdit.PopupSettings.AcceptPopupValue();
		}
	}
}
