...
namespace DevExpress.Xpf.Editors.EditStrategy {
	public class PopupBaseEditStrategy : TextEditStrategy {
		new PopupBaseEdit Editor { get { return base.Editor as PopupBaseEdit; } }
		public PopupBaseEditStrategy(PopupBaseEdit editor)
			: base(editor) {
		}
