...
namespace DevExpress.Xpf.Editors.Popups {
	public class PopupContentControl : ContentControl {
		...
		public PopupContentControl() {
			Loaded += PopupContentControlLoaded;
			Unloaded += PopupContentControlUnloaded;
		}
		void PopupContentControlUnloaded(object sender, RoutedEventArgs e) {
			FrameworkElementHelper.SetIsLoaded(this, false);
		}
		void PopupContentControlLoaded(object sender, RoutedEventArgs e) {
