...
namespace DevExpress.Xpf.Editors.Settings {
	...
	static Action<WeakEventHandler<TOwner, EventArgs, EventHandler>, object> action = (h, o) => ((BaseEditSettings)o).EditSettingsChanged -= h.Handler;
	static Func<WeakEventHandler<TOwner, EventArgs, EventHandler>, EventHandler> create = h => h.OnEvent;
		public EditSettingsChangedEventHandler(TOwner owner, Action<TOwner, object, EventArgs> onEventAction)
			: base(owner, onEventAction, action, create) {
		}
		public void Subscribe(BaseEditSettings settings) {
			settings.EditSettingsChanged += Handler;
		}
