...
namespace DevExpress.Xpf.Editors {
	public class EditValueChangedEventArgs : RoutedEventArgs {
		public EditValueChangedEventArgs(object oldValue, object newValue)
			: base(BaseEdit.EditValueChangedEvent) {
			NewValue = newValue;
			OldValue = oldValue;
		}
	...
	public class EditValueChangingEventArgs : RoutedEventArgs {
		public EditValueChangingEventArgs(object oldValue, object newValue)
			: base(BaseEdit.EditValueChangingEvent) {
			NewValue = newValue;
			OldValue = oldValue;
		}
		public object OldValue { get; private set; }
	...
	public delegate void EditValueChangingEventHandler(object sender, EditValueChangingEventArgs e);
}
