...
namespace DevExpress.Xpf.Editors {
	public abstract class BrushEditStyleSettingsBase : BaseEditStyleSettings {
		protected BrushEditStyleSettingsBase() : base() {
		}
	}
	public class SolidColorBrushEditStyleSettings : BrushEditStyleSettingsBase {
		public override void ApplyToEdit(BaseEdit editor) {
			...
			BrushEditBase brushEditBase = editor as BrushEditBase;
