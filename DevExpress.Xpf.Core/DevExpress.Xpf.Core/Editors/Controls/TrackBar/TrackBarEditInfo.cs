...
namespace DevExpress.Xpf.Editors {
	public class TrackBarEditInfo : RangeEditBaseInfo {
		...
		static TrackBarEditInfo() {
			...
			SelectionLengthProperty = DependencyPropertyManager.Register("SelectionLength", typeof(double), ownerType, 
				new FrameworkPropertyMetadata(0d));
			ReservedSpaceProperty = DependencyPropertyManager.Register("ReservedSpace", typeof(double), ownerType,
				new FrameworkPropertyMetadata(0d));
		}
		public double SelectionLength {
			get { return (double)GetValue(SelectionLengthProperty); }
