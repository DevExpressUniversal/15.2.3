...
namespace DevExpress.Xpf.Editors.Settings {
	...
	static Action<WeakEventHandler<TOwner, EventArgs, EventHandler>, object> action = (h, o) => ((ICollectionView)o).CurrentChanged -= h.Handler;
	static Func<WeakEventHandler<TOwner, EventArgs, EventHandler>, EventHandler> create = h => h.OnEvent;
		public CollectionViewMoveCurrentEventHandler(TOwner owner, Action<TOwner, object, EventArgs> onEventAction) 
