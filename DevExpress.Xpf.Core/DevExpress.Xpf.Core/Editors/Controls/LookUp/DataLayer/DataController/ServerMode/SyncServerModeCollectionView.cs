...
namespace DevExpress.Xpf.Editors.Helpers {
	public class SyncServerModeCollectionView : CollectionView, IServerModeCollectionView {
		readonly SyncVisibleListWrapper syncVisibleListWrapper;
		SyncVisibleListWrapper Wrapper { get { return this.syncVisibleListWrapper; } }
		new ICollectionView SourceCollection { get { return this.syncVisibleListWrapper; } }
		public SyncServerModeCollectionView(SyncVisibleListWrapper syncVisibleListWrapper) : base(Enumerable.Empty<object>()) {
			...
			syncVisibleListWrapper.CollectionChanged += OnVisibleListCollectionChanged;
		}
		...
		public override int IndexOf(object item) {
			...
			if (proxy == null)
				return -1;
			object value = Wrapper.GetValueFromProxy(proxy);
		...
		object IServerModeCollectionView.GetItem(int visibleIndex) {
			return syncVisibleListWrapper[visibleIndex];
		}
