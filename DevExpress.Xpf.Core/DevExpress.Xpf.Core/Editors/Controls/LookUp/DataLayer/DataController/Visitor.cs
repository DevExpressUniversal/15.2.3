...
namespace DevExpress.Xpf.Editors.Helpers {
	public class Visitor : IClientCriteriaVisitor {
		public HashSet<string> RequestedProperties = new HashSet<string>();
		public void Visit(BetweenOperator theOperator) {
			theOperator.BeginExpression.Do(x => x.Accept(this));
			theOperator.EndExpression.Do(x => x.Accept(this));
		}
		public void Visit(BinaryOperator theOperator) {
			theOperator.LeftOperand.Do(x => x.Accept(this));
			theOperator.RightOperand.Do(x => x.Accept(this));
		}
		public void Visit(UnaryOperator theOperator) {
			theOperator.Operand.Do(x => x.Accept(this));
		}
		public void Visit(InOperator theOperator) {
			theOperator.LeftOperand.Do(x => x.Accept(this));
			theOperator.Operands.Do(x => x.ForEach(o => o.Accept(this)));
		}
		...
		public void Visit(AggregateOperand theOperand) {
			theOperand.AggregatedExpression.Do(x => x.Accept(this));
		}
		public void Visit(OperandProperty theOperand) {
			string propertyName = theOperand.PropertyName;
			if (!string.IsNullOrEmpty(propertyName) && !RequestedProperties.Contains(propertyName))
