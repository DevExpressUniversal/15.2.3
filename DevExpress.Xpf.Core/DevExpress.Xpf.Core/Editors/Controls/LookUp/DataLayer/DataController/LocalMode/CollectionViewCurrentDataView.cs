...
namespace DevExpress.Xpf.Editors.Helpers {
	public class CollectionViewCurrentDataView : LocalCurrentDataView {
		...
		public CollectionViewCurrentDataView(object view, object handle, string valueMember, string displayMember)
			: base(view, handle, valueMember, displayMember) {
		}
		protected override object CreateVisibleListWrapper() {
			return ((ICollectionViewHelper)ListSource.ListSource).Collection;
		}
	}
}
