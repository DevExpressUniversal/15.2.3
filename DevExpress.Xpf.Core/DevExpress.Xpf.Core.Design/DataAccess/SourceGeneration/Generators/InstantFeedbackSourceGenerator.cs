...
namespace DevExpress.Design.DataAccess {
	...
	abstract class BaseInstantFeedbackSourceGenerator : BaseXamlDataSourceGenerator {
		protected override void InitializeDataSourceItem(IModelItem dataSourceItem, IDataSourceGeneratorContext context) {
			...
			SetProperty(dataSourceItem, DataSourcePropertyCodeName.AreSourceRowsThreadSafe, instantFeedbackSettingsModel.AreSourceRowsThreadSafe);
	...
	class EntityFrameworkInstantFeedbackSourceGenerator : BaseInstantFeedbackSourceGenerator {
		protected override System.Type GetDataSourceType() {
			return typeof(DevExpress.Xpf.Core.ServerMode.EntityInstantFeedbackDataSource);
		}
	}
	class LinqToSqlInstantFeedbackSourceGenerator : BaseInstantFeedbackSourceGenerator {
		protected override System.Type GetDataSourceType() {
			return typeof(DevExpress.Xpf.Core.ServerMode.LinqInstantFeedbackDataSource);
		}
	}
	class WcfInstantFeedbackSourceGenerator : BaseInstantFeedbackSourceGenerator {
		protected override System.Type GetDataSourceType() {
			return typeof(WcfInstantFeedbackDataSource);
		}
		protected override void InitializeDataSourceItem(IModelItem dataSourceItem, IDataSourceGeneratorContext context) {
	...
	class XPInstantFeedbackSourceGenerator : XPObjectSourceGenerator {
		protected override System.Type GetDataSourceType() {
			return RuntimeTypes.XPInstantFeedbackDataSource.ResolveType();
		}
	}
}
