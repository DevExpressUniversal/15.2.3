...
namespace DevExpress.Xpf.Core.Design.Services.PropertyLinesProviders {
	public abstract class ServicePropertyLinesProviderBase : PropertyLinesProviderBase {
		public ServicePropertyLinesProviderBase(Type itemType) : base(itemType) { }
		protected override SmartTagLineViewModelFactoryList GetPropertiesImpl(FrameworkElementSmartTagPropertiesViewModel viewModel) {
			...
			lines.Add(() => new ObjectPropertyLineViewModel(viewModel, ServiceBase.NameProperty.Name));
			return lines;
		}
	}
}
