...
namespace DevExpress.Xpf.Core.Design.Services.PropertyLinesProviders {
	public sealed class DispatcherServicePropertyLinesProvider : ServicePropertyLinesProviderBase {
		public DispatcherServicePropertyLinesProvider() : base(typeof(DispatcherService)) { }
		protected override SmartTagLineViewModelFactoryList GetPropertiesImpl(FrameworkElementSmartTagPropertiesViewModel viewModel) {
			...
			lines.Add(() => new EnumPropertyLineViewModel(viewModel, "DispatcherPriority", typeof(DispatcherPriority)));
			return lines;
		}
	}
}
