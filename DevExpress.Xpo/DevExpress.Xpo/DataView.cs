...
namespace DevExpress.Xpo {
...
#if !SL
	[DevExpressXpoLocalizedDescription("DataViewRecordView")]
#endif
	...
	public class DataViewProperty {
		...
		Type valueType;
		XPDataView owner;
		internal void SetOwner(XPDataView owner) {
			this.owner = owner;
		}
		void ResetView() {
			if(owner != null) {
...
#if !SL
	[DevExpressXpoLocalizedDescription("DataViewPropertyName")]
#endif
		public string Name {
			get { return name; }
...
#if !SL
	[DevExpressXpoLocalizedDescription("DataViewPropertyValueType")]
#endif
		[Editor("DevExpress.Xpo.Design.SimpleEnumAndTypeEditor, " + AssemblyInfo.SRAssemblyXpoDesignFull, "System.Drawing.Design.UITypeEditor, System.Drawing")]
		[TypeConverter("DevExpress.Xpo.Design.XPDataViewTypeConverter, " + AssemblyInfo.SRAssemblyXpoDesignFull)]
	...
	[Designer("DevExpress.Xpo.Design.XPDataViewDesigner, " + AssemblyInfo.SRAssemblyXpoDesignFull)]
	[ToolboxBitmap(typeof(ToolboxIcons.ToolboxIconsRootNS), "XPDataView")]
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPDataViewCaseSensitive")]
#endif
		...
		ArrayList LoadDataInternal(SelectedData data) {
			...
			foreach(SelectStatementResultRow rec in data.ResultSet[0].Rows) {
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPDataViewProperties")]
#endif
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPDataViewFilter")]
#endif
		[TypeConverter("DevExpress.Xpo.Design.CriteriaConverter, " + AssemblyInfo.SRAssemblyXpoDesignFull)]
		[DefaultValue(null)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Editor("DevExpress.Xpo.Design.XPDataViewCriteriaEditor, " + AssemblyInfo.SRAssemblyXpoDesignFull, "System.Drawing.Design.UITypeEditor, System.Drawing")]
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPDataViewSorting")]
#endif
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
