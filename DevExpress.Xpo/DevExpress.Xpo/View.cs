...
namespace DevExpress.Xpo {
...
#if !SL
	[DevExpressXpoLocalizedDescription("ViewRecordView")]
#endif
		public XPView View {
			get { return view; }
		}
	...
	public class ViewProperty : IDataColumnInfoProvider {
		...
		bool fetch;
		XPView owner;
		internal void SetOwner(XPView owner) {
			this.owner = owner;
		}
		void ResetView() {
			if(owner != null) {
...
#if !SL
	[DevExpressXpoLocalizedDescription("ViewPropertyName")]
#endif
		public string Name {
			get { return name; }
		...
		[
#if !SL
	DevExpressXpoLocalizedDescription("ViewPropertySorting"),
#endif
...
#if !SL
	[DevExpressXpoLocalizedDescription("ViewPropertyProperty")]
#endif
#if !SL
		...
		[
#if !SL
	DevExpressXpoLocalizedDescription("ViewPropertyGroup"),
#endif
 DefaultValue(false)]
		public bool Group {
			get { return group; }
		...
		[
#if !SL
	DevExpressXpoLocalizedDescription("ViewPropertyFetch"),
#endif
 DefaultValue(true)]
		public bool Fetch {
			get { return fetch; }
...
#if !SL
	[DesignerSerializer("DevExpress.Xpo.Design.XPViewSerializer, " + AssemblyInfo.SRAssemblyXpoDesignFull, "System.ComponentModel.Design.Serialization.CodeDomSerializer, System.Design")]
	[Designer("DevExpress.Xpo.Design.XPViewDesigner, " + AssemblyInfo.SRAssemblyXpoDesignFull)]
#endif
	...
	[ToolboxBitmap(typeof(ToolboxIcons.ToolboxIconsRootNS), "XPView")]
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewCaseSensitive")]
#endif
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewSession")]
#endif
#if !SL
...
#endif
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewObjectClassInfo")]
#endif
#if !SL
 ...
 Session.GetClassInfo(objectType);
			...
			set {
				if(!this.IsDesignMode && !this.Initializing)
					throw new NotSupportedException(Res.GetString(Res.Collections_CannotAssignProperty, "ObjectClassInfo"));
				if(info != value) {
					info = value;
					objectType = null;
		...
		public Type ObjectType {
			...
			set {
				if(!this.IsDesignMode && !this.Initializing)
					throw new NotSupportedException(Res.GetString(Res.Collections_CannotAssignProperty, "ObjectType"));
				objectType = value;
				Reset(true);
			}
		}
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewProperties")]
#endif
		...
		[
#if !SL
	DevExpressXpoLocalizedDescription("XPViewSkipReturnedRecords"),
#endif
 DefaultValue(0)]
		...
		[
#if !SL
	DevExpressXpoLocalizedDescription("XPViewTopReturnedRecords"),
#endif
 DefaultValue(0)]
		...
		SortingCollection sorting;
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewSorting")]
#endif
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
#if !SL
		[Editor("DevExpress.Xpo.Design.XPViewSortingCollectionEditor, " + AssemblyInfo.SRAssemblyXpoDesignFull, "System.Drawing.Design.UITypeEditor, System.Drawing")]
#endif
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewCriteria")]
#endif
#if !SL
		[TypeConverter("DevExpress.Xpo.Design.CriteriaConverter, " + AssemblyInfo.SRAssemblyXpoDesignFull)]
		[Editor("DevExpress.Xpo.Design.XPViewCriteriaEditor, " + AssemblyInfo.SRAssemblyXpoDesignFull, "System.Drawing.Design.UITypeEditor, System.Drawing")]
#endif
		[DefaultValue(null)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		[
#if !SL
	DevExpressXpoLocalizedDescription("XPViewSelectDeleted"),
#endif
 DefaultValue(false)]
...
#if !SL
	[DevExpressXpoLocalizedDescription("XPViewGroupCriteria")]
#endif
#if !SL
		[TypeConverter("DevExpress.Xpo.Design.CriteriaConverter, " + AssemblyInfo.SRAssemblyXpoDesignFull)]
		[Editor("DevExpress.Xpo.Design.XPViewCriteriaEditor, " + AssemblyInfo.SRAssemblyXpoDesignFull, "System.Drawing.Design.UITypeEditor, System.Drawing")]
