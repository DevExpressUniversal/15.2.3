...
namespace DevExpress.Xpo {
	sealed class Res {
		...
		static Res res;
		Res() {
			manager = new ResourceManager("DevExpress.Xpo.Messages", GetType().GetAssembly());
		}
		...
		public const string ConnectionProvider_TheAutoIncrementedKeyWithX0TypeIsNotSuppor = "ConnectionProvider_TheAutoIncrementedKeyWithX0TypeIsNotSuppor";
		public const string CriteriaAnalizer_ClassesAreNotAssignable = "CriteriaAnalizer_ClassesAreNotAssignable";
		public const string CriteriaAnalizer_PathNotFound = "CriteriaAnalizer_PathNotFound";
		public const string CriteriaAnalizer_NullTransitionMemberInfo = "CriteriaAnalizer_NullTransitionMemberInfo";
		public const string CriteriaAnalizer_EmptyJoinOperandId = "CriteriaAnalizer_EmptyJoinOperandId";
		public const string CriteriaAnalizer_NullJoinClassInfo = "CriteriaAnalizer_NullJoinClassInfo";
		public const string CriteriaAnalizer_TopLevelAggregateNotSupported = "CriteriaAnalizer_TopLevelAggregateNotSupported";
		...
		public const string InMemory_DataSetUncommited = "InMemory_DataSetUncommited";
		...
		public const string Metadata_NonpesistentKey = "Metadata_NonpesistentKey";
		...
		public const string NestedSession_NotClonable = "NestedSession_NotClonable";
		...
		public const string SerializableObjectLayer_OLDoesNotImplementptISerializableObjectLayerEx = "SerializableObjectLayer_OLDoesNotImplementptISerializableObjectLayerEx";
		...
		public const string ServerModeGridSource_GroupAndAddOrRemoveIsNotAllwed = "ServerModeGridSource_GroupAndAddOrRemoveIsNotAllwed";
		...
		public const string Session_DictConstractor = "Session_DictConstractor";
		public const string ThreadSafeDataLayer_DictionaryModified = "ThreadSafeDataLayer_DictionaryModified";
		public const string View_AtLeastOneFetchProperptyShouldBeDefined = "View_AtLeastOneFetchProperptyShouldBeDefined";
		...
		public const string LinqToXpo_DoesnTSupportNestedJoinsWithLevel = "LinqToXpo_DoesnTSupportNestedJoinsWithLevel";
		public const string LinqToXpo_TheDeclaringTypeAssemblyNamePropertyIsEmpt = "LinqToXpo_TheDeclaringTypeAssemblyNamePropertyIsEmpt";
		...
		public const string LinqToXpo_SortingIsNotSupportedForSelectManyOperatio = "LinqToXpo_SortingIsNotSupportedForSelectManyOperatio";
