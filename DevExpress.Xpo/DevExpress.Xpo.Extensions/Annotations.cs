...
namespace DevExpress.Xpo {
	internal static class ResourceTypeExtensions {
		internal static Annotation GetAnnotation(this ResourceType resourceType) {
			return resourceType.CustomState as Annotation;
		}
	}
	internal class Annotation {
		public Annotation(XPClassInfo cInfo) {
			ClassInfo = cInfo;
		}
