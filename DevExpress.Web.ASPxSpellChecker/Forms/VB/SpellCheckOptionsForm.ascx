...
<table id="dxMainSpellCheckOptionsFormTable" <%=DevExpress.Web.Internal.RenderUtils.GetTableSpacings(Me, 0, 0)%> class="dxwscDlgMainSpellCheckOptionsFormTable">
	<tr>
		<td class="dxwscDlgContentSCOptionsFormContainer">
			<table id="dxOptionsForm" class="dxwscDlgOptionsForm" <%=DevExpress.Web.Internal.RenderUtils.GetTableSpacings(Me, 0, 0)%> style="width:100%">
				<tr>
					<td>
