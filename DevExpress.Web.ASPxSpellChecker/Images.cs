...
namespace DevExpress.Web.ASPxSpellChecker {
	public class SpellCheckerImages : ImagesBase {
		...
		public new string ImageFolder {
			get { return base.ImageFolder; }
			set { base.ImageFolder = value; }
		}
		protected bool ShouldSerializeImageFolder() { return false; }
		protected override Type GetResourceType() {
			return typeof(ASPxSpellChecker);
		}
		protected override string GetResourceImagePath() {
			return ASPxSpellChecker.SpellCheckerImagesResourcePath;
		}
		protected override void PopulateImageInfoList(List<ImageInfo> list) {
			...
			list.Add(new ImageInfo(ErrorUnderlineImageName));
		}
	}
}
