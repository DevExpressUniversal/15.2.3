...
namespace DevExpress.Snap.Core.Native.Services {
	public class DataSourceCollectorService : IDataSourceCollectorService {
		readonly SnapDocumentModel snapDocumentModel;
		public DataSourceCollectorService(SnapDocumentModel snapDocumentModel) {
			this.snapDocumentModel = snapDocumentModel;
		}
		public object[] GetDataSources() {
			List<object> dataSources = new List<object>();
			dataSources.AddRange(this.snapDocumentModel.DataSourceDispatcher.GetDataSources());
			dataSources.Add(snapDocumentModel.ParametersDataSource);
