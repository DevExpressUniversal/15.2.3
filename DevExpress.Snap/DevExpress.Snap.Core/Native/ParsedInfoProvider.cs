...
namespace DevExpress.Snap.Core.Native {
	public class ParsedInfoProvider : IParsedInfoProvider {
		readonly IFieldInfo fieldInfo;
		CalculatedFieldBase parsedInfo;
		public ParsedInfoProvider(IFieldInfo fieldInfo) {
		...
		public CalculatedFieldBase GetParsedInfo() {
			if (parsedInfo == null) {
				...
				parsedInfo = calculator.ParseField(PieceTable, Field);
			}
			return parsedInfo;
		}
	...
	public interface IParsedInfoProvider {
		CalculatedFieldBase GetParsedInfo();
		void InvalidateParsedInfo();
	}
}
