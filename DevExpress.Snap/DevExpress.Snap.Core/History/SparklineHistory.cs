...
namespace DevExpress.Snap.Core.History {
	public class SparklineRunInsertedHistoryItem : InlinePictureRunInsertedHistoryItem {
		public SparklineRunInsertedHistoryItem(PieceTable pieceTable)
			: base(pieceTable) {
		}
		...
		protected override InlinePictureRun CreateInlinePictureRun(Paragraph paragraph, OfficeImage image) {
			return new SparklineRun(paragraph, image);
		}
	}
}
