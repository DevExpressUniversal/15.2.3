...
namespace DevExpress.Snap.Core.Commands {
	public abstract class SnapMultiCommand : MultiCommand {
		protected SnapMultiCommand(IRichEditControl control)
			: base(control) {
		}
		protected SnapMultiCommand(IRichEditControl control, bool shouldCreateCommands)
			: base(control, shouldCreateCommands) {
		}
