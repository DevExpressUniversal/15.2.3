...
namespace DevExpress.Snap.Core.Commands {
	public class ChangeSelectionIntervalCommand : RichEditSelectionCommand {
		public ChangeSelectionIntervalCommand(IRichEditControl control)
			: base(control) {			
		}
		#region Properties
		...
		public DocumentLogInterval SelectionInterval { get; set; }
		...
		protected internal override void ChangeSelection(XtraRichEdit.Model.Selection selection) {
			...
			DocumentLogPosition startSelection = SelectionInterval.Start;
			DocumentLogPosition endSelection = SelectionInterval.Start + SelectionInterval.Length - 1;
