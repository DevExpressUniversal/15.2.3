...
namespace DevExpress.Snap.Core.Commands {
	public class SnapMailMergeQuickPrintCommand : FinishAndMergeCommandBase {
		public SnapMailMergeQuickPrintCommand(IRichEditControl control)
			: base(control) {
		}
		public override RichEditCommandId Id { get { return SnapCommandId.SnapMailMergeQuickPrint; } }
