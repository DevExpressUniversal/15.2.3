...
namespace DevExpress.Snap.Extensions.Native {
	public class SNContextMenu : XtraContextMenuBase {
		readonly SnapControl snapControl;
		public SNContextMenu(SnapControl snapControl) {
			this.snapControl = snapControl;
		}
		protected override LookAndFeel.UserLookAndFeel GetLookAndFeel(IServiceProvider provider) {
			return snapControl.LookAndFeel;
		}
