...
namespace DevExpress.XtraPrinting.Preview {
	public interface IPrintPreviewPopupControlContainer {
		PrintControl PrintControl { get; set; }
	}
	[
	ToolboxItem(false),
	]
	public abstract class PrintPreviewPopupControlContainer : PopupControlContainer, IPrintPreviewPopupControlContainer {
