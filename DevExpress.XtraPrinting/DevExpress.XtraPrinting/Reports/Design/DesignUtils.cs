...
namespace DevExpress.XtraReports.Design {
	public static class LinkColorHelper {
		static Color Color { get { return Color.FromArgb(0x28, 0x59, 0xae); } }
		public static Color GetSkinColor(UserLookAndFeel lookAndFeel) {
