...
namespace DevExpress.XtraPrinting.Native.Lines {
	public class FloatNumericPropertyLine : EditorPropertyLineBase {
		TextEdit TextEdit {
			get { return (TextEdit)baseEdit; }
		}
		protected override bool ShouldUpdateValue { get { return true; } }
		public FloatNumericPropertyLine(IStringConverter converter, PropertyDescriptor property, object obj)
		...
		protected override void  IntializeEditor() {
			...
			TextEdit.Properties.ValidateOnEnterKey = true;
			TextEdit.Validating += new CancelEventHandler(OnBaseEditValidating);
		}
		protected override void SetEditText(object val) {
			TextEdit.ToolTip = TextEdit.Text = ValueToString(val);
		}
	}
}
