...
namespace DevExpress.XtraPrinting
{
	...
	public class Link : LinkBase, IWinLink {
		#region windows forms specific
		ImageCollection imageCollection ;
		[
#if !SL
	DevExpressXtraPrintingLocalizedDescription("LinkImages"),
#endif
		...
		public override bool CanHandleCommand(PrintingSystemCommand command, IPrintControl printControl) {
			return CanHandleCommandInternal(command, (PrintControl)printControl);
		}
		#endregion // windows forms specific
		public Link() {
		}
		public Link(PrintingSystem ps)
			: base(ps) {
		}
		internal Link(PrintingSystemBase ps)
			: base(ps) {
		}
		public Link(System.ComponentModel.IContainer container)
			: base(container) {
		}
	}
}
