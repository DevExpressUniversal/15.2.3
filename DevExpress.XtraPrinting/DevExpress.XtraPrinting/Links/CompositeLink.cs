...
namespace DevExpress.XtraPrintingLinks {
	public class CompositeLink : CompositeLinkBase, IWinLink {
	...
	DevExpressXtraPrintingLocalizedDescription("LinkImages"),
		...
		public CompositeLink(PrintingSystem ps)
			: base(ps) {
		}
		public CompositeLink(System.ComponentModel.IContainer container)
			: base(container) {
		}
	}
}
