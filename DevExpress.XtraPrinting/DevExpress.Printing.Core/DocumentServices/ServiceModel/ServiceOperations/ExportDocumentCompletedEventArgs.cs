...
namespace DevExpress.DocumentServices.ServiceModel.ServiceOperations {
	public class ExportDocumentCompletedEventArgs : ServiceOperationCompletedEventArgs<ExportId> {
		...
		public ExportDocumentCompletedEventArgs(byte[] data, ExportId exportId, Exception error, bool cancelled, object userState)
			: base(exportId, error, cancelled, userState) {
			Data = data;
		}
	}
}
