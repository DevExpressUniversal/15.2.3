...
namespace DevExpress.DocumentServices.ServiceModel.ServiceOperations {
	public class PrintDocumentCompletedEventArgs : ServiceOperationCompletedEventArgs<PrintId> {
		...
		public PrintDocumentCompletedEventArgs(string[] pages, bool stopped, PrintId printId, Exception error, bool cancelled, object userState)
			: base(printId, error, cancelled, userState) {
			Pages = pages;
			Stopped = stopped;
		}
	}
