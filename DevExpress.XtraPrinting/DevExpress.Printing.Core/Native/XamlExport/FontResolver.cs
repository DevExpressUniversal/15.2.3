...
namespace DevExpress.XtraPrinting.XamlExport {
	public static class FontResolver {
		...
		internal static string ResolveEnglishFamilyName(Font font) {
			string familyName = FontHelper.GetEnglishFamilyName(font);
			RaiseFamilyNameResolved(ref familyName);
			return familyName;
		}
#endif
		static void RaiseFamilyNameResolved(ref string familyName) {
			if(FamilyNameResolved != null) {
				FamilyNameResolvedEventArgs eventArgs = new FamilyNameResolvedEventArgs(familyName);
				FamilyNameResolved(null, eventArgs);
				familyName = eventArgs.FamilyName;
			}
		}
	}
}
