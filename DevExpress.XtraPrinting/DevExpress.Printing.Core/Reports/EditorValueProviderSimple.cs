...
namespace DevExpress.XtraReports.Parameters.Native {
	public class EditorValuesProviderSimple : IParameterEditorValueProvider {
		readonly Dictionary<IParameter, object> parameters;
		public EditorValuesProviderSimple(Dictionary<IParameter, object> parameters) {
			this.parameters = parameters;
		}
		public object GetValue(DevExpress.Data.IParameter parameterIdentity) {
			object result = null;
			parameters.TryGetValue(parameterIdentity, out result);
			return result;
		}
	}
}
