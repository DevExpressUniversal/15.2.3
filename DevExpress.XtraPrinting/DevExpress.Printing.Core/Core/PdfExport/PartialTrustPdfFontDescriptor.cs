...
{
	class PartialTrustPdfFontDescriptor : PdfFontDescriptor {
		public PartialTrustPdfFontDescriptor(PdfFontBase ownerFont, bool compressed)
			: base(ownerFont, compressed) {
		}
		public override void FillUp() {
			if(ownerFont == null) return;
			Dictionary.Add("Type", "FontDescriptor");
			Dictionary.Add("FontName", OwnerFont.BaseFont);
			Dictionary.Add("Ascent", (int)0);
			Dictionary.Add("CapHeight", 500);
			Dictionary.Add("Descent", (int)0);
