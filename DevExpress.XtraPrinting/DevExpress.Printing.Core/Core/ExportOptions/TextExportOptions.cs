...
namespace DevExpress.XtraPrinting {
	...
	public class TextExportOptions : TextExportOptionsBase {
		public const string DefaultSeparator = "\t";
		public TextExportOptions() : this(DefaultSeparator) { }
		public TextExportOptions(string separator) {
			Separator = separator;
		}
		public TextExportOptions(string separator, Encoding encoding) 
			: base(separator, encoding) {
		}
		public TextExportOptions(string separator, Encoding encoding, TextExportMode textExportMode)
			: base(separator, encoding, textExportMode) {
		}
		protected TextExportOptions(TextExportOptions source)
			: base(source) {
		}
		protected internal override ExportOptionsBase CloneOptions() {
			return new TextExportOptions(this);
		}
