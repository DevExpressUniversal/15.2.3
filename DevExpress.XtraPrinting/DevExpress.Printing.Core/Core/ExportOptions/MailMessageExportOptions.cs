...
namespace DevExpress.XtraPrinting {
	...
	public class MailMessageExportOptions : HtmlExportOptionsBase {
		public MailMessageExportOptions() : this(DefaultCharacterSet) { }
		public MailMessageExportOptions(string characterSet) : this(characterSet, DefaultTitle) { }
		...
		protected MailMessageExportOptions(MailMessageExportOptions source)
			: base(source) {
		}
		[
		Browsable(false),
		...
		protected internal override ExportOptionsBase CloneOptions() {
			return new MailMessageExportOptions(this);
		}
	}
}
