...
namespace DevExpress.XtraPrinting {
	...
	public class HtmlExportOptions : HtmlExportOptionsBase {
		public HtmlExportOptions() : this(DefaultCharacterSet) { }
		public HtmlExportOptions(string characterSet) : this(characterSet, DefaultTitle) { }
		...
		protected HtmlExportOptions(HtmlExportOptions source)
			: base(source) {
		}
		protected internal override ExportOptionsBase CloneOptions() {
			return new HtmlExportOptions(this);
		}
	}
}
