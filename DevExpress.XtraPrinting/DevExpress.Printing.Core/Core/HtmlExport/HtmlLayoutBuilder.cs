...
namespace DevExpress.XtraPrinting.Export.Web {
	public class HtmlLayoutBuilder : LayoutBuilder {
		HtmlExportContext htmlExportContext;
		public HtmlLayoutBuilder(Document document, HtmlExportContext htmlExportContext)
			: base(document) {
		...
		protected override ILayoutControl[] GetBrickLayoutControls(Brick brick, RectangleF rect) {
			return ToLayoutControls(htmlExportContext.GetData(brick, rect, rect), brick);
		}
	}
}
