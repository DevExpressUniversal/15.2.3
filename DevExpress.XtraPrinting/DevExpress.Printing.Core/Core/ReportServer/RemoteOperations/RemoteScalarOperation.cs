...
namespace DevExpress.ReportServer.ServiceModel.Native.RemoteOperations {
	abstract public class RemoteScalarOperation<T> : ReportServiceOperation {
		...
		public RemoteScalarOperation(IReportServiceClient client, TimeSpan updateInterval, DocumentId documentId)
