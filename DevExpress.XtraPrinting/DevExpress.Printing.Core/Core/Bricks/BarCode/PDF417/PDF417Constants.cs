...
namespace DevExpress.XtraPrinting.BarCode.Native {
	public class PDF417Constants {
		...
		public const int MaxCodewordsCapacity = 928;
		public const int MaxCodewordsCount = 929;
		public const int MaxSizeOfBuffer = 3000;
		public const int MaxCharsCountInRow = 30;
		public const int MaxTextLength = 1726;
		public const int MaxDataLength = 1033;
		public const long ByteCalculationCoefficient = 256;
		public const long ByteConversionCoefficient = 900;
		public const int ErrorCorrectionPlacebo = 900;
		public const int CalculateDegree = 6;
		public const int EndLatchToByteCompaction = 924;
		public const int ModeLatchToByteCompaction = 901;
		public const float MinYToXRatio = 3f;
		public static readonly int[,] PDF417Bits = new int[,] { { 
	...
	public class ErrorCorrCoefficients {
		public static readonly short[] ErrorCorrCoef0 = new short[] { 0x1b, 0x395 };
		public static readonly short[] ErrorCorrCoef1 = new short[] { 0x20a, 0x238, 0x2d3, 0x329 };
		public static readonly short[] ErrorCorrCoef2 = new short[] { 0xed, 0x134, 0x1b4, 0x11c, 0x286, 0x28d, 0x1ac, 0x17b };
		public static readonly short[] ErrorCorrCoef3 = new short[] { 0x112, 0x232, 0xe8, 0x2f3, 0x257, 0x20c, 0x321, 0x84, 0x127, 0x74, 0x1ba, 0x1ac, 0x127, 0x2a, 0xb0, 0x41 };
		public static readonly short[] ErrorCorrCoef4 = new short[] { 
		...
		public static readonly short[] ErrorCorrCoef5 = new short[] { 
		...
		public static readonly short[] ErrorCorrCoef6 = new short[] { 
		...
		public static readonly short[] ErrorCorrCoef7 = new short[] { 
		...
		public static readonly short[] ErrorCorrCoef8 = new short[] { 
