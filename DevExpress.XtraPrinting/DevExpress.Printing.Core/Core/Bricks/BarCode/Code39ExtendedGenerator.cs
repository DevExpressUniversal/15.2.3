...
namespace DevExpress.XtraPrinting.BarCode {
	public class Code39ExtendedGenerator : Code39Generator {
		...
		#region static XRCode39ExtendedGenerator()
		...
		#endregion
#if !SL
	[DevExpressPrintingCoreLocalizedDescription("Code39ExtendedGeneratorSymbologyCode")]
#endif
		public override BarCodeSymbology SymbologyCode {
			get {
				return BarCodeSymbology.Code39Extended;
			}
		}
		public Code39ExtendedGenerator() {
		}
		Code39ExtendedGenerator(Code39ExtendedGenerator source)
			: base(source) {
		}
		protected override BarCodeGeneratorBase CloneGenerator() {
			return new Code39ExtendedGenerator(this);
		}
		...
		protected override string FormatText(string text) {
			if(CalcCheckSum)
				text += CalcCheckDigit(PerformSubstitutions(text));
			return text;
		}
