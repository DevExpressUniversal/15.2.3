...
namespace DevExpress.XtraPrinting.NativeBricks {
	...
	public class XECheckBoxTextBrick : CheckBoxTextBrick {
		public override string BrickType { get { return BrickTypes.XECheckBoxText; } }
		public XECheckBoxTextBrick() : base() { }
		public XECheckBoxTextBrick(BrickStyle style) : base(style) { }
	}
	class XECheckBoxTextBrickExporter : CheckBoxTextBrickExporter {
		internal CheckBoxTextBrick CheckBoxBrick { get { return Brick as CheckBoxTextBrick; } }
		protected internal override void FillXlsTableCellInternal(IXlsExportProvider exportProvider) {
			exportProvider.SetCellText(CheckBoxBrick.CheckText, null);
		}
