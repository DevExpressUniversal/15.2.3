...
namespace DevExpress.XtraPrinting.NativeBricks {
	...
	public class XEToggleSwitchTextBrick : ToggleSwitchTextBrick {
		public override string BrickType { get { return BrickTypes.XEToggleSwitchText; } }
		public XEToggleSwitchTextBrick() : base() { }
		public XEToggleSwitchTextBrick(BrickStyle style) : base(style) { }
	}
	class XEToggleSwitchTextBrickExporter : ToggleSwitchTextBrickExporter {
		internal ToggleSwitchTextBrick ToggleSwitchTextBrick { get { return Brick as ToggleSwitchTextBrick; } }
		protected internal override void FillXlsTableCellInternal(IXlsExportProvider exportProvider) {
			exportProvider.SetCellText(ToggleSwitchTextBrick.CheckText, null);
		}
		protected internal override BrickViewData[] GetExportData(ExportContext exportContext, RectangleF rect, RectangleF clipRect) {
			if(exportContext is XlsExportContext) {
