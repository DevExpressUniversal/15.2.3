...
namespace DevExpress.Office {
	#region TransparentDestination
	public class TransparentDestination : Destination {
		readonly Destination destination;
		public TransparentDestination(IDestinationImporter importer)
			: base(importer) {
		...
		public override bool ProcessText(XmlReader reader) {
			return destination.ProcessText(reader);
		}
		protected override Destination ProcessCurrentElement(XmlReader reader) {
			return destination.ProcessCurrentElementInternal(reader);
		}
