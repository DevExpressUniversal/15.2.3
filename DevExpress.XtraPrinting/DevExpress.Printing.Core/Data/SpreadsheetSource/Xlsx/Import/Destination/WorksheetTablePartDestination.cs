...
namespace DevExpress.SpreadsheetSource.Xlsx.Import {
	#region WorksheetTablePartsDestination
	public class WorksheetTablePartsDestination : ElementDestination<XlsxSpreadsheetSourceImporter> {
		...
		#endregion
		public WorksheetTablePartsDestination(XlsxSpreadsheetSourceImporter importer)
			: base(importer) {
		}
		...
		static Destination OnTablePart(XlsxSpreadsheetSourceImporter importer, XmlReader reader) {
			return new WorksheetTablePartDestination(importer);
		}
	}
	#endregion
	#region WorksheetTablePartDestination
	public class WorksheetTablePartDestination : LeafElementDestination<XlsxSpreadsheetSourceImporter> {
		public WorksheetTablePartDestination(XlsxSpreadsheetSourceImporter importer)
			: base(importer) {
		}
		public override void ProcessElementOpen(XmlReader reader) {
			string relationId = Importer.ReadAttribute(reader, "id", XlsxPackageBuilder.RelsNamespace);
			Importer.TableRelationIds.Add(relationId);
		}
	}
	#endregion
}
