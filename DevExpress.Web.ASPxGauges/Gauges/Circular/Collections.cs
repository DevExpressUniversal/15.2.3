...
namespace DevExpress.Web.ASPxGauges.Gauges.Circular {
	public class ArcScaleComponentCollection :
		ComponentCollectionWeb<ArcScaleComponent> {
	}
	public class ArcScaleBackgroundLayerComponentCollection :
		ComponentCollectionWeb<ArcScaleBackgroundLayerComponent> {
	}
	public class ArcScaleEffectLayerComponentCollection :
		ComponentCollectionWeb<ArcScaleEffectLayerComponent> {
	}
	public class ArcScaleNeedleComponentCollection :
		ComponentCollectionWeb<ArcScaleNeedleComponent> {
	}
	public class ArcScaleMarkerComponentCollection :
		ComponentCollectionWeb<ArcScaleMarkerComponent> {
	}
	public class ArcScaleRangeBarComponentCollection :
		ComponentCollectionWeb<ArcScaleRangeBarComponent> {
	}
	public class ArcScaleSpindleCapComponentCollection :
		ComponentCollectionWeb<ArcScaleSpindleCapComponent> {
	}
	public class ArcScaleStateIndicatorComponentCollection :
		ComponentCollectionWeb<ArcScaleStateIndicatorComponent> {
	}
}
