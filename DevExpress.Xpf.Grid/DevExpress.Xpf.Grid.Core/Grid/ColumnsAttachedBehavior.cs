	...
	public class ColumnTemplateSelector : DataTemplateSelector {
		public override DataTemplate SelectTemplate(object item, DependencyObject container) {
			...
			foreach(Attribute a in context.PropertyDescriptor.Attributes) {
				if(a is ColumnGeneratorTemplateNameAttribute)
					templateName = ((ColumnGeneratorTemplateNameAttribute)a).Name;
			}
			...
			if(control == null)
				throw new Exception();
			return (control.Resources[templateName]) as DataTemplate;
		}
	}
}
