...
namespace DevExpress.Xpf.Grid {
	public class OuterBorderElement : Control {
		public static readonly DependencyProperty ShowColumnHeadersProperty =
			DependencyPropertyManager.Register("ShowColumnHeaders", typeof(bool), typeof(OuterBorderElement), new PropertyMetadata(true, (d, e) => { ((OuterBorderElement)d).OnShowColumnHeadersChanged(); }));
		public OuterBorderElement() {
			this.SetDefaultStyleKey(typeof(OuterBorderElement));
			OnShowColumnHeadersChanged();
		}
		...
		private void OnShowColumnHeadersChanged() {
			BorderThickness = ShowColumnHeaders ? new Thickness(1, 0, 1, 1) : new Thickness(1);
		}
	}
}
