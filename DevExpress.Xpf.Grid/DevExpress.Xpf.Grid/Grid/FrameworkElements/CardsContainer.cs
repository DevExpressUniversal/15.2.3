...
namespace DevExpress.Xpf.Grid {
	public class CardsContainer : Control {
		public static readonly DependencyProperty DataPresenterProperty = DependencyProperty.Register("DataPresenter", typeof(DataPresenterBase), typeof(CardsContainer), new PropertyMetadata(null));
