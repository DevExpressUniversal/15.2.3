...
namespace DevExpress.Xpf.Map {
	public class ScalePanelOptions : NavigationElementOptions {
		public static readonly DependencyProperty ShowKilometersScaleProperty = DependencyPropertyManager.Register("ShowKilometersScale",
			typeof(bool), typeof(ScalePanelOptions), new PropertyMetadata(true));
		...
		public ScalePanelOptions() {
			this.SetValue(NavigationElementOptions.VerticalAlignmentProperty, NavigationElementVerticalAlignment.Bottom);
			this.SetValue(NavigationElementOptions.HorizontalAlignmentProperty, NavigationElementHorizontalAlignment.Right);
		}
		protected override MapDependencyObject CreateObject() {
			return new ScalePanelOptions();
		}
	}
}
