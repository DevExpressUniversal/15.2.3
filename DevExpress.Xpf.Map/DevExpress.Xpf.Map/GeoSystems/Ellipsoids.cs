...
namespace DevExpress.Xpf.Map {
	public class Ellipsoid {
		...
		protected internal EllipsoidCore EllipsoidCore { get { return ellipsoidCore; } }
		[Category(Categories.Data)]
		public double SemimajorAxis {
			get { return EllipsoidCore.SemimajorAxis; }
			set { RecreateEllipsoidCore(value, InverseFlattening, Name); }
		}
		[Category(Categories.Data)]
		public double InverseFlattening {
			get { return 1.0 / EllipsoidCore.Flattening; }
			set { RecreateEllipsoidCore(SemimajorAxis, value, Name); }
		}
		[Category(Categories.Data)]
		public string Name {
			get { return EllipsoidCore.Name; }
			set { RecreateEllipsoidCore(SemimajorAxis, InverseFlattening, value); }
		}
		public double SemiminorAxis { get { return EllipsoidCore.SemimajorAxis; } }
		...
		Ellipsoid(EllipsoidCore ellipsoidCore) {
			this.ellipsoidCore = ellipsoidCore;
		}
		public Ellipsoid()
			: this(EllipsoidCore.WGS84) {
		}
		public Ellipsoid(double semimajorAxis, double inverseFlattening, string name)
			: this(EllipsoidCore.CreateBySemimajorAndInverseFlattering(semimajorAxis, inverseFlattening, name)) {
		}
		void RecreateEllipsoidCore(double axis, double secondParameter, string name) {
			this.ellipsoidCore = EllipsoidCore.CreateBySemimajorAndInverseFlattering(axis, secondParameter, name);
		}
	}
}
