...
namespace DevExpress.Xpf.Map {
	public class MapPolylineSettings : MapItemSettings {
		public static readonly DependencyProperty FillRuleProperty = DependencyPropertyManager.Register("FillRule",
		   typeof(FillRule), typeof(MapPolylineSettings), new PropertyMetadata(FillRule.EvenOdd, UpdateItems));
		...
		protected override MapDependencyObject CreateObject() {
			return new MapPolylineSettings();
		}
		...
		protected override void FillPropertiesMappings(DependencyPropertyMappingDictionary mappings) {
			...
			mappings.Add(MapPolylineSettings.FillRuleProperty, MapPolyline.FillRuleProperty);
		}
	}
}
