...
namespace DevExpress.Xpf.Map.Design {
	public class MeasureUnitEditor : ExtendedPropertyValueEditor {
		public MeasureUnitEditor() {
			DataTemplate customTemplate = new DataTemplate();
			FrameworkElementFactory comboBox = new FrameworkElementFactory(typeof(ComboBox));
			comboBox.SetValue(ComboBox.ItemsSourceProperty, MeasureUnit.GetPredefinedUnits());
