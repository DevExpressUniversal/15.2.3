...
namespace DevExpress.Web.ASPxSpreadsheet {
	public class SRRenameTableCommand : SRTextBoxCommandBase {
		protected override WebSpreadsheetCommandID WebCommandID {
			get {
				return WebSpreadsheetCommandID.RenameTableWebCommand;
			}
		}
		protected override SpreadsheetCommandId CommandID {
			get {
				return SpreadsheetCommandId.TableToolsRenameTable;
			}
		}
	}
}
