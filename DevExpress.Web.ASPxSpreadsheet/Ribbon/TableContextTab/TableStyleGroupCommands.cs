...
namespace DevExpress.Web.ASPxSpreadsheet {
	public class SRModifyTableStyleCommand : SRButtonCommandBase {
		protected override WebSpreadsheetCommandID WebCommandID {
			get {
				return WebSpreadsheetCommandID.ModifyTableStyleWebCommand;
			}
		}
		protected override SpreadsheetCommandId CommandID {
			get {
				return SpreadsheetCommandId.ModifyTableStyles;
			}
		}
		...
		protected override ItemImagePropertiesBase GetSmallImage() {
			...
			var properties = SpreadsheetRibbonHelper.GetRibbonItemSmallImageProperty(this, SpreadsheetCommandId.FormatAsTable);
			return properties;
		}
		protected override ItemImagePropertiesBase GetLargeImage() {
			if(!base.GetLargeImage().IsEmpty)
				return base.GetLargeImage();
			var properties = SpreadsheetRibbonHelper.GetRibbonItemLargeImageProperty(this, SpreadsheetCommandId.FormatAsTable);
			return properties;
		}
	}
}
