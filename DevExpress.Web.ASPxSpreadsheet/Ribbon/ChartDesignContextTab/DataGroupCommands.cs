...
namespace DevExpress.Web.ASPxSpreadsheet {
	public class SRChartSwitchRowColumnCommand : SRButtonCommandBase {
		protected override SpreadsheetCommandId CommandID {
			get {
				return SpreadsheetCommandId.ChartSwitchRowColumn;
			}
		}
	}
	public class SRChartSelectDataCommand : SRButtonCommandBase {
		protected override SpreadsheetCommandId CommandID {
			get {
		...
		protected override WebSpreadsheetCommandID WebCommandID {
			get {
				return WebSpreadsheetCommandID.ChartSelectData;
			}
		}
	}
}
