...
namespace DevExpress.Web.ASPxPivotGrid {
	...
	public class CustomizePivotCellEventArgs {
		...
		readonly PivotCellBaseEventArgs cellItemInfo;
		readonly PivotFieldValueEventArgs valueItemInfo;
		...
		public PivotCellBaseEventArgs CellItemInfo { get { return cellItemInfo; } }
		public PivotFieldValueEventArgs ValueItemInfo { get { return valueItemInfo; } }
		...
		internal CustomizePivotCellEventArgs(CustomizePivotCellEventArgsCore coreArgs) {
			...
			if(coreArgs.CellItem != null)
				cellItemInfo = new PivotCellBaseEventArgs(coreArgs.CellItem);
			if(coreArgs.ValueItem != null)
				valueItemInfo = new PivotFieldValueEventArgs(coreArgs.ValueItem);
		}
	}
}
