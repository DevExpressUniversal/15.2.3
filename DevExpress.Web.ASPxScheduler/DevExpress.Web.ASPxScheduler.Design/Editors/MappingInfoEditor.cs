...
namespace DevExpress.Web.ASPxScheduler.Design {
	#region ASPxAppointmentMappingInfoTypeEditor
	public class ASPxAppointmentMappingInfoTypeEditor : AppointmentMappingInfoTypeEditor {
		...
		protected internal override XtraScheduler.Design.Wizards.SetupBaseMappingsWizardRunner<Appointment> CreateWizardRunner(System.ComponentModel.Design.IDesignerHost host, IPersistentObjectStorage<Appointment> objectStorage, IDataFieldsProvider dataFieldsProvider) {
			return new ASPxSetupAppointmentBaseMappingsWizardRunner(host, objectStorage, dataFieldsProvider);
		}
	}
	#endregion
	#region ASPxResourceMappingInfoTypeEditor
	public class ASPxResourceMappingInfoTypeEditor : ResourceMappingInfoTypeEditor {
		...
		protected internal override XtraScheduler.Design.Wizards.SetupBaseMappingsWizardRunner<Resource> CreateWizardRunner(System.ComponentModel.Design.IDesignerHost host, IPersistentObjectStorage<Resource> objectStorage, IDataFieldsProvider dataFieldsProvider) {
			return new ASPxSetupResourceBaseMappingsWizardRunner(host, objectStorage, dataFieldsProvider);
		}
	}
	#endregion
}
