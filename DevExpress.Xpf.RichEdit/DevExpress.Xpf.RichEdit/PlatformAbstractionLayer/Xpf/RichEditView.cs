...
namespace DevExpress.Xpf.RichEdit.Views {
	public class XpfRichEditViewRepository : RichEditViewRepository {
		public XpfRichEditViewRepository(IRichEditControl control)
			: base(control) {
		}
		protected internal override SimpleView CreateSimpleView() {
			return new XpfSimpleView(Control);
		}
		protected internal override DraftView CreateDraftView() {
			return new XpfDraftView(Control);
		}
		protected internal override PrintLayoutView CreatePrintLayoutView() {
			return new XpfPrintLayoutView(Control);
		}
		protected internal override ReadingLayoutView CreateReadingLayoutView() {
			return new XpfReadingLayoutView(Control);
		}
	}
}
