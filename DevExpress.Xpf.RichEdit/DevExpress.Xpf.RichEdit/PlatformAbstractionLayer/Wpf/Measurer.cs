...
namespace DevExpress.XtraRichEdit.Layout.Engine {
	public class WpfBoxMeasurer : GdiBoxMeasurer {
		readonly WpfFontInfoMeasurer fontInfoMeasurer;
		public WpfBoxMeasurer(DocumentModel documentModel, Graphics gr)
			: base(documentModel, gr) {
			this.fontInfoMeasurer = new WpfFontInfoMeasurer(DocumentModel.LayoutUnitConverter);
		}
		#region Properties
		protected WpfFontInfoMeasurer FontInfoMeasurer { get { return fontInfoMeasurer; } }
		#endregion
