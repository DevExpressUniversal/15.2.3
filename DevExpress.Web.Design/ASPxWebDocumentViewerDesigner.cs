...
using DevExpress.Web.Design.Reports.WebDocumentViewer;
...
namespace DevExpress.XtraReports.Web.Design {
	public class ASPxWebDocumentViewerDesigner : ASPxWebUIControlDesigner {
		ASPxWebDocumentViewer webDocumentViewer;
		public override void Initialize(IComponent component) {
			base.Initialize(component);
			webDocumentViewer = (ASPxWebDocumentViewer)component;
		}
		...
		protected override ClientControlsDesignModeInfo CreateClientControlsDesignModeInfo() {
			return WebDocumentViewerDesignModeInfoGenerator.Generate();
		}
		protected override ASPxWebControlDesignerActionList CreateCommonActionList() {
			return new ASPxWebDocumentViewerDesignerActionList(this);
		}
		public override void RunDesigner() {
			ShowDialog(new WrapperEditorForm(new WebDocumentViewerMenuItemsOwner(webDocumentViewer, DesignerHost)));
		}
	}
}
