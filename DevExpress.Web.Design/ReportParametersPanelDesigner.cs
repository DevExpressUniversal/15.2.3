...
namespace DevExpress.XtraReports.Web.Design {
	public class ReportParametersPanelDesigner : ASPxWebControlDesigner {
		public ReportParametersPanel ReportParametersPanel { get; private set; }
		protected override ASPxWebControlDesignerActionList CreateCommonActionList() {
			return new ReportParametersPanelActionList(this);
		}
		...
		public override void Initialize(IComponent component) {
			...
			ReportParametersPanel = (ReportParametersPanel)component;
		}
