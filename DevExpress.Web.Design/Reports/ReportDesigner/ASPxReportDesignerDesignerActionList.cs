...
namespace DevExpress.Web.Design.Reports.ReportDesigner {
	class ASPxReportDesignerDesignerActionList : XRWebControlDesignerActionListBase<ASPxReportDesigner> {
		...
		public ASPxReportDesignerDesignerActionList(ASPxReportDesignerDesigner designer)
			: base(designer) {
		}
