...
namespace DevExpress.Web.Design.Reports.DocumentViewer {
	class DocumentViewerSetReportServiceReportNamePresenter : SetReportServiceReportNamePresenter<ISetReportServiceReportNameView> {
		public DocumentViewerSetReportServiceReportNamePresenter(ISetReportServiceReportNameView view, ReportTypesProvider reportTypesProvider)
			: base(view, reportTypesProvider) {
		}
