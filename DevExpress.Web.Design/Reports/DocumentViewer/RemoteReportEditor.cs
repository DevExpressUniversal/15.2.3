...
namespace DevExpress.Web.Design.Reports.DocumentViewer {
	class RemoteReportEditor : UITypeEditor {
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object objValue) {
			if(context != null && context.Instance is ASPxDocumentViewerDesignerActionList) {
				var actionList = (ASPxDocumentViewerDesignerActionList)context.Instance;
				actionList.ConfigureRemoteReport();
			}
			return objValue;
		}
