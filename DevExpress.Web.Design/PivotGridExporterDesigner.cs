...
namespace DevExpress.Web.ASPxPivotGrid.Export.Design {
	public class ASPxPivotGridExporterDesigner : ControlDesigner {
		public override void Initialize(IComponent component) {
			...
			if(host != null) {
				DevExpress.Utils.Design.ReferencesHelper.EnsureReferences(host,
					...
					AssemblyInfo.SRAssemblyASPxPivotGridExport,
					AssemblyInfo.SRAssemblyPivotGridCore,
					AssemblyInfo.SRAssemblyPivotGrid,
