...
namespace DevExpress.Xpf.Charts.Native {
	public class XYSeriesLabel3DLayout : SeriesLabel3DLayout {
		readonly Point3D point;
		readonly Vector3D direction;
		public XYSeriesLabel3DLayout(SeriesLabel label, Point3D point, Vector3D direction) : base(label) {
			this.point = point;
