...
namespace DevExpress.Xpf.Charts.ModelSupport {
	public class Pie3DChartConfigurator : ChartConfigurator {
		new Model.Pie3DChart ChartModel { get { return base.ChartModel as Model.Pie3DChart; } }
		protected override bool Is3D { get { return true; } }
		public Pie3DChartConfigurator(Model.Chart chartModel, Model.IModelElementContainer container) : base(chartModel, container) {
		}
