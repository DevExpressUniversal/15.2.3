...
namespace DevExpress.Xpf.Charts {
	public class RelativeStrengthIndex : SeparatePaneIndicator {
		...
		public static readonly DependencyProperty ValueLevelProperty = DependencyPropertyManager.Register("ValueLevel", typeof(ValueLevel), typeof(RelativeStrengthIndex), new PropertyMetadata(ValueLevel.Close, ChartElementHelper.Update));
		public static readonly DependencyProperty PointsCountProperty = DependencyPropertyManager.Register("PointsCount", typeof(int), typeof(RelativeStrengthIndex), new PropertyMetadata(DefaultPointsCount, ChartElementHelper.Update));
		readonly RelativeStrengthIndexCalculator calculator = new RelativeStrengthIndexCalculator();
		...
		public RelativeStrengthIndex() {
			DefaultStyleKey = typeof(RelativeStrengthIndex);
		}
		...
		protected override void Assign(Indicator indicator) {
			...
			RelativeStrengthIndex relativeStrengthIndex = indicator as RelativeStrengthIndex;
			if (relativeStrengthIndex != null) {
				CopyPropertyValueHelper.CopyPropertyValue(this, relativeStrengthIndex, ValueLevelProperty);
				CopyPropertyValueHelper.CopyPropertyValue(this, relativeStrengthIndex, PointsCountProperty);
			}
		}
