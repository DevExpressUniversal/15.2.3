...
namespace DevExpress.Xpf.Charts {
	public class DetrendedPriceOscillator : SeparatePaneIndicator {
		...
		public static readonly DependencyProperty ValueLevelProperty = DependencyPropertyManager.Register("ValueLevel", typeof(ValueLevel), typeof(DetrendedPriceOscillator), new PropertyMetadata(DefaultValueLevel, ChartElementHelper.Update));
		public static readonly DependencyProperty PointsCountProperty = DependencyPropertyManager.Register("PointsCount", typeof(int), typeof(DetrendedPriceOscillator), new PropertyMetadata(DefaultPointsCount, ChartElementHelper.Update));
		readonly DetrendedPriceOscillatorCalculator calculator = new DetrendedPriceOscillatorCalculator();
		...
		public DetrendedPriceOscillator() {
			DefaultStyleKey = typeof(DetrendedPriceOscillator);
		}
		...
		protected override void Assign(Indicator indicator) {
			...
			DetrendedPriceOscillator commodityChannelIndex = indicator as DetrendedPriceOscillator;
