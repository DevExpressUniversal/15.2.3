...
namespace DevExpress.Xpf.Charts {
	public class CommodityChannelIndex : SeparatePaneIndicator {
		...
		public static readonly DependencyProperty PointsCountProperty = DependencyPropertyManager.Register("PointsCount", typeof(int), typeof(CommodityChannelIndex), new PropertyMetadata(DefaultPointsCount, ChartElementHelper.Update));
		readonly CommodityChannelIndexCalculator calculator = new CommodityChannelIndexCalculator();
		...
		public CommodityChannelIndex() {
			DefaultStyleKey = typeof(CommodityChannelIndex);
		}
		...
		protected override void Assign(Indicator indicator) {
			...
			CommodityChannelIndex commodityChannelIndex = indicator as CommodityChannelIndex;
