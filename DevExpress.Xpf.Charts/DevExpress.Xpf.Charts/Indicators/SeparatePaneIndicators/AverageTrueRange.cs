...
namespace DevExpress.Xpf.Charts {
	public class AverageTrueRange : SeparatePaneIndicator {
		...
		public static readonly DependencyProperty PointsCountProperty = DependencyPropertyManager.Register("PointsCount", typeof(int), typeof(AverageTrueRange), new PropertyMetadata(DefaultPointsCount, ChartElementHelper.Update));
		readonly AverageTrueRangeCalculator calculator = new AverageTrueRangeCalculator();
		...
		public AverageTrueRange() {
			DefaultStyleKey = typeof(AverageTrueRange);
		}
		...
		protected override void Assign(Indicator indicator) {
			...
			AverageTrueRange averageTrueRange = indicator as AverageTrueRange;
			if (averageTrueRange != null) {
				CopyPropertyValueHelper.CopyPropertyValue(this, averageTrueRange, PointsCountProperty);
			}
		}
