...
namespace DevExpress.Xpf.Charts {
	public class ChaikinsVolatility : SeparatePaneIndicator {
		...
		public static readonly DependencyProperty PointsCountProperty = DependencyPropertyManager.Register("PointsCount", typeof(int), typeof(ChaikinsVolatility), new PropertyMetadata(DefaultPointsCount, ChartElementHelper.Update));
		readonly ChaikinsVolatilityCalculator calculator = new ChaikinsVolatilityCalculator();
		...
		public ChaikinsVolatility() {
			DefaultStyleKey = typeof(ChaikinsVolatility);
		}
		...
		protected override void Assign(Indicator indicator) {
			...
			ChaikinsVolatility chaikinsVolatility = indicator as ChaikinsVolatility;
			if (chaikinsVolatility != null) {
				CopyPropertyValueHelper.CopyPropertyValue(this, chaikinsVolatility, PointsCountProperty);
			}
		}
