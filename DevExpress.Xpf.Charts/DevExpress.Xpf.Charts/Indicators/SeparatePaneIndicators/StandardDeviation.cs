...
namespace DevExpress.Xpf.Charts {
	public class StandardDeviation : SeparatePaneIndicator {
		...
		public static readonly DependencyProperty ValueLevelProperty = DependencyPropertyManager.Register("ValueLevel", typeof(ValueLevel), typeof(StandardDeviation), new PropertyMetadata(ValueLevel.Close, ChartElementHelper.Update));
		public static readonly DependencyProperty PointsCountProperty = DependencyPropertyManager.Register("PointsCount", typeof(int), typeof(StandardDeviation), new PropertyMetadata(DefaultPointsCount, ChartElementHelper.Update));
		readonly StandardDeviationCalculator calculator = new StandardDeviationCalculator();
		...
		public StandardDeviation() {
			DefaultStyleKey = typeof(StandardDeviation);
		}
		...
		protected override void Assign(Indicator indicator) {
			...
			StandardDeviation standardDeviation = indicator as StandardDeviation;
			if (standardDeviation != null) {
				CopyPropertyValueHelper.CopyPropertyValue(this, standardDeviation, ValueLevelProperty);
				CopyPropertyValueHelper.CopyPropertyValue(this, standardDeviation, PointsCountProperty);
			}
		}
