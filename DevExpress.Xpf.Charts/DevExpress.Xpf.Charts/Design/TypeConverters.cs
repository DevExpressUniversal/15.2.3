...
namespace DevExpress.Xpf.Charts.Design {
	public class DefaultDateAttribute : DefaultValueAttribute {
		public DefaultDateAttribute() : base(DateTime.MaxValue) {
		}
	}
	public class AxisValueTypeConverter : TypeConverter {
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
			...
			return str == null ? base.ConvertFrom(context, culture, value) : str;
		}
	}
	...
	public class DataTypeTypeConverter : TypeConverter {
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
			...
			if (type == null )
				throw new ArgumentException("An incorrect or non-existent type has been defined.");
			return type;
		}
	}
