...
namespace DevExpress.Xpf.Charts {
	...
	public class SplineAreaSeries2D : AreaSeries2D {
		...
		public static readonly DependencyProperty LineTensionProperty = DependencyProperty.Register(
			"LineTension", typeof(double), typeof(SplineAreaSeries2D), new PropertyMetadata(defaultLineTension, OnLineTensionChange));
		static void OnLineTensionChange(DependencyObject obj, DependencyPropertyChangedEventArgs e) {
			SplineAreaSeries2D control = obj as SplineAreaSeries2D;
			if (control != null) {
		...
		[
#if !SL
	DevExpressXpfChartsLocalizedDescription("SplineAreaSeries2DLineTension"),
#endif
		...
		public SplineAreaSeries2D() {
			DefaultStyleKey = typeof(SplineAreaSeries2D);
		}
		protected override void AssignForBinding(Series series) {
			base.AssignForBinding(series);
			SplineAreaSeries2D spline = series as SplineAreaSeries2D;
			if (spline != null)
		...
		protected override GeometryStripCreator CreateStripCreator() {
			return new SplineAreaGeometryStripCreator(ActualLineTension);
		}
		protected internal override AdditionalLineSeriesGeometry CreateAdditionalGeometry() {
			return new AdditionalSplineAreaSeriesGeometry(this);
		}
	}
}
