...
namespace DevExpress.Xpf.Charts {
	...
	public class SplineAreaFullStackedSeries2D : AreaFullStackedSeries2D, IStackedSplineView, IGeometryStripCreator {
		...
		public static readonly DependencyProperty LineTensionProperty = DependencyProperty.Register(
			"LineTension", typeof(double), typeof(SplineAreaFullStackedSeries2D), new PropertyMetadata(defaultLineTension, OnLineTensionChange));
		static void OnLineTensionChange(DependencyObject obj, DependencyPropertyChangedEventArgs e) {
			SplineAreaFullStackedSeries2D control = obj as SplineAreaFullStackedSeries2D;
			if (control != null) {
		...
		[
#if !SL
	DevExpressXpfChartsLocalizedDescription("SplineAreaFullStackedSeries2DLineTension"),
#endif
		...
		public SplineAreaFullStackedSeries2D() {
			DefaultStyleKey = typeof(SplineAreaFullStackedSeries2D);
		}
		protected override void AssignForBinding(Series series) {
			base.AssignForBinding(series);
			SplineAreaFullStackedSeries2D spline = series as SplineAreaFullStackedSeries2D;
			if (spline != null)
				CopyPropertyValueHelper.CopyPropertyValue(this, spline, LineTensionProperty);
		}
		protected override Series CreateObjectForClone() {
			return new SplineAreaFullStackedSeries2D();
		}
