...
namespace DevExpress.Charts.Designer.Native {
	public class SetNestedDonutWeightCommand : SeriesOptionsCommandBase {
		...
		public SetNestedDonutWeightCommand(WpfChartModel chartModel)
			: base(chartModel) { }
		...
		public override CommandResult RuntimeExecute(object parameter) {
			...
			double oldValue = SelectedSeriesModel.Weight;
			SelectedSeriesModel.Weight = newValue;
