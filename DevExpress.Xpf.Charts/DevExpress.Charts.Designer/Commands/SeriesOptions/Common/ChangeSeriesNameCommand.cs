...
namespace DevExpress.Charts.Designer.Native {
	public class ChangeSeriesNameCommand : SeriesOptionsCommandBase {
		...
		public override CommandResult RuntimeExecute(object parameter) {
			...
			return new CommandResult(new HistoryItem(new ExecuteCommandInfo(parameter, indexItems), this, SeriesModel, oldName, newName), SeriesModel.Series);
		}
	}
}
