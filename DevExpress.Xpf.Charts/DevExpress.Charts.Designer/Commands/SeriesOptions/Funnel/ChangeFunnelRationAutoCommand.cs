...
namespace DevExpress.Charts.Designer.Native {
	public class ChangeFunnelRationAutoCommand : SeriesOptionsCommandBase {
		...
		public override string Caption {
			get { return ChartDesignerLocalizer.GetString(ChartDesignerStringIDs.SeriesOptions_FunnelRatioAuto); }
		}
		public override string ImageName {
			get { return GlyphUtils.GalleryItemImages + @"SeriesPointAndSeriesModels\ChangeFunnelRationAuto"; }
		}
		public ChangeFunnelRationAutoCommand(WpfChartModel chartModel)
			: base(chartModel) { }
		...
		protected override object RuntimeRedo(HistoryItem historyItem) {
			...
			funnelSeries.HeightToWidthRatioAuto = (bool)historyItem.NewValue;
			return null;
		}
		protected override object RuntimeUndo(HistoryItem historyItem) {
			int seriesIndex = historyItem.ExecuteCommandInfo.IndexByNameDictionary[seriesIndexKey];
			var funnelSeries = (FunnelSeries2D)PreviewChart.Diagram.Series[seriesIndex];
			funnelSeries.HeightToWidthRatioAuto = (bool)historyItem.OldValue;
			return null;
		}
		...
		public override void DesigntimeApply(IModelItem chartModelItem, HistoryItem historyItem, IDesignTimeProvider designTimeProvider) {
			...
			seriesModelItem.Properties["HeightToWidthRatioAuto"].SetValue(historyItem.NewValue);
		}
		...
		public override CommandResult RuntimeExecute(object parameter) {
			...
			bool oldValue = SelectedSeriesModel.HeightToWidthRatioAuto;
			SelectedSeriesModel.HeightToWidthRatioAuto = newValue;
