...
namespace DevExpress.Charts.Designer.Native {
	public class ChangeIsSeriesTemplatePreviewCommand : SeriesOptionsCommandBase {
		public override string Caption { get { return null; } }
		public override string ImageName { get { return null; } }
		public ChangeIsSeriesTemplatePreviewCommand(WpfChartModel model) : base(model) { }
		...
		protected override void RedoInternal(WpfChartSeriesModel model, object newValue) {
			model.IsSeriesTemplatePreview = (bool)newValue;
		}
		...
		protected override void UndoInternal(WpfChartSeriesModel model, object oldValue) {
			model.IsSeriesTemplatePreview = (bool)oldValue;
		}
		public override CommandResult RuntimeExecute(object parameter) {
			bool newValue = (bool)parameter;
			bool oldValue = SeriesModel.IsSeriesTemplatePreview;
			SeriesModel.IsSeriesTemplatePreview = newValue;
			...
			return new CommandResult(new HistoryItem(new ExecuteCommandInfo(parameter, indexItems), this, SeriesModel, oldValue, newValue));
		}
	}
}
