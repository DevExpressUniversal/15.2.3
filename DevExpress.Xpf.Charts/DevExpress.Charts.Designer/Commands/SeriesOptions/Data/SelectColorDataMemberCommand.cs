...
namespace DevExpress.Charts.Designer.Native {
	public class SelectColorDataMemberCommand : SelectDataMemberCommandBase {
		public override string Caption {
			get { return ChartDesignerLocalizer.GetString(ChartDesignerStringIDs.SeriesOptions_ColorDataMember); }
		}
		public SelectColorDataMemberCommand(WpfChartModel model)
			: base(model) {
		}
		...
		public override CommandResult DataMemberRuntimeExecute(object parameter) {
			...
			DataMemberInfo ColorDataMember = parameter as DataMemberInfo;
			if (String.IsNullOrEmpty(ColorDataMember.DataMember) || ColorDataMember.DataMember == "None")
				ColorDataMember = new DataMemberInfo();
			DataMemberInfo oldValue = SeriesModel.ColorDataMember;
			if (ColorDataMember != oldValue) {
				...
				SeriesModel.ColorDataMember = ColorDataMember;
				resultItem.HistoryItems.Add(new HistoryItem(new ExecuteCommandInfo(parameter, indexItems), this, null, oldValue, ColorDataMember));
				if (SeriesModel.IsSeriesTemplate) {
					if (String.IsNullOrEmpty(ColorDataMember.DataMember) && !AllDataMembersSet()) {
