...
namespace DevExpress.Xpf.Charts.Design {
	internal class RegisterMetadata : MetadataProviderBase {
		protected override void PrepareAttributeTable(AttributeTableBuilder builder) {
			...
			FrameworkElementSmartTagPropertiesViewModel.RegisterPropertyLineProvider(new ChartControlPropertyLinesProvider());
			FrameworkElementSmartTagPropertiesViewModel.RegisterPropertyLineProvider(new DiagramPropertyLinesProvider());
		}
