...
namespace DevExpress.Xpf.Spreadsheet.Design {
	public static partial class BarInfos {
		public static BarInfo PictureToolsFormatArrange { get { return pictureToolsFormatArrange; } }
		static readonly BarInfo pictureToolsFormatArrange = new BarInfo(
			"Picture Tools",
			"Format",
			"Arrange",
			new BarInfoItems(
