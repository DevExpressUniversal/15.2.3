...
namespace DevExpress.Xpf.Spreadsheet.Design {
	public static partial class BarInfos {
		public static BarInfo DrawingToolsFormatArrange { get { return drawingToolsFormatArrange; } }
		static readonly BarInfo drawingToolsFormatArrange = new BarInfo(
			"Drawing Tools",
			"Format",
			"Arrange",
			new BarInfoItems(
