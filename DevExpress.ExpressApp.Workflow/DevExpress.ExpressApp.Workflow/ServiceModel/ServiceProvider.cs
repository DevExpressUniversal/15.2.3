...
namespace DevExpress.ExpressApp.Workflow.ServiceModel {
	[Obsolete("Use 'DevExpress.ExpressApp.MiddleTier.CustomHandleServiceExceptionEventArgs' instead.")]
	...
	[Obsolete("Use 'DevExpress.ExpressApp.MiddleTier.ServiceProvider' instead.")]
