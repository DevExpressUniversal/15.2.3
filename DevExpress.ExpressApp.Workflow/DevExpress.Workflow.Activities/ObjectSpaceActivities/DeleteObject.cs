...
namespace DevExpress.Workflow.Activities {
	...
	[ToolboxBitmap(typeof(ObjectSpaceTransactionScope), "Images.DeleteObject.bmp")]
	public class DeleteObject<T> : ObjectSpaceActivityBase {
		[RequiredArgument]
		...
		protected override void Execute(NativeActivityContext context) {
			...
			os.Delete(os.GetObjectByKey<T>(Key.Get(context)));
		}
	}
}
