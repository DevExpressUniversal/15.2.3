...
namespace DevExpress.Xpf.Printing.DataNodes {
	class VisualNode : VisualNodeBase, IVisualDetailNode {
		readonly object data;
		public VisualNode(IDataNode parent, int index, object data)
			: base(parent, index) {
			this.data = data;
		}
		...
		public RowViewInfo GetDetail(bool allowContentReuse) {
			return Root.ItemTemplate != null ? new RowViewInfo(Root.ItemTemplate, data) : null;
		}
		#endregion
	}
}
