...
namespace DevExpress.Xpf.Printing.BrickCollection {
	...
	class TrackBarBrickCreator : BrickCreator {
		public TrackBarBrickCreator(PrintingSystemBase ps, Dictionary<BrickStyleKey, BrickStyle> brickStyles, Dictionary<IVisualBrick, IOnPageUpdater> onPageUpdaters)
