...
namespace DevExpress.Xpf.Printing.BrickCollection {
	class PanelBrickCreator : BrickCreator {
		public PanelBrickCreator(PrintingSystemBase ps, Dictionary<BrickStyleKey, BrickStyle> brickStyles, Dictionary<IVisualBrick, IOnPageUpdater> onPageUpdaters)
		...
		public override VisualBrick Create(UIElement source, UIElement parent) {
			...
			IExportSettings exportSettings = new EffectiveExportSettings(source);
