...
namespace DevExpress.Xpf.Printing.Native {
	public class PdfSignatureOptionsEditor : IDXTypeEditor {
		public void Edit(object value, Window ownerWindow) {
			PdfSignatureOptions sourceOptions = (PdfSignatureOptions)value;
			PdfSignatureOptions options = new PdfSignatureOptions();
			options.Assign(sourceOptions);
			PdfSignatureEditorWindow window = new PdfSignatureEditorWindow() { Owner = ownerWindow };
			new PdfSignatureEditorPresenter(options, window);
