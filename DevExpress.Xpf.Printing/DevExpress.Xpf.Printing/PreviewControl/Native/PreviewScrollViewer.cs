...
namespace DevExpress.Xpf.Printing.PreviewControl.Native {
	public class PreviewScrollViewer : DevExpress.Xpf.DocumentViewer.DXScrollViewer {
		...
		static PreviewScrollViewer() {
			...
			VerticalScrollBarWidthPropertyKey = DependencyPropertyManager.RegisterReadOnly("VerticalScrollBarWidth", typeof(double), ownerType, new FrameworkPropertyMetadata(0d));
