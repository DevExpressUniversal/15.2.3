...
namespace DevExpress.Xpf.Printing {
	...
	public class DockPanelVisibilityConverter : IMultiValueConverter {
		public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture) {
			...
			var canShow = (values[1] as bool?).Return(x => x.Value, () => false);
			var autoShow = (bool)values[2];
			var visible = isChecked.HasValue ? canShow && isChecked.Value : autoShow && canShow;
			return visible ? Visibility.Visible : Visibility.Collapsed;
		}
		public object[] ConvertBack(object value, Type[] targetTypes, object parameter, System.Globalization.CultureInfo culture) {
			var visibility = (Visibility)value;
			var visible = visibility == Visibility.Visible;
			return new object[] { visible };
		}
	}
	public class ProgressTypeToEditSettingsConverter : MarkupExtension, IValueConverter {
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture) {
			var progressType = (ProgressType)value;
			return progressType == ProgressType.Marquee ? (BaseProgressBarStyleSettings)new ProgressBarMarqueeStyleSettings() : new ProgressBarStyleSettings();
		}
