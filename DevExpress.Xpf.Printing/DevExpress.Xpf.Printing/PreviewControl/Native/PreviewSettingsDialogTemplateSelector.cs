...
namespace DevExpress.Xpf.Printing.PreviewControl.Native {
	class PreviewSettingsDialogTemplateSelector : DataTemplateSelector {
		...
		public override System.Windows.DataTemplate SelectTemplate(object item, System.Windows.DependencyObject container) {
			var settingsModel = item as PreviewSettingsViewModelBase;
			if(settingsModel == null)
				return null;
			switch(settingsModel.SettingsType) {
				case SettingsType.Export:
					return ExportOptionsDialogTemplate;
				case SettingsType.Send:
					return SendOptionsDialogTemplate;
				case SettingsType.Scale:
					return ScaleDialogTemplate;
				case SettingsType.Print:
					return PrintOptionsDialogTemplate;
				case SettingsType.PageSettings:
				case SettingsType.Watermark:
				default:
					return null;
			}
		}
