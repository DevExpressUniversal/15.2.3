...
#endif
{
	public class JavaScriptExpressionParser : ExpressionParserBase
	{
		public JavaScriptExpressionParser(ParserBase parser) : base(parser)
	  {
		}
		...
		{
			JavaScriptParser parser = new JavaScriptParser();
			return parser.ParseTypeReferenceExpression(reader);
		}
	}
}
