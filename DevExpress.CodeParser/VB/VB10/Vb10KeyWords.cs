...
#endif
{
	public sealed class VB10KeyWords
	{
		private static StringCollection _KeyWords = null;
		private VB10KeyWords(){}
		static void CreateKeywords()
		{
			lock (typeof(VB10KeyWords))
			{
				_KeyWords = new StringCollection();
				string[] lWords = new string[VB90KeyWords.Collection.Count];
				VB90KeyWords.Collection.CopyTo(lWords, 0);
