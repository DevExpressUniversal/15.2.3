...
#endif
{	
	public class VB90ExpressionInverter : ExpressionInverterBase
	{
		protected override Expression InvertIsExpression(Is expression)
		{
			return new IsNot(expression.LeftSide, expression.RightSide);
		}
		protected override Expression InvertIsNotExpression(IsNot expression)
		{
			return new Is(expression.LeftSide, expression.RightSide);
		}
	}
	public class VBOldExpressionInverter : ExpressionInverterBase
	{
		protected override Expression InvertIsExpression(Is expression)
		{
