...
#endif
{
	public class BaseReferenceExpression : Expression, IBaseReferenceExpression
	{
		...
		#endregion
		#region BaseReferenceExpression(string name, SourceRange range)
	  ...
	  SetRange(range);
		...
		{
			return ImageIndex.BaseReference;
		}
		#endregion
		...
		{
			BaseReferenceExpression lClone = new BaseReferenceExpression();
		...
		public override LanguageElementType ElementType
		{
			get 
			{
				return LanguageElementType.BaseReferenceExpression;
			}
		}
		#endregion		
		#region NameRange
