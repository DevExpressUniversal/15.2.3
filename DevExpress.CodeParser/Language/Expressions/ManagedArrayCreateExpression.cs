...
#endif
{	
	public class ManagedArrayCreateExpression: ArrayCreateExpression
	{
		protected ManagedArrayCreateExpression() :
			base()
		{
		}
		...
		public ManagedArrayCreateExpression(TypeReferenceExpression type, ExpressionCollection dimensions, ArrayInitializerExpression initializer) :
			base(type, dimensions, initializer)
		{
		}
		#region Clone
		public override BaseElement Clone(ElementCloneOptions options)
		{
			ManagedArrayCreateExpression lClone = new ManagedArrayCreateExpression();
		...
		public override LanguageElementType ElementType
		{
			get 
			{
				return LanguageElementType.ManagedArrayCreateExpression;
			}
		}
		#endregion
	}
