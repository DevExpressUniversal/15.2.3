...
#endif
{
	public class IsNot : TypeCheck, IIsNotExpression
	{
		...
		#endregion
		#region IsNot(Expression left, Token token, Expression right)
		public IsNot(Expression left, Token token, Expression right)
			: base (left, token, right)
		{
		}
		#endregion
		#region IsNot(Expression left, Expression right)
		...
		public override bool IsIdenticalTo(Expression expression)
		{
			...
			{
				IsNot lExpression = (IsNot)expression;
		...
		public override LanguageElementType ElementType
		{
			get 
			{
				return LanguageElementType.IsNot;
			}
		}		
	}
}
