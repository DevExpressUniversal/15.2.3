...
#endif
{
	public class CheckedExpression : Expression, ICheckedExpression
	{
	  ...
	  SetExpression(expression);
		...
		{			
			...
			if (!(source is CheckedExpression))
				return;
			CheckedExpression lSource = (CheckedExpression)source;
	...
	void SetExpression(Expression expression)
	{
	  ...
	  if (_Exp != null)
		...
		{
			return ImageIndex.CheckedExpression;
		}
		#endregion
		...
		public override bool IsIdenticalTo(Expression expression)
		{
			...
			{
				CheckedExpression lExpression = (CheckedExpression)expression;
				if (Expression == null)
					return false;
		...
		{
			CheckedExpression lClone = new CheckedExpression();
	  ...
	  get { return INT_MaintainanceComplexity; }
		...
		{
	  get { return LanguageElementType.CheckedExpression; }
		}
		#region Expression
	  ...
	  set { SetExpression(value); }
		...
		IExpression ICheckedExpression.Expression
		{
