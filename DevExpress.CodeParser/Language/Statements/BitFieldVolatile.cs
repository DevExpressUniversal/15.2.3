...
#endif
{
	public class BitFieldVolatile : Volatile
	{
		Expression _Size = null;
		protected BitFieldVolatile()
		{
		}
		...
		{			
			...
			if (!(source is BitFieldVolatile))
				return;			
			BitFieldVolatile bitField = (BitFieldVolatile)source;
		...
		{
			BitFieldVolatile bitField = new BitFieldVolatile();
		...
		public override LanguageElementType ElementType
		{
			get
			{
				return LanguageElementType.BitFieldVolatile;
			}
		}				
