...
#endif
{
	public class BitFieldConst : Const
	{		
		Expression _Size = null;
		protected BitFieldConst()
		{
		}
		public BitFieldConst(string type, string name, Expression size):base(type,name)
		{
			_Size = size;
			AddDetailNode(size);
		}
		...
		{			
			...
			if (!(source is BitFieldConst))
				return;			
			BitFieldConst bitField = (BitFieldConst)source;
		...
		{
			BitFieldConst bitField = new BitFieldConst();
		...
		public override LanguageElementType ElementType
		{
			get
			{
				return LanguageElementType.BitFieldConst;
			}
		}
