...
#endif
{
	public class UnsafeStatement : ParentToSingleStatement, IUnsafeStatement
	{
		...
		{
			UnsafeStatement clone = new UnsafeStatement();
		...
		public override LanguageElementType ElementType
		{
			get 
			{
				return LanguageElementType.UnsafeStatement;
			}
		}
	}
}
