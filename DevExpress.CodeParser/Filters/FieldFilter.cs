...
#endif
{	
	public class FieldFilter : ElementFilterBase
	{
		public FieldFilter()	{}
		public override bool Apply(IElement element)
		{
			if (element == null)
				return false;
			return ((element is IBaseVariable) && ((IBaseVariable)element).IsField);
		}
	...
	public class LocalFilter : ElementFilterBase
	{
		public LocalFilter()	{}
		public override bool Apply(IElement element)
		{
			if (element == null)
				return false;
			return ((element is IBaseVariable) && ((IBaseVariable)element).IsLocal);
		}
		public override bool SkipChildren(IElement element)
		{
			return false;
