...
#endif
{
	public sealed class CSharp20KeyWords
	{
		private static StringCollection _KeyWords = new StringCollection();
		private CSharp20KeyWords(){}
		#region CSharp20KeyWords
		static CSharp20KeyWords()
		{
			lock (typeof(CSharp20KeyWords))
			{
				_KeyWords.Add("get");
				_KeyWords.Add("set");
				_KeyWords.Add("this");
		...
		_KeyWords.Add("__arglist");
		_KeyWords.Add("__makeref");
		_KeyWords.Add("__reftype");
		_KeyWords.Add("__refvalue");
			}
		}
		#endregion
		#region KeyWords
