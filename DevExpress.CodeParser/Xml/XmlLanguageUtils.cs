...
{
  using Html;
  class XmlLanguageUtils : LanguageUtils
  {
	...
	public override CodeGen CreateCodeGen()
	{
	  ...
	  if (codeGen != null)
		codeGen.Code = new CodeWriter(new StringWriter(), new CodeGenOptions(ParserLanguageID.Xml));
	  return codeGen;
	}
	...
	sealed class XmlTokenizer : Tokenizer
	{
