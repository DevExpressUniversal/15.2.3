...
#endif
{
  public static class ElementBuilderFactory
  {
	...
	{
	  return CreateElementBuilder(FromString(language));
	}
	public static ElementBuilder CreateElementBuilder()
	{
	  return CreateElementBuilder(ParserLanguageID.None);
	}
  }
}
