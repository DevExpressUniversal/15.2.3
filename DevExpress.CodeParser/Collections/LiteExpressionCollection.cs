...
#endif
{
	...
	{
		int IndexOf(IExpression e);
		IExpression this[int index] { get; }
	}
	[Serializable]
	public class LiteExpressionCollection : NodeList, IExpressionCollection, ISerializableCollection
	{
		public LiteExpressionCollection() : this(1)
		{ 
		}
		...
		{
			return new LiteExpressionCollection();
		}
	public CollectionType CollectionType
	{
	  get
	  {
		return CollectionType.ExpressionCollection;
	  }
	}
