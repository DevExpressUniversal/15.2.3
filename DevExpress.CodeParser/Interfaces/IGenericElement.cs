...
#endif
{
	public interface IGenericElement : IElement
	{
		...
		bool IsGeneric { get; }
		bool IsActivatedGeneric { get; }
		IGenericElement GenericTemplate { get; }
	}
  public interface IGenericElementModifier : IElementModifier
  {
	void AddTypeParameter(ITypeParameter typeParameter);
	void RemoveTypeParameter(ITypeParameter typeParameter);
	void InsertTypeParameter(int index, ITypeParameter typeParameter);
  }
}
