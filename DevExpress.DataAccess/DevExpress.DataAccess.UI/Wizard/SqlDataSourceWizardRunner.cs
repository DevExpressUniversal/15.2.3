...
namespace DevExpress.DataAccess.UI.Wizard {
	public class SqlDataSourceWizardRunner<TModel> : DataSourceWizardRunnerBase<TModel, ISqlDataSourceWizardClientUI> where TModel : ISqlDataSourceModel, new() {
		Type startPage;
		public SqlDataSourceWizardRunner(UserLookAndFeel lookAndFeel, IWin32Window owner) : base(lookAndFeel, owner) { }
		internal SqlDataSourceWizardRunner(IWizardRunnerContext context) : base(context) { }
		protected override WizardPageFactoryBase<TModel, ISqlDataSourceWizardClientUI> CreatePageFactory(ISqlDataSourceWizardClientUI client) {
			this.startPage = client.DataConnections.Any() ?
		...
		protected override string WizardTitle {
			get { return "SqlDataSource Wizard"; }
		}
	}
}
