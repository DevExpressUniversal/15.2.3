...
namespace DevExpress.DataAccess.UI.Wizard.Clients {
	public class ExcelDataSourceWizardClientUI : ExcelDataSourceWizardClient, IExcelDataSourceWizardClientUI {
		public ExcelDataSourceWizardClientUI(IExcelSchemaProvider excelSchemaProvider) : base(excelSchemaProvider) {}
