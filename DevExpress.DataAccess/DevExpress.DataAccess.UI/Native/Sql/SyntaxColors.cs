...
namespace DevExpress.DataAccess.UI.Native.Sql {
	public class SyntaxColors : ISyntaxColors {
		...
		public UserLookAndFeel LookAndFeel { get { return this.lookAndFeel; } set { this.lookAndFeel = value; } }
		...
		Color GetColorByName(string colorName, Color defaultColor) {
			Skin skin = ReportsSkins.GetSkin(this.lookAndFeel);
		...
		Color GetCommonColorByName(string colorName, Color defaultColor) {
			...
			return skin == null ? defaultColor : skin.Colors[colorName];
		}
	}
}
