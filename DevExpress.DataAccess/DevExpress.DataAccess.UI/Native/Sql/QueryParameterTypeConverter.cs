...
namespace DevExpress.DataAccess.UI.Native.Sql {
	public class QueryParameterTypeConverter : ParameterTypeConverter {
		public const string ExtensionGuid = "QueryParameterEditorExtension";
		const string guid = "QueryParameterEditor";
