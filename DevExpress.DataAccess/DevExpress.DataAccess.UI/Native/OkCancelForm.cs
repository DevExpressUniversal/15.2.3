...
namespace DevExpress.DataAccess.UI.Native {
	public partial class OkCancelForm : XtraForm {
		protected virtual bool Sizable { get { return true; } }
		public OkCancelForm(IServiceProvider serviceProvider) : this() {
		...
		protected override void OnLoad(EventArgs e) {
			...
			SizeGripStyle = Sizable ? SizeGripStyle.Show : SizeGripStyle.Hide;
		}
