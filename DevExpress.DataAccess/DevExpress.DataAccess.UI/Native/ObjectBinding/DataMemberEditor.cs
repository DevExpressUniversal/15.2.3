...
namespace DevExpress.DataAccess.UI.Native.ObjectBinding {
	public class DataMemberEditor : UITypeEditor {
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
			...
			DesignerTransaction transaction = designerHost.CreateTransaction("Edit DataMember");
			...
			if(ods.EditDataMember(solutionTypesProvider, wizardRunnerContext, parameterService, repositoryItemsProvider)) {
