...
namespace DevExpress.DataAccess.Native {
	...
	public sealed class LocalizableCategoryAttribute : CategoryAttribute {
		...
		readonly DataAccessStringId id;
		public LocalizableCategoryAttribute(string value)
			: base(value) {
				this.value = value;
		}
		public LocalizableCategoryAttribute(DataAccessStringId id)
			: base(id.ToString()) {
				this.id = id;
		}
		public string Value { get { return value; } }
		public DataAccessStringId Id { get { return id; } }
		protected override string GetLocalizedString(string val) {
			return DataAccessLocalizer.GetString((DataAccessStringId)Enum.Parse(typeof(DataAccessStringId), val, true));
		}
	}
}
