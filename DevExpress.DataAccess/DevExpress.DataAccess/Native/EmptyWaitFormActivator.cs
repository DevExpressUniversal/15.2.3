...
namespace DevExpress.DataAccess.Native {
	public class EmptyWaitFormActivator : IWaitFormActivator {
		static EmptyWaitFormActivator instance;
		public static EmptyWaitFormActivator Instance { get { return instance ?? (instance = new EmptyWaitFormActivator()); } }
