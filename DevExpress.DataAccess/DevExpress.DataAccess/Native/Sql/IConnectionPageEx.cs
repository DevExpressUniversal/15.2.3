...
namespace DevExpress.DataAccess.Native.Sql {
...
#if !DXPORTABLE
	public interface IConnectionPageBigQuery {
		BigQueryAuthorizationType AuthorizationType { get; set; }
	...
	public interface IConnectionPageHostname {
		string Hostname { get; set; }
	}
	public interface IConnectionPageAdvantage {
		AdvantageServerType ServerType { get; set; }
	}
#endif
}
