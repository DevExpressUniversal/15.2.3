...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public class VistaDbStrategy : FileDbStrategyBase {
		VistaDBProviderFactory factory;
		#region Overrides of FileDbStrategyBase
		protected override ProviderFactory Factory { get { return this.factory ?? (this.factory = new VistaDBProviderFactory()); } }
		public override DataConnectionParametersBase GetConnectionParameters(IConnectionParametersControl control) {
			return new VistaDBConnectionParameters(control.FileName, control.Password);
		}
		public override void InitializeControl(IConnectionParametersControl control, DataConnectionParametersBase value) {
			VistaDBConnectionParameters p = (VistaDBConnectionParameters)value;
