...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public class PervasiveStrategy : ServerDbStrategyBase {
		PervasiveProviderFactory factory;
		#region Overrides of ServerDbStrategyBase
		protected override ProviderFactory Factory { get { return this.factory ?? (this.factory = new PervasiveProviderFactory()); } }
		public override DataConnectionParametersBase GetConnectionParameters(IConnectionParametersControl control) {
			return new PervasiveSqlConnectionParameters(control.ServerName, control.Database, control.UserName,
				control.Password);
		}
		public override void InitializeControl(IConnectionParametersControl control, DataConnectionParametersBase value) {
			PervasiveSqlConnectionParameters p = (PervasiveSqlConnectionParameters)value;
