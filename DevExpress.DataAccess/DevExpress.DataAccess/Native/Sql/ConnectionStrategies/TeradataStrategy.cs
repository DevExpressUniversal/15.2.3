...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public class TeradataStrategy : ServerDbStrategyBase {
		DataAccessTeradataProviderFactory factory;
		...
		DataAccessTeradataProviderFactory ProviderFactory { get { return this.factory ?? (this.factory = new DataAccessTeradataProviderFactory()); } }
		public override string GetDefaultText(ConnectionParameterEdits edit) {
			return edit == ConnectionParameterEdits.Port ? TeradataConnectionParameters.DefaultPort : base.GetDefaultText(edit);
		}
		public override DataConnectionParametersBase GetConnectionParameters(IConnectionParametersControl control) {
			return new TeradataConnectionParameters(control.ServerName, control.Port, control.Database, control.UserName, control.Password);
		}
		public override void InitializeControl(IConnectionParametersControl control, DataConnectionParametersBase value) {
			TeradataConnectionParameters p = (TeradataConnectionParameters)value;
