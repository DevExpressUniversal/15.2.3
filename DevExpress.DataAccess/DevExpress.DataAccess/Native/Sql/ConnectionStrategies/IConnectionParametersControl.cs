...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public interface IConnectionParametersControl {
		bool ServerBased { get; set; }
		string FileName { get; set; }
		string ServerName { get; set; }
		string Port { get; set; }
		MsSqlAuthorizationType AuthTypeMsSql { get; set; }
		...
		BigQueryAuthorizationType AuthTypeBigQuery { get; set; }
		...
		AdvantageServerType ServerTypeAdvantage { get; set; }
	}
}
