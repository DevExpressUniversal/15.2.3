...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public class MsSqlServerCeStrategy : FileDbStrategyBase {
		MSSqlCEProviderFactory factory;
		...
		public override DataConnectionParametersBase GetConnectionParameters(IConnectionParametersControl control) {
			return new MsSqlCEConnectionParameters(control.FileName, control.Password);
		}
		public override void InitializeControl(IConnectionParametersControl control, DataConnectionParametersBase value) {
			MsSqlCEConnectionParameters p = (MsSqlCEConnectionParameters)value;
			control.FileName = p.FileName;
			control.Password = p.Password;
		}
		protected override ProviderFactory Factory { get { return this.factory ?? (this.factory = new MSSqlCEProviderFactory()); } }
		#endregion
	}
}
