...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public class AseStrategy : ServerDbStrategyBase {
		AseProviderFactory factory;
		#region Overrides of ServerDbStrategyBase
		protected override ProviderFactory Factory { get { return this.factory ?? (this.factory = new AseProviderFactory()); } }
		public override DataConnectionParametersBase GetConnectionParameters(IConnectionParametersControl control) {
			return new AseConnectionParameters(control.ServerName, control.Database, control.UserName, control.Password);
		}
		public override void InitializeControl(IConnectionParametersControl control, DataConnectionParametersBase value) {
			AseConnectionParameters p = (AseConnectionParameters)value;
