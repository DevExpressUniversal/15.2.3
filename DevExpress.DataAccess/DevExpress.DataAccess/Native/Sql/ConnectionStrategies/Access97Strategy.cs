...
namespace DevExpress.DataAccess.Native.Sql.ConnectionStrategies {
	public class Access97Strategy : FileDbStrategyBase {
		Access97ProviderFactory factory;
		...
		public override ConnectionParameterEdits GetEditsSet(IConnectionParametersControl control) {
			return base.GetEditsSet(control) | ConnectionParameterEdits.UserName;
		}
		#endregion
		#region Overrides of FileDbStrategyBase
		public override DataConnectionParametersBase GetConnectionParameters(IConnectionParametersControl control) {
			return new Access97ConnectionParameters(control.FileName, control.UserName, control.Password);
		}
		public override void InitializeControl(IConnectionParametersControl control, DataConnectionParametersBase value) {
			Access97ConnectionParameters p = (Access97ConnectionParameters)value;
			control.FileName = p.FileName;
			control.UserName = p.UserName;
			control.Password = p.Password;
		}
		protected override ProviderFactory Factory { get { return this.factory ?? (this.factory = new Access97ProviderFactory()); } }
		#endregion
	}
}
