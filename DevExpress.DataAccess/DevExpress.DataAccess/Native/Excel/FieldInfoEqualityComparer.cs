...
namespace DevExpress.DataAccess.Native.Excel {
	public class FieldInfoEqualityComparer : IEqualityComparer<FieldInfo> {
		public static bool Equals(FieldInfo x, FieldInfo y) {
			if (x.GetType() != y.GetType())
				return false;
			return string.Equals(x.Name, y.Name)
				   && x.Type == y.Type;
		}
		#region Implementation of IEqualityComparer<in FieldInfo>
		bool IEqualityComparer<FieldInfo>.Equals(FieldInfo x, FieldInfo y) {
			return Equals(x, y);
		}
		int IEqualityComparer<FieldInfo>.GetHashCode(FieldInfo obj) {
			return 0;
		}
		#endregion
	}
