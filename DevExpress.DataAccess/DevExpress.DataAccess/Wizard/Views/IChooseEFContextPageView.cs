...
namespace DevExpress.DataAccess.Wizard.Views {
	public interface IChooseEFContextPageView {
		...
		event EventHandler<BrowseForAssemblyEventArgs> BrowseForAssembly;
		event EventHandler<ContextNameChangedEventArgs> ContextNameChanged;
		void RefreshContextList(IEnumerable<IContainerInfo> enumerable);
		void Initialize();
	}
	public class BrowseForAssemblyEventArgs: EventArgs {
		readonly string assemblyPath;
		public string AssemblyPath {get {return assemblyPath;} }
		public BrowseForAssemblyEventArgs (string assemblyPath ){
	...
	public class ContextNameChangedEventArgs : EventArgs {
		...
		public ContextNameChangedEventArgs(string contextName) {
