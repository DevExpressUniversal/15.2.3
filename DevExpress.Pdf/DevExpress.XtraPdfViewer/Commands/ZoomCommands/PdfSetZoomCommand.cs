...
namespace DevExpress.XtraPdfViewer.Commands {
	public class PdfSetZoomCommand : PdfViewerCommand {
		public override PdfViewerCommandId Id { get { return PdfViewerCommandId.SetZoom; } }
		...
		public PdfSetZoomCommand(PdfViewer control) : base(control) {
		}
		public override void ForceExecute(ICommandUIState state) {
			PdfDocumentViewer viewer = Viewer;
			if (viewer != null)
				viewer.Zoom = (float)state.EditValue / 100;
		}
		protected override void UpdateUIStateCore(ICommandUIState state) {
			...
			if (viewer == null) {
				...
				state.EditValue = viewer.Zoom;
				state.Enabled = viewer.Document != null;
			}
		}
