...
namespace DevExpress.Pdf.Native {
	public class PdfPostScriptIfElseOperator : PdfPostScriptOperator {
		...
		public override void Execute(PdfPostScriptInterpreter interpreter) {
			...
			IList<object> proc2 = stack.Pop() as IList<object>;
			IList<object> proc1 = stack.Pop() as IList<object>;
			object condition = stack.Pop();
			if (!(condition is bool) || proc1 == null || proc2 == null)
				PdfDocumentReader.ThrowIncorrectDataException();
			interpreter.Execute((bool)condition ? proc1 : proc2);
		}
	}
}
