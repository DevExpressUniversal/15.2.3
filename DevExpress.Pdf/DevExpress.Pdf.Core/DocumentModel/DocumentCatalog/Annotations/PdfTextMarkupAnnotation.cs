...
namespace DevExpress.Pdf {
	public enum PdfTextMarkupAnnotationType { Highlight, Underline, Squiggly, StrikeOut }
	public class PdfTextMarkupAnnotation : PdfMarkupAnnotation {
		...
		readonly PdfTextMarkupAnnotationType type;
		readonly IList<PdfQuadrilateral> quads;
		public PdfTextMarkupAnnotationType Type { get { return type; } }
		public IList<PdfQuadrilateral> Quads { get { return quads; } }
		protected override string AnnotationType { get { return PdfEnumToStringConverter.Convert(type); } }
		internal PdfTextMarkupAnnotation(PdfPage page, PdfTextMarkupAnnotationType type, PdfReaderDictionary dictionary) : base(page, dictionary) {
			this.type = type;
			quads = PdfQuadrilateral.ParseArray(dictionary);
		}
		protected override PdfWriterDictionary CreateDictionary(PdfObjectCollection collection) {
			...
			PdfQuadrilateral.Write(dictionary, quads);
			return dictionary;
		}
	}
}
