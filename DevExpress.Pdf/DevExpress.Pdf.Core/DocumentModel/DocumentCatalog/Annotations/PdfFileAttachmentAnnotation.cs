...
namespace DevExpress.Pdf {
	public class PdfFileAttachmentAnnotation : PdfMarkupAnnotation {
		...
		const string fileSpecificationDictionaryKey = "FS";
		const string iconNameDictionaryKey = "Name";
		const string defaultIconName = "PushPin";
		...
		internal PdfFileAttachmentAnnotation(PdfPage page, PdfReaderDictionary dictionary) : base(page, dictionary) {
			fileSpecification = PdfFileSpecification.Parse(dictionary, fileSpecificationDictionaryKey, false);
