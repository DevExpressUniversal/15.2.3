...
namespace DevExpress.Pdf {
	public class PdfFitBBoxDestination : PdfDestination {
		...
		PdfFitBBoxDestination(PdfFitBBoxDestination destination) : base(destination) { }
		protected internal override PdfDestination CreateDuplicate() {
			return new PdfFitBBoxDestination(this);
		}
		protected internal override PdfTarget CreateTarget(IList<PdfPage> pages) {
			return new PdfTarget(PdfTargetMode.FitBBox, CalculatePageIndex(pages));
		}
