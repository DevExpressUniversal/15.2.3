...
namespace DevExpress.Pdf {
	[PdfDefaultField(PdfListLogicalStructureElementAttributeNumbering.None)]
	...
	public class PdfListLogicalStructureElementAttribute : PdfLogicalStructureElementAttribute {
		...
		const string listNumberingKey = "ListNumbering";
		readonly PdfListLogicalStructureElementAttributeNumbering listNumbering;
		public PdfListLogicalStructureElementAttributeNumbering ListNumbering { get { return listNumbering; } }
		internal PdfListLogicalStructureElementAttribute(PdfReaderDictionary dictionary) : base(dictionary.Number) {
			listNumbering = PdfEnumToStringConverter.Parse<PdfListLogicalStructureElementAttributeNumbering>(dictionary.GetName(listNumberingKey));
		}
		protected override PdfWriterDictionary CreateDictionary(PdfObjectCollection collection) {
			...
			dictionary.AddName(listNumberingKey, PdfEnumToStringConverter.Convert(listNumbering));
			return dictionary;
		}
	}
}
