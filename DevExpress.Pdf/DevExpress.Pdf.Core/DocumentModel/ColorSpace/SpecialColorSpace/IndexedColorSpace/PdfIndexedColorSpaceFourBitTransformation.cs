...
namespace DevExpress.Pdf.Native {
	public class PdfIndexedColorSpaceFourBitTransformation : PdfIndexedColorSpaceTransformation {
		public PdfIndexedColorSpaceFourBitTransformation(PdfIndexedColorSpace colorSpace, int width, int height, IList<PdfRange> colorKeyMask) : base(colorSpace, width, height, colorKeyMask) {
		}
