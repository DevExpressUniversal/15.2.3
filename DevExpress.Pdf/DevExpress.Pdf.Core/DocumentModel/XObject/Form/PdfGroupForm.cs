...
namespace DevExpress.Pdf {
	public class PdfGroupForm : PdfForm {
		...
		readonly PdfTransparencyGroup group;
		public PdfTransparencyGroup Group { get { return group; } }
		internal PdfGroupForm(PdfReaderStream stream, PdfReaderDictionary groupDictionary, PdfResources parentResources)
			: base(stream, parentResources) {
			group = new PdfTransparencyGroup(groupDictionary);
		}
		protected override PdfWriterDictionary CreateDictionary(PdfObjectCollection objects) {
			...
			dictionary.Add(DictionaryKey, group);
			return dictionary;
		}
	}
}
