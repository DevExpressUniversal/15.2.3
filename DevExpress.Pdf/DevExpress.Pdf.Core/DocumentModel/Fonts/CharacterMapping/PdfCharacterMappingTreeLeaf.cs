...
namespace DevExpress.Pdf.Native {
	class PdfCharacterMappingTreeLeaf : PdfCharacterMappingTreeNode {
		readonly string value;
		public override bool IsFinal { get { return true; } }
		public PdfCharacterMappingTreeLeaf(string value) {
			this.value = value;
		}
		...
		public override PdfCharacterMappingFindResult Find(byte[] code, int position) {
			return new PdfCharacterMappingFindResult(value, 0);
		}
	}
}
