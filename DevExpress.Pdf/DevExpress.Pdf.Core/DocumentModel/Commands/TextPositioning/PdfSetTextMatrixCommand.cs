...
namespace DevExpress.Pdf {
	public class PdfSetTextMatrixCommand : PdfCommand {
		...
		readonly PdfTransformationMatrix textMatrix;
		public PdfTransformationMatrix TextMatrix { get { return textMatrix; } }
		...
		protected internal override void Write(PdfResources resources, PdfDocumentWritableStream writer) {
			textMatrix.Write(writer);
			writer.WriteSpace();
			writer.WriteString(Name);
		}
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			interpreter.SetTextMatrix(textMatrix);
		}
	}
}
