...
namespace DevExpress.Pdf {
	public class PdfStartTextLineWithOffsetsCommand : PdfCommand {
		...
		public double XOffset { get { return xOffset; } }
		public double YOffset { get { return yOffset; } }
		public PdfStartTextLineWithOffsetsCommand(double xOffset, double yOffset) {
			this.xOffset = xOffset;
			this.yOffset = yOffset;
		}
		internal PdfStartTextLineWithOffsetsCommand(PdfOperands operands) {
			xOffset = operands.PopDouble();
			yOffset = operands.PopDouble();
		}
		protected internal override void Write(PdfResources resources, PdfDocumentWritableStream writer) {
			writer.WriteSpace();
			writer.WriteDouble(xOffset);
			writer.WriteSpace();
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			interpreter.SetTextMatrix(xOffset, yOffset);
		}
	}
}
