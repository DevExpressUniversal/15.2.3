...
namespace DevExpress.Pdf {
	public class PdfSetGrayColorSpaceForStrokingOperationsCommand : PdfSetGrayColorSpaceCommand {
		...
		internal PdfSetGrayColorSpaceForStrokingOperationsCommand(PdfOperands operands) : base(operands) {
		}
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			...
			interpreter.SetColorForStrokingOperations(new PdfColor(Gray));
		}
	}
}
