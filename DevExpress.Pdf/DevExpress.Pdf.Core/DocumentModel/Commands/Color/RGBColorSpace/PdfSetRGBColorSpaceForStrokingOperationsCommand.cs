...
namespace DevExpress.Pdf {
	public class PdfSetRGBColorSpaceForStrokingOperationsCommand : PdfSetRGBColorSpaceCommand {
		...
		internal PdfSetRGBColorSpaceForStrokingOperationsCommand(PdfOperands operands) : base(operands) {
		}
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			...
			interpreter.SetColorForStrokingOperations(new PdfColor(R, G, B));
		}
	}
}
