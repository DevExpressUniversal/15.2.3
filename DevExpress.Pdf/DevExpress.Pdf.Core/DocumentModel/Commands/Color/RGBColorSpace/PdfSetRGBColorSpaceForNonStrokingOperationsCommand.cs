...
namespace DevExpress.Pdf {
	public class PdfSetRGBColorSpaceForNonStrokingOperationsCommand : PdfSetRGBColorSpaceCommand {
		...
		internal PdfSetRGBColorSpaceForNonStrokingOperationsCommand(PdfOperands operands) : base(operands) {
		}
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			...
			interpreter.SetColorForNonStrokingOperations(new PdfColor(R, G, B));
		}
	}
}
