...
namespace DevExpress.Pdf {
	public class PdfSetCMYKColorSpaceForNonStrokingOperationsCommand : PdfSetCMYKColorSpaceCommand {
		...
		internal PdfSetCMYKColorSpaceForNonStrokingOperationsCommand(PdfOperands operands) : base(operands) {
		}
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			...
			interpreter.SetColorForNonStrokingOperations(new PdfColor(C, M, Y, K));
		}
	}
}
