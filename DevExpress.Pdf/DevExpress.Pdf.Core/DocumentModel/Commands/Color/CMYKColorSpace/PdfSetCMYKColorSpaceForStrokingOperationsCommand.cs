...
namespace DevExpress.Pdf {
	public class PdfSetCMYKColorSpaceForStrokingOperationsCommand : PdfSetCMYKColorSpaceCommand {
		...
		internal PdfSetCMYKColorSpaceForStrokingOperationsCommand(PdfOperands operands) : base(operands) {
		}
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			...
			interpreter.SetColorForStrokingOperations(new PdfColor(C, M, Y, K));
		}
	}
}
