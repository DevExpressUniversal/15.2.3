...
namespace DevExpress.Pdf {
	public abstract class PdfSetColorCommand : PdfCommand {
		...
		protected virtual PdfColor Color { get { return new PdfColor((double[])components.Clone()); } }
		protected PdfSetColorCommand(PdfOperands operands) {
			Parse(operands);
		}
		protected void Parse(PdfOperands operands) {
			int count = operands.Count;
			components = new double[count];
			for (int i = 0; i < count; i++)
				components[i] = operands.PopDouble();
		}
