...
namespace DevExpress.Pdf {
	public class PdfPaintShadingPatternCommand : PdfCommand {
		...
		internal PdfPaintShadingPatternCommand(PdfResources resources, PdfOperands operands) {
			shading = resources.GetShading(operands.PopName());
		}
		protected internal override void Write(PdfResources resources, PdfDocumentWritableStream writer) {
			writer.WriteSpace();
			writer.WriteName(resources.FindShadingName(shading));
			writer.WriteSpace();
