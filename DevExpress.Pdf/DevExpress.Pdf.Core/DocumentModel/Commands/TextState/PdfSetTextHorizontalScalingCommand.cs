...
namespace DevExpress.Pdf {
	public class PdfSetTextHorizontalScalingCommand : PdfCommand {
		...
		readonly double horizontalScaling;
		...
		internal PdfSetTextHorizontalScalingCommand(PdfOperands operands) {
			horizontalScaling = operands.PopDouble();
		}
		protected internal override void Write(PdfResources resources, PdfDocumentWritableStream writer) {
			writer.WriteSpace();
			writer.WriteDouble(horizontalScaling);
			writer.WriteSpace();
			writer.WriteString(Name);
		}
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			interpreter.SetTextHorizontalScaling(horizontalScaling);
		}
	}
}
