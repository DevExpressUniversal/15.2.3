...
namespace DevExpress.Pdf {
	public class PdfAppendBezierCurveWithPreviousControlPointCommand : PdfCommand {
		...
		internal PdfAppendBezierCurveWithPreviousControlPointCommand(PdfOperands operands) {
		...
		protected internal override void Execute(PdfCommandInterpreter interpreter) {
			interpreter.AppendPathBezierSegment(new PdfPoint(x2, y2), new PdfPoint(x3, y3));
		}
	}
}
