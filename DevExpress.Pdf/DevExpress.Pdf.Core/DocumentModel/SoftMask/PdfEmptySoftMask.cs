...
namespace DevExpress.Pdf {
	public class PdfEmptySoftMask : PdfSoftMask {
		...
		static readonly PdfEmptySoftMask instance = new PdfEmptySoftMask();
		public static PdfEmptySoftMask Instance { get { return instance; } }
		PdfEmptySoftMask(): base (null) {
		}
		protected internal override bool IsSame(PdfSoftMask softMask) {
			return Object.ReferenceEquals(softMask, instance);
		}
