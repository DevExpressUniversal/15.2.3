...
namespace DevExpress.Pdf {
	public class PdfPasswordRequestedEventArgs : EventArgs {
		...
		readonly int passwordRequestsCount;
		SecureString password;
		public string FileName { get { return fileName; } }
		public int PasswordRequestsCount { get { return passwordRequestsCount; } }
		public SecureString Password {
			get { return password; }
			set { password = value; }
		}
		internal PdfPasswordRequestedEventArgs(string fileName, int passwordRequestsCount) {
