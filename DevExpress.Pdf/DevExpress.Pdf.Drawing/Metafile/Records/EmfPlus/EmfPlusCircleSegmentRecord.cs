...
namespace DevExpress.Pdf.Drawing {
	public abstract class EmfPlusCircleSegmentRecord : EmfPlusPenDrawingRecord {
		...
		protected RectangleF Bounds { get { return bounds; } }
		protected EmfPlusCircleSegmentRecord(short flags, byte[] content)
			: base(flags, content) {
			startAngle = ContentStream.ReadSingle();
			sweepAngle = ContentStream.ReadSingle();
			bounds = ContentStream.ReadRectF((flags & compressedFlagMask) != 0);
		}
	}
}
