...
namespace DevExpress.Pdf.Drawing {
	class PdfGraphicsDrawBeziersCommand : PdfGraphicsStrokingCommand {
		readonly PointF[] points;
		public PdfGraphicsDrawBeziersCommand(PdfPen pen, PointF[] points)
			: base(pen) {
		...
		public override void Execute(PdfGraphicsPageContentsCommandConstructor constructor) {
			...
			constructor.DrawBeziers(points);
		}
	}
}
