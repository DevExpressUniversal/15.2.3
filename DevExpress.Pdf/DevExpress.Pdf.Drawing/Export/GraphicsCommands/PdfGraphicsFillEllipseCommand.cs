...
namespace DevExpress.Pdf.Drawing {
	class PdfGraphicsFillEllipseCommand : PdfGraphicsNonStrokingCommand {
		readonly RectangleF rect;
		public PdfGraphicsFillEllipseCommand(PdfBrushContainer brush, RectangleF rect) : base(brush) {
			this.rect = rect;
		}
