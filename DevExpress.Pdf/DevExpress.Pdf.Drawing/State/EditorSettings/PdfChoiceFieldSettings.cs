...
namespace DevExpress.Pdf.Drawing {
	public abstract class PdfChoiceEditorSettings : PdfEditorSettings {
		...
		readonly int topIndex;
		public IList<PdfOptionsFormFieldOption> Values { get { return options; } }
		public override PdfEditorType EditorType { get { return PdfEditorType.ListBox; } }
		public int TopIndex { get { return topIndex; } }
		protected PdfChoiceEditorSettings(PdfAnnotationState state, PdfChoiceFormField field, PdfEditableFontData fontData, double fontSize, bool readOnly)
			: base(state, field, fontData, fontSize, readOnly) {
			options = field.Options;
			topIndex = field.TopIndex;
		}
	}
}
