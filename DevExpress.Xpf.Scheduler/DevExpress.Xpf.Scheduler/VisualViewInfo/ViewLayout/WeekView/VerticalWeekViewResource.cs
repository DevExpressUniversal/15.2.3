...
namespace DevExpress.Xpf.Scheduler.Drawing {
	public class VisualVerticalWeekViewResource : VisualResource {
		protected override VisualSimpleResourceInterval CreateVisualSimpleResourceInterval() {
			return new VisualVerticalWeek();
		}
		...
		protected override CellContainerCollection GetCellContainers(SingleResourceViewInfo source) {
			WeekBasedSingleResourceViewInfo dayBasedSource = (WeekBasedSingleResourceViewInfo)source;
			return dayBasedSource.CellContainers;
		}
