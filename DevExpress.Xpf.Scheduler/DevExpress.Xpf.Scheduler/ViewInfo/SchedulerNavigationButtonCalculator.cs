...
namespace DevExpress.Xpf.Scheduler.Native {
	public class SchedulerNavigationButtonCalculator : NavigationButtonCalculator {
		SchedulerControl control;		
		public SchedulerNavigationButtonCalculator(SchedulerControl control, SchedulerViewBase view)
			: base(control.InnerControl, view.InnerView) {
		...
		protected internal override bool UseGroupByNoneCriteriaCalculator() {
			...
			return view.FactoryHelper.CalcActualGroupType(view.InnerView) == SchedulerGroupType.None;
		}
	}
}
