...
namespace DevExpress.Xpf.Scheduler.Native
{
	...
	public class WeekViewFactoryHelper : ViewFactoryHelper
	{
		...
		{
			return new WeekViewAppointmentLayoutCalculator(viewInfo);
		}
	}
	#endregion
	...
	public class WeekViewGroupByNoneStrategy : ViewGroupTypeStrategy {
		...
		public override ISchedulerViewInfoBase CreateViewInfo(SchedulerViewBase view) {
			return new WeekViewGroupByNone((WeekView)view);
		}
	}
	#endregion
	...
	public class WeekViewGroupByDateStrategy : ViewGroupTypeStrategy {
		...
		public override ISchedulerViewInfoBase CreateViewInfo(SchedulerViewBase view) {
			return new WeekViewGroupByDate((WeekView)view);
		}
	}
	#endregion
	...
	public class WeekViewGroupByResourceStrategy : ViewGroupTypeStrategy {
		...
		public override ISchedulerViewInfoBase CreateViewInfo(SchedulerViewBase view) {
			return new WeekViewGroupByResource((WeekView)view);
		}
	}
	#endregion
}
