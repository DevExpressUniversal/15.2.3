...
namespace DevExpress.Xpf.Scheduler.UI {
	public partial class EditTimeRulerControl : UserControl {
		public EditTimeRulerControl() {
			InitializeComponent();
#if DEBUGTEST
			Loaded += new RoutedEventHandler(EditTimeRulerControl_Loaded);
#endif
		}
#if DEBUGTEST
		void EditTimeRulerControl_Loaded(object sender, RoutedEventArgs e) {
