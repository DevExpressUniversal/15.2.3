...
namespace DevExpress.Xpf.Scheduler.Commands {
	public class SetTimeScaleVisibleUICommand : SchedulerUICommand {
		public SetTimeScaleVisibleUICommand(TimeScale scale) {
			Guard.ArgumentNotNull(scale, "scale");
			Scale = scale;
		}
		TimeScale Scale { get; set; }
		public override SchedulerCommand CreateCommand(SchedulerControl control) {
			...
			if (timelineView == null)
				return null;
			return new TimeScaleVisibleCommand(control.InnerControl, Scale);
		}
	}
}
