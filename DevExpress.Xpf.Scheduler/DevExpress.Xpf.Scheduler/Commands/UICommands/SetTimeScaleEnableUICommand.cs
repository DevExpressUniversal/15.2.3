...
namespace DevExpress.Xpf.Scheduler.Commands {
	#region SetTimeScaleEnableUICommand
	public class SetTimeScaleEnableUICommand : SchedulerUICommand {
		TimeScale scale;
		public SetTimeScaleEnableUICommand(TimeScale scale) {
		...
		public override SchedulerCommand CreateCommand(SchedulerControl control) {
			...
			if (timelineView == null)
				return null;
			return new TimeScaleEnableCommand(control.InnerControl, Scale);
		}
	}
	#endregion
}
