...
namespace DevExpress.Xpf.Scheduler {
	public class BrushBrickXamlExporter : VisualBrickXamlExporter {
		public override void WriteBrickToXaml(XamlWriter writer, BrickBase brick, XamlExportContext exportContext, System.Drawing.RectangleF clipRect, Action<XamlWriter> declareNamespaces, Action<XamlWriter, object> writeCustomProperties) {
			base.WriteBrickToXaml(writer, brick, exportContext, clipRect, declareNamespaces, writeCustomProperties);
		}
		protected override void WriteBrickToXamlCore(XamlWriter writer, VisualBrick brick, XamlExportContext exportContext) {
			...
			writer.WriteAttribute(XamlAttribute.Source, exportContext.ResourceMap.ImageResourcesDictionary[visualBrick]);
		...
		public override float GetGraphicsDpi() {
