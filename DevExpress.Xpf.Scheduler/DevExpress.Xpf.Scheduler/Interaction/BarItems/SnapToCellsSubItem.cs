...
namespace DevExpress.Xpf.Scheduler.UI {
	public class SnapToCellsSubItem : SubMenuBarSubItem {
		protected override void UpdateItemsCore() {
			Array modes = Enum.GetValues(typeof(AppointmentSnapToCellsMode));
			foreach (AppointmentSnapToCellsMode mode in modes) {
				AddSnapToCellIte(mode);	
			}
		}
		void AddSnapToCellIte(AppointmentSnapToCellsMode value) {
			BarCheckItem item = new BarCheckItem();
			SetSnapToCellsUICommand command = new SetSnapToCellsUICommand(value);
