...
namespace DevExpress.Xpf.Scheduler.UI {
	public class ChangeStatusBarItem : ColorablePopupMenuBasedBarItem {
		...
		protected override int GetItemCount() {
			return SchedulerControl.Storage.AppointmentStorage.Statuses.Count;
		}
		protected override SchedulerUICommand CreateItemCommand(int i) {
			return new ChangeAppointmentStatusUICommand(SchedulerControl.Storage.AppointmentStorage.Statuses.GetByIndex(i), i);
		}
	}
}
