...
namespace DevExpress.Xpf.Scheduler.Drawing {
	public class VisualWeekViewGroupByDate : VisualResourcesBasedViewInfo {
		#region DayOfWeekHeaders
		static readonly DependencyPropertyKey DayOfWeekHeadersPropertyKey = DevExpress.Xpf.Core.Native.DependencyPropertyHelper.RegisterReadOnlyProperty<VisualWeekViewGroupByDate, VisualDayOfWeekHeaderContentCollection>("DayOfWeekHeaders", null);
		public static readonly DependencyProperty DayOfWeekHeadersProperty = DayOfWeekHeadersPropertyKey.DependencyProperty;
#if !SL
	[DevExpressXpfSchedulerLocalizedDescription("VisualWeekViewGroupByDateDayOfWeekHeaders")]
#endif
		...
		protected override VisualResource CreateVisualResource() {
			return new VisualVerticalWeekViewResource();
		}
		protected override void CopyFromCore(ISchedulerViewInfoBase source) {
			base.CopyFromCore(source);
			WeekViewGroupByDate groupByResource = source as WeekViewGroupByDate;
			if(ResourceContainers == null)
				ResourceContainers = new VisualResourcesCollection();
			CollectionCopyHelper.Copy(ResourceContainers, groupByResource.ResourcesContainers, CreateVisualResource);
			if(DayOfWeekHeaders == null)
				DayOfWeekHeaders = new VisualDayOfWeekHeaderContentCollection();
			CollectionCopyHelper.Copy(DayOfWeekHeaders, groupByResource.DayOfWeekHeaders, CreateVisualDayOfWeekHeader);
		}
		protected virtual VisualDayOfWeekHeaderContent CreateVisualDayOfWeekHeader() {
			return new VisualDayOfWeekHeaderContent();
		}
		protected override void CopyAppointmentsViewInfoCore(ISchedulerViewInfoBase source) {
			...
			if(ResourceContainers == null)
				return;
			WeekViewGroupByDate groupByNone = source as WeekViewGroupByDate;
