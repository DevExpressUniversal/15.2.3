...
namespace DevExpress.Xpf.Scheduler.Drawing {
	public class VisualWeekViewGroupByResource : VisualResourcesBasedViewInfo {
		...
		protected override void CopyFromCore(ISchedulerViewInfoBase source) {
			...
			WeekViewGroupByResource groupByResource = source as WeekViewGroupByResource;
		...
		protected override void CopyAppointmentsViewInfoCore(ISchedulerViewInfoBase source) {
			...
			if (ResourceContainers == null)
				return;
			WeekViewGroupByResource groupByNone = source as WeekViewGroupByResource;
