...
namespace DevExpress.Xpf.Scheduler {
	#region SchedulerControlProvider
	public class SchedulerControlProvider : FrameworkElement {
		public static readonly DependencyProperty SchedulerControlProperty = DependencyPropertyManager.Register("SchedulerControl", typeof(SchedulerControl), typeof(SchedulerControlProvider), new FrameworkPropertyMetadata(new PropertyChangedCallback(OnSchedulerControlChanged)));
		protected static void OnSchedulerControlChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
			SchedulerControlProvider instance = d as SchedulerControlProvider;
			if (instance != null)
		...
		public SchedulerControlProvider() {
