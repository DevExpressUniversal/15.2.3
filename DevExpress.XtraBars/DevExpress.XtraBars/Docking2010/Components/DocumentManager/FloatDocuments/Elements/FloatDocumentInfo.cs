...
namespace DevExpress.XtraBars.Docking2010.Views {
	public interface IFloatDocumentInfo : IBaseDocumentInfo, IUIElement {
	}
	class FloatDocumentInfo : BaseElementInfo, IFloatDocumentInfo {
		BaseDocument documentCore;
		public FloatDocumentInfo(BaseView owner, BaseDocument document)
			: base(owner) {
			documentCore = document;
		}
		public override System.Type GetUIElementKey() {
			return typeof(IFloatDocumentInfo);
		}
		public BaseDocument BaseDocument {
			get { return documentCore; }
		}
		protected override void UpdateStyleCore() {
			BaseDocument.UpdateStyle();
		}
