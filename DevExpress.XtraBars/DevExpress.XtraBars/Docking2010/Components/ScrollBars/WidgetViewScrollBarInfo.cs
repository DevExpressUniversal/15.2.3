...
namespace DevExpress.XtraBars.Docking2010.Views.Widget {
	public interface IWidgetViewScrollBarInfo : 
		IScrollBarInfo {
	}
	class WidgetViewScrollBarInfo : ScrollBarInfo, IUIElement, IWidgetViewScrollBarInfo {
		public WidgetViewScrollBarInfo(IScrollBarInfoOwner owner)
			: base(owner) {
		}
		public Type GetUIElementKey() {
			return typeof(IWidgetViewScrollBarInfo);
		}
		...
		IUIElement IUIElement.Scope { get { return (BaseView)Owner; } }
