...
namespace DevExpress.Xpf.Docking {
	public class LayoutItemData : INotifyPropertyChanged {
		public static BaseLayoutItem ConvertToBaseLayoutItem(object content) {
			return content is LayoutItemData ? ((LayoutItemData)content).LayoutItem : content as BaseLayoutItem;
		}
		...
		public BaseLayoutItem LayoutItem {
			...
			set {
				...
				_item = value;
				NotifyPropertyChanged("LayoutItem");
			}
		}
