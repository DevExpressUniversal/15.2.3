...
namespace DevExpress.Xpf.Docking {
	static class InvokeHelper {
		public static void BeginInvoke(DependencyObject dObj, Delegate method, Priority priority, params object[] args) {
			if(dObj == null) return;
			dObj.Dispatcher.BeginInvoke(method, 
				(System.Windows.Threading.DispatcherPriority)((int)priority),
				args);
		}
