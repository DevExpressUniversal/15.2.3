...
namespace DevExpress.Xpf.Layout.Core {
	public class LayoutElementEnumerator : IEnumerator<ILayoutElement> {
		...
		public LayoutElementEnumerator(ILayoutElement root) {
			Stack = new Stack<ILayoutElement>(32);
			Root = root;
		}
	...
	public static class ElementHelper {
		...
		public static Rect GetScreenRect(ILayoutElementHost host) {
			...
			return new Rect(host.ClientToScreen(rootElement.Location), rootElement.Size);
		}
		public static Rect GetScreenRect(ILayoutElementHost host, ILayoutElement element) {
			return new Rect(host.ClientToScreen(element.Location), element.Size);
		}
		public static Rect GetRect(ILayoutElement element) {
			return new Rect(element.Location, element.Size);
		}
	}
}
