...
namespace DevExpress.XtraSpreadsheet.Design {
	#region XtraSpreadsheetComboBoxEditDesigner
	[CLSCompliant(false)]
	public class XtraSpreadsheetComboBoxEditDesigner : ComboBoxEditDesigner {
		protected override bool AllowHookDebugMode { get { return true; } }
		public XtraSpreadsheetComboBoxEditDesigner() {
