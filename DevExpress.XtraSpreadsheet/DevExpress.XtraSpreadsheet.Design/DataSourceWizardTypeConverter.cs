...
namespace DevExpress.XtraSpreadsheet.Design {
	public class DataSourceWizardTypeConverter : ExpandableObjectConverter {
		...
		public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes) {
			...
			var props = TypeDescriptor.GetProperties(typeof(SpreadsheetDataSourceWizardOptions));
			var enableCustomSqlPropertyDescriptor = new EnableCustomSqlPropertyDescriptor(props["EnableCustomSql"], designerHost);
			var result = new PropertyDescriptorCollection(new[] { props["AlwaysSaveCredentials"], props["DisableNewConnections"], 
					enableCustomSqlPropertyDescriptor, props["QueryBuilderLight"] });
			return result;
		}
		static UserLookAndFeel GetLookAndFeel(IDesignerHost designerHost) {
			var lookAndFeel = new UserLookAndFeel(new object());
			lookAndFeel.UseDefaultLookAndFeel = false;
			lookAndFeel.SkinName = VSThemeHelper.GetAppropriateSkinName(designerHost);
			return lookAndFeel;
		}
	}
}
