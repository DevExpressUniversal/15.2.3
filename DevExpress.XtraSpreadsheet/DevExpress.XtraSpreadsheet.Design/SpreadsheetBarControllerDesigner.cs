...
namespace DevExpress.XtraSpreadsheet.Design {
	#region SpreadsheetBarControllerDesigner
	public class SpreadsheetBarControllerDesigner : ControlCommandBarControllerDesigner<SpreadsheetControl, SpreadsheetCommandId> {
