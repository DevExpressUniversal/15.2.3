...
namespace DevExpress.XtraSpreadsheet.Design {
	#region SpreadsheetNameBoxDesigner
	public class SpreadsheetNameBoxDesigner : BaseControlDesigner, IServiceProvider {
		IDesignerHost host;
		IComponentChangeService changeService;
		public SpreadsheetNameBoxDesigner() {
		}
		public SpreadsheetNameBoxControl NameBoxControl { get { return Control as SpreadsheetNameBoxControl; } }
		...
		public override void InitializeNewComponent(System.Collections.IDictionary defaultValues) {
			...
			if (NameBoxControl != null)
				NameBoxControl.Text = String.Empty;
		}
		...
		protected virtual DesignerActionList CreateSpreadsheetActionList() {
			return new SpreadsheetNameBoxActionList(this);
		}
	...
	#endregion
	#region SpreadsheetNameBoxActionList
	public class SpreadsheetNameBoxActionList : DesignerActionList {
		readonly SpreadsheetNameBoxDesigner designer;
		public SpreadsheetNameBoxActionList(SpreadsheetNameBoxDesigner designer)
			: base(designer.Component) {
			this.designer = designer;
		}
		public SpreadsheetNameBoxDesigner Designer { get { return designer; } }
		...
		protected internal virtual void PopulateCreateBarsItems(DesignerActionItemCollection items) {
			if (Designer.NameBoxControl != null)
		...
		public ISpreadsheetControl SpreadsheetControl {
			get {
				return Designer.NameBoxControl.SpreadsheetControl;
			}
			set {
				Designer.NameBoxControl.SpreadsheetControl = value;
			}
		}
	}
	#endregion
