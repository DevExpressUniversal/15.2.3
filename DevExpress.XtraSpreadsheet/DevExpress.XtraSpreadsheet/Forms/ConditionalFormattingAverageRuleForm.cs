...
namespace DevExpress.XtraSpreadsheet.Forms {
	public partial class ConditionalFormattingAverageRuleForm : XtraForm {
		readonly ConditionalFormattingAverageRuleViewModel viewModel;
		public ConditionalFormattingAverageRuleForm(ConditionalFormattingAverageRuleViewModel viewModel) {
		...
		protected ConditionalFormattingAverageRuleForm() {
			InitializeComponent();
		}
