...
namespace DevExpress.XtraSpreadsheet.Forms {
	public partial class ConditionalFormattingDuplicateValuesRuleForm : XtraForm {
		readonly ConditionalFormattingDuplicateValuesRuleViewModel viewModel;
		public ConditionalFormattingDuplicateValuesRuleForm(ConditionalFormattingDuplicateValuesRuleViewModel viewModel) {
		...
		protected ConditionalFormattingDuplicateValuesRuleForm() {
			InitializeComponent();
		}
		...
		void SetBindingsForm() {
			...
			this.edtComparer.Properties.DataSource = Enum.GetValues(typeof(ConditionalFormattingDuplicateValuesCondition));
			this.edtComparer.DataBindings.Add("EditValue", viewModel, "Condition", true, DataSourceUpdateMode.OnPropertyChanged, String.Empty);
