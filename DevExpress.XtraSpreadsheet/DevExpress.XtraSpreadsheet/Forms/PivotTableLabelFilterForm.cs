...
namespace DevExpress.XtraSpreadsheet.Forms {
	public partial class PivotTableLabelFilterForm : XtraForm {
		readonly PivotTableLabelFiltersViewModel viewModel;
		PivotTableLabelFilterForm() {
			InitializeComponent();
		}
		public PivotTableLabelFilterForm(PivotTableLabelFiltersViewModel viewModel) {
