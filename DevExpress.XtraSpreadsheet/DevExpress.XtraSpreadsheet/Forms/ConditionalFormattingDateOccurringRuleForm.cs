...
namespace DevExpress.XtraSpreadsheet.Forms {
	public partial class ConditionalFormattingDateOccurringRuleForm : XtraForm {
		readonly ConditionalFormattingDateOccurringRuleViewModel viewModel;
		public ConditionalFormattingDateOccurringRuleForm(ConditionalFormattingDateOccurringRuleViewModel viewModel) {
		...
		protected ConditionalFormattingDateOccurringRuleForm() {
			InitializeComponent();
		}
		...
		void SetBindingsForm() {
			...
			this.edtComparer.Properties.DataSource = viewModel.Conditions;
