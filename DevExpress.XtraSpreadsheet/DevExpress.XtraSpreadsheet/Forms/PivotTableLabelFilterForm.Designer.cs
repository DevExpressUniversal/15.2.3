...
namespace DevExpress.XtraSpreadsheet.Forms {
	partial class PivotTableLabelFilterForm {
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PivotTableLabelFilterForm));
			...
			this.lblAsterisk = new DevExpress.XtraEditors.LabelControl();
			...
			resources.ApplyResources(this.lblAsterisk, "lblAsterisk");
			...
			this.Name = "PivotTableLabelFilterForm";
			this.ShowIcon = false;
		...
		private XtraEditors.LabelControl lblQuestion;
		private XtraEditors.LabelControl lblAsterisk;
	}
}
