...
namespace DevExpress.XtraSpreadsheet.Forms.Design {
	[DXToolboxItem(false)]
	public partial class FormatNumberCustomControl : XtraUserControl, INotifyPropertyChanged {
		#region Fields
		string customFormatCode;
		#endregion
		public FormatNumberCustomControl() {
			InitializeComponent();
			SetBindings();
		}
		...
		#endregion
		void SetBindings() {
			this.edtCustom.DataBindings.Add("EditValue", this, "CustomFormatCode", true, DataSourceUpdateMode.OnPropertyChanged);
		}
	}
}
