...
namespace DevExpress.XtraSpreadsheet.Mouse {
	#region SpreadsheetMouseHandlerService
	public class SpreadsheetMouseHandlerService : MouseHandlerService {
		readonly InnerSpreadsheetControl control;
		public SpreadsheetMouseHandlerService(InnerSpreadsheetControl control)
