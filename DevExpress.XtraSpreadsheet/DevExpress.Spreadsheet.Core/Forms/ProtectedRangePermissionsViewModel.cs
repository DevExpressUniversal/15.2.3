...
namespace DevExpress.XtraSpreadsheet.Forms {
	#region ProtectedRangePermissionsViewModel
	public class ProtectedRangePermissionsViewModel : ViewModelBase {
		#region Fields
		readonly ISpreadsheetControl control;
		string name;
		string securityDescriptor;
		#endregion
		public ProtectedRangePermissionsViewModel(ISpreadsheetControl control) {
