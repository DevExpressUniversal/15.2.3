...
namespace DevExpress.XtraSpreadsheet.Layout {
	public class CutCopyRangeDashBorderLayoutItem : RangeSelectionLayoutItemBase {
		int sheetId;
		public CutCopyRangeDashBorderLayoutItem(SelectionLayout layout, CellPosition topLeft, CellPosition bottomRight, int sheetId)
