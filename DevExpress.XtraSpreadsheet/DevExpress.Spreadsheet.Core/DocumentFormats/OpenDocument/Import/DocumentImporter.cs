...
namespace DevExpress.XtraSpreadsheet.Import {
	#region OpenDocumentImporter
	public class OpenDocumentImporter : IImporter<DocumentFormat, bool> {
		...
		public bool LoadDocument(IDocumentModel documentModel, Stream stream, IImporterOptions options) {
			...
			model.InternalAPI.LoadDocumentOpenDocumentContent(stream, (OpenDocumentImporterOptions)options);
			return true;
		}
		#endregion
	}
