...
namespace DevExpress.XtraSpreadsheet.Import.OpenXml {
	public class ScatterChartSeriesDestination : SeriesBaseDestination {
		...
		static ScatterChartSeriesDestination GetThis(SpreadsheetMLBaseImporter importer) {
			return (ScatterChartSeriesDestination)importer.PeekDestination();
		}
		#endregion
		#region Fields
		readonly ScatterSeries series;
		#endregion
		public ScatterChartSeriesDestination(SpreadsheetMLBaseImporter importer, ScatterSeries series, bool isFirstSeries)
		...
		static Destination OnSmooth(SpreadsheetMLBaseImporter importer, XmlReader reader) {
			ScatterSeries series = GetThis(importer).series;
