...
namespace DevExpress.XtraSpreadsheet.Import.OpenXml {
	public class AreaChartSeriesDestination : SeriesBaseDestination {
		...
		#endregion
		public AreaChartSeriesDestination(SpreadsheetMLBaseImporter importer, AreaSeries series, bool isFirstSeries)
