...
namespace DevExpress.XtraSpreadsheet.Import.OpenXml {
	public class ChartShapePropertiesDestination  : ShapePropertiesDestinationBase {
		...
		#endregion
		public ChartShapePropertiesDestination(SpreadsheetMLBaseImporter importer, ShapeProperties shapeProperties)
