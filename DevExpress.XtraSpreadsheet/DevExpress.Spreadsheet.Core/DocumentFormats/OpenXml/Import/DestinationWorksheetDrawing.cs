...
namespace DevExpress.XtraSpreadsheet.Import.OpenXml {
	public class WorksheetDrawingDestination : ElementDestination<SpreadsheetMLBaseImporter> {
		static readonly ElementHandlerTable<SpreadsheetMLBaseImporter> handlerTable = CreateElementHandlerTable();
		static ElementHandlerTable<SpreadsheetMLBaseImporter> CreateElementHandlerTable() {
			ElementHandlerTable<SpreadsheetMLBaseImporter> result = new ElementHandlerTable<SpreadsheetMLBaseImporter>();
			return result;
		}
		public WorksheetDrawingDestination(SpreadsheetMLBaseImporter importer)
			: base(importer) {
		}
		...
		public override void ProcessElementOpen(XmlReader reader) {
			...
			Importer.DrawingsRelations.Add(relationPath, Importer.CurrentWorksheet);
		}
	}
}
