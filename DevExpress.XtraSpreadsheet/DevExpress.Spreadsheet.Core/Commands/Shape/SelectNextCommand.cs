...
namespace DevExpress.XtraSpreadsheet.Commands {
	#region ShapeSelectNextCommand
	public class ShapeSelectNextCommand : SpreadsheetMenuItemSimpleCommand {
		public ShapeSelectNextCommand(ISpreadsheetControl control)
			: base(control) {
		}
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ShapeSelectNext; } }
