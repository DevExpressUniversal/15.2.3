...
namespace DevExpress.XtraSpreadsheet.Commands {
	#region ShapeSelectAllCommand
	public class ShapeSelectAllCommand : SpreadsheetMenuItemSimpleCommand {
		public ShapeSelectAllCommand(ISpreadsheetControl control)
			: base(control) {
		}
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ShapeSelectAll; } }
