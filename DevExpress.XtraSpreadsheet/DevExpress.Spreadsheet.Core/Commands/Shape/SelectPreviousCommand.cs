...
namespace DevExpress.XtraSpreadsheet.Commands {
	#region ShapeSelectPreviousCommand
	public class ShapeSelectPreviousCommand : SpreadsheetMenuItemSimpleCommand {
		public ShapeSelectPreviousCommand(ISpreadsheetControl control)
			: base(control) {
		}
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ShapeSelectPrevious; } }
		...
		protected internal override void ExecuteCore() {
			ActiveSheet.SelectPreviousShape();
		}
