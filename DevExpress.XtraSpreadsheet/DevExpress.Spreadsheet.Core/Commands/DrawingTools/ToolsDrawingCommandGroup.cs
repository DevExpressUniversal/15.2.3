...
namespace DevExpress.XtraSpreadsheet.Commands.Internal {
	#region ToolsDrawingCommandGroup
	public class ToolsDrawingCommandGroup : SpreadsheetToolsCommandGroup {
		public ToolsDrawingCommandGroup(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ToolsDrawingCommandGroup; } }
