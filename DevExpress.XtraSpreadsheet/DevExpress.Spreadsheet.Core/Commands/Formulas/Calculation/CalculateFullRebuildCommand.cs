...
namespace DevExpress.XtraSpreadsheet.Commands {
	public class CalculateFullRebuildCommand : SpreadsheetMenuItemSimpleCommand {
		public CalculateFullRebuildCommand(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.FormulasCalculateFullRebuild; } }
		...
		protected internal override void ExecuteCore() {
			DocumentModel.CalculationChain.ForceFullCalculationRebuild();
		}
