...
namespace DevExpress.XtraSpreadsheet.Commands {
	public class CalculateFullCommand : SpreadsheetMenuItemSimpleCommand {
		public CalculateFullCommand(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.FormulasCalculateFull; } }
		...
		protected internal override void ExecuteCore() {
			DocumentModel.CalculationChain.ForceFullCalculation();
		}
