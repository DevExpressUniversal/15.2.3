...
namespace DevExpress.XtraSpreadsheet.Commands.Internal {
	#region DataValidationCommandGroup
	public class DataValidationCommandGroup : SpreadsheetCommandGroup {
		public DataValidationCommandGroup(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.DataToolsDataValidationCommandGroup; } }
		...
		bool IsEnabled() {
			return !InnerControl.IsAnyInplaceEditorActive && !ActiveSheet.ReadOnly && !ActiveSheet.Selection.IsChartSelected;
		}
	}
	#endregion
}
