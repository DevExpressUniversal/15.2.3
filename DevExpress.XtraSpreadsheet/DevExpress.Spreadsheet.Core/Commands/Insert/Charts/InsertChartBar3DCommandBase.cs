...
namespace DevExpress.XtraSpreadsheet.Commands {
	#region InsertChartBar3DCommandBase (abstract class)
	public abstract class InsertChartBar3DCommandBase : InsertChartColumn3DCommandBase {
		protected InsertChartBar3DCommandBase(ISpreadsheetControl control)
			: base(control) {
		}
