...
namespace DevExpress.XtraSpreadsheet.Commands {
	#region CloseCommentEditorCommand
	public class CommentCloseEditorCommand : SpreadsheetMenuItemSimpleCommand {
		public CommentCloseEditorCommand(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.CommentCloseEditor; } }
		...
		protected internal override void ExecuteCore() {
			...
			try {
				InnerCommentInplaceEditor editor = InnerControl.InnerCommentInplaceEditor;
				editor.Commit();
				editor.Deactivate();
			}
			finally {
