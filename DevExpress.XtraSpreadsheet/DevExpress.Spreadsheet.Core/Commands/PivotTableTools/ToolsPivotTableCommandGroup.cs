...
namespace DevExpress.XtraSpreadsheet.Commands.Internal {
	#region ToolsPivotTableCommandGroup
	public class ToolsPivotTableCommandGroup : SpreadsheetToolsCommandGroup {
		public ToolsPivotTableCommandGroup(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ToolsPivotTableCommandGroup; } }
		...
		public override void UpdateUIState(DevExpress.Utils.Commands.ICommandUIState state) {
			...
			if (!options.SheetLocked)
				return;
			state.Visible = state.Visible && !Protection.PivotTablesLocked;
		}
