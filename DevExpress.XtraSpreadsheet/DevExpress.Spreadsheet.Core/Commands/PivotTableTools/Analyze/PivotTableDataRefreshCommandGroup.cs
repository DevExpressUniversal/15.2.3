...
namespace DevExpress.XtraSpreadsheet.Commands.Internal {
	#region PivotTableDataRefreshCommandGroup
	public class PivotTableDataRefreshCommandGroup : SpreadsheetPivotTableCommandRefreshGroupBase {
		public PivotTableDataRefreshCommandGroup(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.PivotTableDataRefreshGroup; } }
