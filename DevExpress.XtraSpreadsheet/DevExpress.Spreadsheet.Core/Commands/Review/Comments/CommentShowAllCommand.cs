...
namespace DevExpress.XtraSpreadsheet.Commands {
	public class CommentShowAllCommand : SpreadsheetMenuItemSimpleCommand {
		public CommentShowAllCommand(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ReviewShowAllComment; } }
