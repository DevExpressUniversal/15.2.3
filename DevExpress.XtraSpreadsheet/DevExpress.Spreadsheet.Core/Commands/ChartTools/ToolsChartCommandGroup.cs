...
namespace DevExpress.XtraSpreadsheet.Commands.Internal {
	#region ToolsChartCommandGroup
	public class ToolsChartCommandGroup : SpreadsheetToolsCommandGroup {
		public ToolsChartCommandGroup(ISpreadsheetControl control)
			: base(control) {
		}
		#region Properties
		public override SpreadsheetCommandId Id { get { return SpreadsheetCommandId.ToolsChartCommandGroup; } }
		...
		protected override bool IsToolsActive() {
			...
			return ActiveSheet.DrawingObjects[index].DrawingType == DrawingObjectType.Chart;
		}
	}
	#endregion
}
