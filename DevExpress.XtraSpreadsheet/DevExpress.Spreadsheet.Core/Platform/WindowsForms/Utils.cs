...
namespace DevExpress.XtraSpreadsheet.Utils {
	public static class SpreadsheetDataFormats {
		...
		public static readonly string CommaSeparatedValue = DataFormats.CommaSeparatedValue;
		public static readonly string Biff8 = "Biff8";
