...
namespace DevExpress.XtraSpreadsheet.API.Native.Implementation {
	...
	#endregion
	public enum TableSortOrientation {
		SortColumns,
		SortRows
	}
	public interface TableSort {
		...
		TableSortOrientation Orientation { get; set; }
		Range Range { get; }
		void SetRange(Range range);
		TableSortFieldCollection SortFields { get; }
		TableSortMethod SortMethod { get; set; }
	}
	public enum TableSortMethod {
		PinYin,
		Stroke
	}
	public interface TableSortField {
		bool CustomOrder { get; } 
		TableSortDataOption DataOption { get; set; }
		Range Key { get; }
		void ModifyKey(Range newRange);
		TableSortOrder SortOrder { get; set; }
		Int64 Priority { get; set; }
		TableSortOn SortOn { get; set; }
		object SortOnValue { get; }
		void Delete();
	}
	public enum TableSortOn {
		SortOnCellColor,
		SortOnFontColor,
		SortOnIcon,
		SortOnValues,
	...
	public enum TableSortDataOption {
		SortNormal,
		SortTextAsNumbers
	}
	public interface TableSortFieldCollection : ISimpleCollection<TableSortField> {
		void Add();
		void Clear();
	}
}
