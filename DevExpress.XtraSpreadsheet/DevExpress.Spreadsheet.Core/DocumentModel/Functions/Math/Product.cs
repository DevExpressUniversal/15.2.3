...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionProductResult
	public class FunctionProductResult : FunctionSumResultBase {
		double result;
		bool isFirstNumber = true;
		public FunctionProductResult(WorkbookDataContext context)
			: base(context) {
		}
