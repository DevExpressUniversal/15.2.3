...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionMod
	public class FunctionMod : WorksheetFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "MOD"; } }
		public override int Code { get { return 0x0027; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (numberValue.IsError)
				return numberValue;
			VariantValue divisorValue = arguments[1].ToNumeric(context);
			if (divisorValue.IsError)
				return divisorValue;
			double number = numberValue.NumericValue;
			double divisor = divisorValue.NumericValue;
			if (divisor == 0)
