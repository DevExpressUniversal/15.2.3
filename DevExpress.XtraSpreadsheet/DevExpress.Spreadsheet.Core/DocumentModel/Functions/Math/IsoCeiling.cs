...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionIsoCeiling
	public class FunctionIsoCeiling : FunctionCeilingMath {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "ISO.CEILING"; } }
		public override int Code { get { return 0x4021; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (number.IsError)
				return number;
			double value = number.NumericValue, doubleSignificance = 1;
			...
			return GetNumericResult(value, doubleSignificance, 0);
		}
