...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionAcot
	public class FunctionACot : WorksheetFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "ACOT"; } }
		public override int Code { get { return 0x4015; } }
		...
		protected override VariantValue EvaluateArgument(VariantValue argument, WorkbookDataContext context) {
			...
			double result = Math.Asin(1 / Math.Sqrt(1 + Math.Pow(doubleValue, 2)));
			if (doubleValue <= 0)
