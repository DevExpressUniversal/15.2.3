...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionVarResult
	public class FunctionVarResult : FunctionStdevResult {
		public FunctionVarResult(WorkbookDataContext context)
			: base(context) {
		}
