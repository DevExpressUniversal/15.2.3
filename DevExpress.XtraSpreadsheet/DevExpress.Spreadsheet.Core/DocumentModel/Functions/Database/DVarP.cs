...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionDVarP
	public class FunctionDVarP : WorksheetDatabaseFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "DVARP"; } }
		public override int Code { get { return 0x00C4; } }
