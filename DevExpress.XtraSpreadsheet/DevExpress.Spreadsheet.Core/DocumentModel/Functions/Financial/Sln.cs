...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionSln
	public class FunctionSln : WorksheetFunctionBase {
		...
		#endregion
		#region Properties
		public override string Name { get { return "SLN"; } }
		public override int Code { get { return 0x8E; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			double result = DepreciationCalculator.CalculateSLN(cost, salvage, life);
