...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionSyd
	public class FunctionSyd : WorksheetFunctionBase {
		...
		#endregion
		#region Properties
		public override string Name { get { return "SYD"; } }
		public override int Code { get { return 0x8F; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (salvage < 0 || life <= 0 || period <= 0 || period > life)
				return VariantValue.ErrorNumber;
			double result = DepreciationCalculator.CalculateSYD(cost, salvage, life, period);
