...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionDdb
	public class FunctionDdb : WorksheetFunctionBase {
		...
		#endregion
		#region Properties
		public override string Name { get { return "DDB"; } }
		public override int Code { get { return 0x90; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			return DepreciationCalculator.CalculateDDB(cost, salvage, life, period, factor);
		}
	}
	#endregion
}
