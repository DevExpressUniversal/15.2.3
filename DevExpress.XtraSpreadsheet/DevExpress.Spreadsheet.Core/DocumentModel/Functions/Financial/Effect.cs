...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionEffect
	public class FunctionEffect : WorksheetFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "EFFECT"; } }
		public override int Code { get { return 0x01BE; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (value.IsError)
				return value;
			double nominalRate = value.NumericValue;
			...
			double effect = Math.Pow((double)(1 + nominalRate / npery), npery) - 1;
			if (double.IsInfinity(effect))
				return VariantValue.ErrorNumber;
			return effect;
		}
