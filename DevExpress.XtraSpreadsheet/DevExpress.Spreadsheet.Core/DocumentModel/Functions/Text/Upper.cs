...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionUpper
	public class FunctionUpper : WorksheetFunctionTextArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "UPPER"; } }
		public override int Code { get { return 0x0071; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (text.IsError)
				return text;
			return text.GetTextValue(context.StringTable).ToUpper();
		}
