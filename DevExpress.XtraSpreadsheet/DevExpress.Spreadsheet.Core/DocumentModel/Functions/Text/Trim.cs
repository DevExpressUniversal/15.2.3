...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionTrim
	public class FunctionTrim : WorksheetFunctionTextArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "TRIM"; } }
		public override int Code { get { return 0x0076; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (text.IsError)
				return text;
			return RemoveRedundantSpaces(text.GetTextValue(context.StringTable));
		}
