...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionLower
	public class FunctionLower : WorksheetFunctionTextArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "LOWER"; } }
		public override int Code { get { return 0x0070; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (text.IsError)
				return text;
			return text.GetTextValue(context.StringTable).ToLower();
		}
