...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionWorkDay
	public class FunctionWorkDay : FunctionWorkdayIntl {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override FunctionParameterCollection Parameters { get { return functionParameters; } }
		public override string Name { get { return "WORKDAY"; } }
		public override int Code { get { return 0x01D7; } }
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			if(arguments.Count == 3) { 
				VariantValue weekend = new VariantValue();
				weekend.NumericValue = 1;
				arguments.Insert(arguments.Count - 1, weekend);
			}
