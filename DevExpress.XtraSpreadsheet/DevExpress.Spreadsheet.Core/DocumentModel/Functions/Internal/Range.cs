...
namespace DevExpress.XtraSpreadsheet.Model {
	public class FunctionRange :WorksheetFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "RANGE"; } }
		public override int Code { get { return 0x4101; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (mailMergeProcessor == null)
				return argument;
			CellRangeBase result = mailMergeProcessor.GetRangeByCellRange(argument.CellRangeValue);
			if (result == null)
				return VariantValue.ErrorInvalidValueInFunction;
			return VariantValue.Create(result);
		}
