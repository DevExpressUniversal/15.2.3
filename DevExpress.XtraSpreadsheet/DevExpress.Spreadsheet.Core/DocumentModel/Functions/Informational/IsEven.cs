...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionIsEven
	public class FunctionIsEven : WorksheetFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "ISEVEN"; } }
		public override int Code { get { return 0x01A4; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			if (numericValue.IsError)
				return numericValue;
			return (Truncate(numericValue.NumericValue) % 2 == 0);
		}
		protected override VariantValue GetNumericValue(VariantValue value, WorkbookDataContext context) {
			if (value.IsBoolean || (value.IsCellRange && value.CellRangeValue.CellCount != 1))
