...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionFDotDistDotRt
	public class FunctionFDotDistDotRt : WorksheetFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "F.DIST.RT"; } }
		public override int Code { get { return 0x4057; } }
		...
		protected override VariantValue EvaluateCore(IList<VariantValue> arguments, WorkbookDataContext context) {
			...
			return 1 - FunctionFDotDist.GetResult(degreeFreedom1, degreeFreedom2, x);
		}
