...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionAveragea
	public class FunctionAverageA : WorksheetGenericFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "AVERAGEA"; } }
		public override int Code { get { return 0x0169; } }
		public override FunctionParameterCollection Parameters { get { return functionParameters; } }
		public override OperandDataType ReturnDataType { get { return OperandDataType.Value; } }
		protected override FunctionResult CreateInitialFunctionResult(WorkbookDataContext context) {
			return new FunctionAverageaResult(context);
		}
	...
	#endregion
	#region FunctionAverageaResult
	public class FunctionAverageaResult : FunctionResult {
		double total;
		double count;
		protected double Total { get { return total; } set { total = value; } }
		public FunctionAverageaResult(WorkbookDataContext context)
			: base(context) {
		}
