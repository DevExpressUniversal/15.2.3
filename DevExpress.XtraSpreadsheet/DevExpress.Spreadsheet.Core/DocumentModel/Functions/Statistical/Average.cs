...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionAverageResult
	public class FunctionAverageResult : FunctionResult {
		int count;
		double average;
		public FunctionAverageResult(WorkbookDataContext context)
			: base(context) {
		}
		protected int Count { get { return count; } }
		protected double Average { get { return average; } }
		...
		public override bool ProcessConvertedValue(VariantValue value) {
			average += ((double)value.NumericValue - average) / ++count;
			return true;
		}
