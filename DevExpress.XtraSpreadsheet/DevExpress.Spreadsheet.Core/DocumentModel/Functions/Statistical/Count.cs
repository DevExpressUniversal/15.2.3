...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionCountResultBase (abstract class)
	public abstract class FunctionCountResultBase : FunctionResult {
		double count;
		protected FunctionCountResultBase(WorkbookDataContext context)
			: base(context) {
		}
		...
		public override bool ProcessSingleValue(VariantValue value) {
			return ProcessConvertedValue(value); 
		}
	...
	public class FunctionCountResult : FunctionCountResultBase {
		public FunctionCountResult(WorkbookDataContext context)
			: base(context) {
		}
		public override bool ProcessConvertedValue(VariantValue value) {
			if (value.IsText && String.IsNullOrEmpty(value.GetTextValue(Context.StringTable)))
				return true; 
			return base.ProcessConvertedValue(value);
		}
		public override bool ProcessErrorValue(VariantValue value) {
			return true;
		}
	}
	#endregion
