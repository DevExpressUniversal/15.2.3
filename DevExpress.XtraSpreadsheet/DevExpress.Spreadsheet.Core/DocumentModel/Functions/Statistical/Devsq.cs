...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionDevsq
	public class FunctionDevsq : WorksheetGenericFunctionBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "DEVSQ"; } }
		public override int Code { get { return 0x013E; } }
		public override FunctionParameterCollection Parameters { get { return functionParameters; } }
		public override OperandDataType ReturnDataType { get { return OperandDataType.Value; } }
		protected override FunctionResult CreateInitialFunctionResult(WorkbookDataContext context) {
			return new FunctionDevsqResult(context);
		}
	...
	#endregion
	#region FunctionDevsqResult
	public class FunctionDevsqResult : FunctionAverageResult {
		List<double> values = new List<double>();
		public FunctionDevsqResult(WorkbookDataContext context)
			: base(context) {
		}
		public override bool ProcessConvertedValue(VariantValue value) {
			base.ProcessConvertedValue(value);
