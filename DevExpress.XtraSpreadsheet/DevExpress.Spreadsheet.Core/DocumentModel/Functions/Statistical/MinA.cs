...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionMinA
	public class FunctionMinA : FunctionMin {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "MINA"; } }
		public override int Code { get { return 0x016B; } }
		public override FunctionParameterCollection Parameters { get { return functionParameters; } }
		public override OperandDataType ReturnDataType { get { return OperandDataType.Value; } }
		protected override FunctionResult CreateInitialFunctionResult(WorkbookDataContext context) {
			return new FunctionMinAResult(context);
		}
	...
	#endregion
	#region FunctionMinAResult
	public class FunctionMinAResult : FunctionMaxMinAResult {
		public FunctionMinAResult(WorkbookDataContext context)
			: base(context, -1) {
		}
	}
	#endregion
