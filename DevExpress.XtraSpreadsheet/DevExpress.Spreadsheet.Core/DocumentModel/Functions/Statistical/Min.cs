...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionMinResult
	public class FunctionMinResult : FunctionMaxMinResultBase {
		public FunctionMinResult(WorkbookDataContext context)
			: base(context, -1) {
		}
	}
	#endregion
