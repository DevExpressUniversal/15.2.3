...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionTranspose
	public class FunctionTranspose : WorksheetFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "TRANSPOSE"; } }
		public override int Code { get { return 0x0053; } }
		...
		protected override VariantValue EvaluateArgument(VariantValue argument, WorkbookDataContext context) {
			if (argument.IsArray)
				return VariantValue.FromArray(new TransposedVariantArray(argument.ArrayValue));
			return argument;
		}
