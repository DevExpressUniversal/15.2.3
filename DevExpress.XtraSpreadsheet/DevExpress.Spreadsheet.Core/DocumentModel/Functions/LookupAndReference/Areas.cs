...
namespace DevExpress.XtraSpreadsheet.Model {
	public class FunctionAreas : WorksheetFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "AREAS"; } }
		public override int Code { get { return 0x004B; } }
		...
		protected override VariantValue EvaluateArgument(VariantValue argument, WorkbookDataContext context) {
			...
			if (argument.CellRangeValue.RangeType == CellRangeType.UnionRange)
				return ((CellUnion)argument.CellRangeValue).InnerCellRanges.Count;
			return 1;
		}
