...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionOrResult
	public class FunctionOrResult : WorksheetLogicalFunctionsResult {
		public FunctionOrResult(WorkbookDataContext context) : base(context) { }
