...
namespace DevExpress.XtraSpreadsheet.Model {
	...
	#endregion
	#region FunctionAndResult
	public class FunctionAndResult : WorksheetLogicalFunctionsResult {
		public FunctionAndResult(WorkbookDataContext context) : base(context) { Result = true; }
