...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImSech
	public class FunctionImSecH : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMSECH"; } }
		public override int Code { get { return 0x4034; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			Complex complexResult = Complex.Pow(Complex.Cosh(argument.Value), -1);
