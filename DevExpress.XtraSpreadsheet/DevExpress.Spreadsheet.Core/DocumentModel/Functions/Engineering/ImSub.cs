...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImSub
	public class FunctionImSub : WorksheetFunctionTwoComplexArgumentsBase {
		public override string Name { get { return "IMSUB"; } }
		public override int Code { get { return 0x018C; } }
		protected override VariantValue EvaluateArguments(SpreadsheetComplex argument1, SpreadsheetComplex argument2, WorkbookDataContext context) {
			...
			Complex complexResult = Complex.Subtract(argument1.Value, argument2.Value);
