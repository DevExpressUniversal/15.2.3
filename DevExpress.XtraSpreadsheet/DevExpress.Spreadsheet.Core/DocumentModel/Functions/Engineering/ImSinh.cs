...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImSinh
	public class FunctionImSinH : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMSINH"; } }
		public override int Code { get { return 0x4035; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			Complex complexResult = Complex.Sinh(argument.Value);
