...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImLog10
	public class FunctionImLog10 : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMLOG10"; } }
		public override int Code { get { return 0x0193; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			...
			Complex complexResult = Complex.Log10(argument.Value);
