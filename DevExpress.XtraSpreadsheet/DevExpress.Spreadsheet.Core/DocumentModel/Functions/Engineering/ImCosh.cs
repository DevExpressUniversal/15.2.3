...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImCosh
	public class FunctionImCosH : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMCOSH"; } }
		public override int Code { get { return 0x402F; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			Complex complexResult = Complex.Cosh(argument.Value);
