...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImSec
	public class FunctionImSec : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMSEC"; } }
		public override int Code { get { return 0x4033; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			Complex complexResult = Complex.Pow(Complex.Cos(argument.Value), -1);
