...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImSqrt
	public class FunctionImSqrt : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMSQRT"; } }
		public override int Code { get { return 0x0190; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			Complex complexResult = Complex.Sqrt(argument.Value);
