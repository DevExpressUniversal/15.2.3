...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImCsch
	public class FunctionImCsch : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMCSCH"; } }
		public override int Code { get { return 0x4032; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			if (Complex.Equals(Complex.Sinh(argument.Value), Complex.Zero))
				return VariantValue.ErrorNumber;
			Complex complexResult = Complex.Pow(Complex.Sinh(argument.Value), -1);
