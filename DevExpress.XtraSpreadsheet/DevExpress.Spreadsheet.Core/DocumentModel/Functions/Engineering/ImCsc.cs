...
namespace DevExpress.XtraSpreadsheet.Model {
	#region FunctionImCsc
	public class FunctionImCsc : WorksheetComplexFunctionSingleArgumentBase {
		static readonly FunctionParameterCollection functionParameters = PrepareParameters();
		public override string Name { get { return "IMCSC"; } }
		public override int Code { get { return 0x4031; } }
		...
		protected override VariantValue GetNumericResult(SpreadsheetComplex argument, WorkbookDataContext context) {
			...
			Complex complexResult = Complex.Pow(Complex.Sin(argument.Value), -1);
