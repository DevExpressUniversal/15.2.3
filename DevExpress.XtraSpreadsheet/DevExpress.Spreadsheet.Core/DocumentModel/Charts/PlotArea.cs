...
namespace DevExpress.XtraSpreadsheet.Model {
	public class PlotArea : ICloneable<PlotArea>, ISupportsCopyFrom<PlotArea> {
		#region Fields
		readonly IChart parent;
		LayoutOptions layout;
		ShapeProperties shapeProperties;
		#endregion
		public PlotArea(IChart parent) {
			this.parent = parent;
		...
		#endregion
		#region ICloneable<PlotArea> Members
		public PlotArea Clone() {
			PlotArea result = new PlotArea(Parent);
			result.CopyFrom(this);
			return result;
		}
		#endregion
		#region ISupportsCopyFrom<PlotArea> Members
		public void CopyFrom(PlotArea value) {
