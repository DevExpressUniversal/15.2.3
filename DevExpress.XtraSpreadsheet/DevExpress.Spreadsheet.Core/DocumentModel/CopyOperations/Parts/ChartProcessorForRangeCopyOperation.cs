...
namespace DevExpress.XtraSpreadsheet.Model.CopyOperation {
	public class ChartProcessorForRangeCopyOperation {
		ITargetRangeCalculatorOwner owner;
		IRangeCopyChartPart rangeCopy;
		public ChartProcessorForRangeCopyOperation(ITargetRangeCalculatorOwner owner, IRangeCopyChartPart rangeCopy) {
			this.owner = owner;
			this.rangeCopy = rangeCopy;
		}
		protected ITargetRangeCalculatorOwner Owner { get { return owner; } }
		public IRangeCopyChartPart RangeCopy { get { return rangeCopy; } }
		public virtual void Execute(RangeCopyInfo rangeInfo, Chart sourceChart) {
			foreach (Model.CellRange currentTargetRange in rangeInfo.TargetRanges) {
				...
				RangeCopy.CreateTargetChart(sourceChart, offset);
			}
		}
	}
}
