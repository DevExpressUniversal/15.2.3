...
namespace DevExpress.XtraSpreadsheet.Model.CopyOperation {
	public class CopyTableColumnFormulaDiffWorkseetRPNVisitor : ReplaceThingsPRNVisitor {
		string newTableName;
		public CopyTableColumnFormulaDiffWorkseetRPNVisitor(Worksheet source, Worksheet target)
			{
