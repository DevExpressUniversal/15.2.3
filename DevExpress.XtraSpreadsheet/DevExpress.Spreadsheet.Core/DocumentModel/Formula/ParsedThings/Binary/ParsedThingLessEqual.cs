...
namespace DevExpress.XtraSpreadsheet.Model {
	#region ParsedThingLessEqual
	public class ParsedThingLessEqual : BinaryBooleanParsedThing {
		#region Fields
		static ParsedThingLessEqual instance = new ParsedThingLessEqual();
		#endregion
		protected ParsedThingLessEqual() {
		}
		#region Properties
		public static ParsedThingLessEqual Instance {
			get {
				return instance;
			}
		}
	...
	#endregion
	#region ParsedThingLessEqualStrictTypeMatch
	public class ParsedThingLessEqualStrictTypeMatch : ParsedThingLessEqual, IHeplerParsedThing {
		public ParsedThingLessEqualStrictTypeMatch()
			: base() {
		}
