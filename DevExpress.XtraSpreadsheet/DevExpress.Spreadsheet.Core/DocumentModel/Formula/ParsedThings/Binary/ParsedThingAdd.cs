...
namespace DevExpress.XtraSpreadsheet.Model {
	public class ParsedThingAdd : BinaryArithmeticParsedThing {
		#region Fields
		static ParsedThingAdd instance = new ParsedThingAdd();
		#endregion
		ParsedThingAdd() {
		}
		#region Properties
		public static ParsedThingAdd Instance { get { return instance; } }
		#endregion
