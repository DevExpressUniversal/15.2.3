...
namespace DevExpress.XtraSpreadsheet.Model {
	public class ParsedThingPower : BinaryArithmeticParsedThing {
		#region Fields
		static ParsedThingPower instance = new ParsedThingPower();
		#endregion
		ParsedThingPower() {
		}
		#region Properties
		public static ParsedThingPower Instance {
			get {
				return instance;
			}
		}
		#endregion
		static FunctionPower power = new FunctionPower();
		...
		protected override VariantValue GetNumericResult(double left, double right) {
			return power.GetNumericResult(left, right);
		}
