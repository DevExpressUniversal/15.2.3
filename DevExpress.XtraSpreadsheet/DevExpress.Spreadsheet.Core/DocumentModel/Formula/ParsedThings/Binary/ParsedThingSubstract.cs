...
namespace DevExpress.XtraSpreadsheet.Model {
	public class ParsedThingSubtract : BinaryArithmeticParsedThing {
		#region Fields
		static ParsedThingSubtract instance = new ParsedThingSubtract();
		#endregion
		ParsedThingSubtract() {
		}
		#region Properties
		public static ParsedThingSubtract Instance {
			get {
				return instance;
			}
		}
