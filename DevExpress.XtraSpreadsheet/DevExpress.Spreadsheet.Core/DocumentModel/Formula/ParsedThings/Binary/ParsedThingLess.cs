...
namespace DevExpress.XtraSpreadsheet.Model {
	#region ParsedThingLess
	public class ParsedThingLess : BinaryBooleanParsedThing {
		#region Fields
		static ParsedThingLess instance = new ParsedThingLess();
		#endregion
		protected ParsedThingLess() {
		}
		#region Properties
		public static ParsedThingLess Instance {
			get {
				return instance;
			}
		}
	...
	#endregion
	#region ParsedThingLessStrictTypeMatch
	public class ParsedThingLessStrictTypeMatch : ParsedThingLess, IHeplerParsedThing {
		public ParsedThingLessStrictTypeMatch()
			: base() {
		}
