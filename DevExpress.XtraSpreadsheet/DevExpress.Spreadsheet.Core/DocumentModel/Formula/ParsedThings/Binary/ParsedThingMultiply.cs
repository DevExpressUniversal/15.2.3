...
namespace DevExpress.XtraSpreadsheet.Model {
	public class ParsedThingMultiply : BinaryArithmeticParsedThing {
		#region Fields
		static ParsedThingMultiply instance = new ParsedThingMultiply();
		#endregion
		ParsedThingMultiply() {
		}
		#region Properties
		public static ParsedThingMultiply Instance {
			get {
				return instance;
			}
		}
