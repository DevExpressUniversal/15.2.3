...
namespace DevExpress.XtraSpreadsheet.Model {
	public class ParsedThingPercent : UnaryParsedThing {
		#region Fields
		static ParsedThingPercent instance = new ParsedThingPercent();
		#endregion
		ParsedThingPercent() {
		}
		#region Properties
		public static ParsedThingPercent Instance {
			get {
				return instance;
			}
		}
		...
		public override void BuildExpressionString(Stack<int> stack, System.Text.StringBuilder builder, System.Text.StringBuilder spacesBuilder, WorkbookDataContext context) {
			...
			builder.Append(GetOperatorText(context));
