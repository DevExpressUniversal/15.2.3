...
namespace DevExpress.XtraSpreadsheet.Model {
	public class ParsedThingUnaryMinus : UnaryParsedThing {
		#region Fields
		static ParsedThingUnaryMinus instance = new ParsedThingUnaryMinus();
		#endregion
		ParsedThingUnaryMinus() {
		}
		#region Properties
		public static ParsedThingUnaryMinus Instance {
			get {
				return instance;
			}
		}
