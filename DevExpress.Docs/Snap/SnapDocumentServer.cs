...
namespace DevExpress.Snap {
	public class SnapDocumentServer : RichEditDocumentServer, ISnapDocumentServer, IRichEditDocumentServer, IBatchUpdateable, IServiceContainer, IServiceProvider, IDisposable, ISnapDriver {
		public SnapDocumentServer()
			: base() {
		}
		protected new InternalSnapDocumentServer InnerServer { get { return (InternalSnapDocumentServer)base.InnerServer; } }
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerSnxBytes")]
#endif
		public byte[] SnxBytes { get { return InnerServer.SnxBytes; } set { InnerServer.SnxBytes = value; } }
		[
#if !SL
	DevExpressDocsLocalizedDescription("SnapDocumentServerOptions"),
#endif
 NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public new SnapDocumentServerOptions Options { get { return (SnapDocumentServerOptions)base.Options; } }
		#region Events
		#region BeforeConversion
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerBeforeConversion")]
#endif
		public event BeforeConversionEventHandler BeforeConversion {
			add { if (InnerServer != null) InnerServer.BeforeConversion += value; }
			remove { if (InnerServer != null) InnerServer.BeforeConversion -= value; }
		}
		#endregion
		#region BeforeDataSourceExport
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerBeforeDataSourceExport")]
#endif
		public event BeforeDataSourceExportEventHandler BeforeDataSourceExport {
			add { if (InnerServer != null) InnerServer.BeforeDataSourceExport += value; }
			remove { if (InnerServer != null) InnerServer.BeforeDataSourceExport -= value; }
		}
		#endregion
		#region AfterDataSourceImport
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerAfterDataSourceImport")]
#endif
		public event AfterDataSourceImportEventHandler AfterDataSourceImport {
			add { if (InnerServer != null) InnerServer.AfterDataSourceImport += value; }
			remove { if (InnerServer != null) InnerServer.AfterDataSourceImport -= value; }
		}
		#endregion
		#region DataSourceChanged
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerDataSourceChanged")]
#endif
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerAsynchronousOperationStarted")]
#endif
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerAsynchronousOperationFinished")]
#endif
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerSnapMailMergeStarted")]
#endif
		public event SnapMailMergeStartedEventHandler SnapMailMergeStarted {
			add {
				if (InnerServer != null)
					InnerServer.SnapMailMergeStarted += value;
			}
			remove {
				if (InnerServer != null)
					InnerServer.SnapMailMergeStarted -= value;
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerSnapMailMergeRecordStarted")]
#endif
		public event SnapMailMergeRecordStartedEventHandler SnapMailMergeRecordStarted {
			add {
				if (InnerServer != null)
					InnerServer.SnapMailMergeRecordStarted += value;
			}
			remove {
				if (InnerServer != null)
					InnerServer.SnapMailMergeRecordStarted -= value;
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerSnapMailMergeRecordFinished")]
#endif
		public event SnapMailMergeRecordFinishedEventHandler SnapMailMergeRecordFinished {
			add {
				if (InnerServer != null)
					InnerServer.SnapMailMergeRecordFinished += value;
			}
			remove {
				if (InnerServer != null)
					InnerServer.SnapMailMergeRecordFinished -= value;
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerSnapMailMergeFinished")]
#endif
		public event SnapMailMergeFinishedEventHandler SnapMailMergeFinished {
			add {
				if (InnerServer != null)
					InnerServer.SnapMailMergeFinished += value;
			}
			remove {
				if (InnerServer != null)
					InnerServer.SnapMailMergeFinished -= value;
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerDocumentClosing")]
#endif
		...
		#endregion
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerEmptyDocumentCreated")]
#endif
...
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerDocumentLoaded")]
#endif
		...
		#endregion
		protected override InternalRichEditDocumentServer CreateInternalDocumentServer() {
			return new InternalSnapDocumentServer();
		}
#if !SL
	[DevExpressDocsLocalizedDescription("SnapDocumentServerDocument")]
#endif
