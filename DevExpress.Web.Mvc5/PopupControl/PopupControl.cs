...
namespace DevExpress.Web.Mvc {
	...
	[ToolboxItem(false)]
	public class MVCxPopupControl : ASPxPopupControl {
		protected internal MVCxPopupControl()
			: base() {
		}
		...
		protected override string GetClientObjectClassName() {
			return "MVCxClientPopupControl";
		}
		protected override void RegisterIncludeScripts() {
			base.RegisterIncludeScripts();
			RegisterIncludeScript(typeof(MVCxPopupControl), Utils.UtilsScriptResourceName);
			RegisterIncludeScript(typeof(MVCxPopupControl), Utils.PopupControlScriptResourceName);
		}
	}
}
