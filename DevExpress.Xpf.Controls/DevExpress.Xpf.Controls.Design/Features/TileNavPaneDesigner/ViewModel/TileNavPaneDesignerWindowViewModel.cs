...
namespace DevExpress.Xpf.Controls.Design.Features.TileNavPaneDesigner.ViewModel {
	public class TileNavPaneDesignerWindowViewModel : ViewModelBase {
		private IModelItem modelItem;
		public TileNavPaneDesignerWindowViewModel(IModelItem modelItem) {
			this.modelItem = modelItem;
			CategoriesVM = new CategoriesViewModel(modelItem);
		}
