...
namespace DevExpress.XtraLayout.Customization {	
		public class NoSelection : InteractionMethod {
			public NoSelection(UserInteractionHelper owner)
				: base(owner) {
				EditorType = EditorTypes.Label;			   
				Text = "Select item to customize";
			...
			public override bool CanExecute() {
				...
				if(selItems.Count == 0) return true;
				return false;
			}
