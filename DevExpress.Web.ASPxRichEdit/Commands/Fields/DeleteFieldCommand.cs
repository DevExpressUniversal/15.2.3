...
namespace DevExpress.Web.ASPxRichEdit.Internal {
	public class DeleteFieldCommand : WebRichEditUpdateModelCommandBase {
		public DeleteFieldCommand(CommandManager commandManager, Hashtable parameters) : base(commandManager, parameters) { }
		public override CommandType Type { get { return CommandType.DeleteField; } }
