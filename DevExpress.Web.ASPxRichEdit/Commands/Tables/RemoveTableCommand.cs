...
namespace DevExpress.Web.ASPxRichEdit.Internal {
	public class RemoveTableCommand : WebRichEditUpdateModelCommandBase {
		public RemoveTableCommand(CommandManager commandManager, Hashtable parameters) : base(commandManager, parameters) { }
		public override CommandType Type { get { return CommandType.RemoveTable; } }
