...
namespace DevExpress.Web.ASPxRichEdit.Export {
	public class ParagraphFormattingBaseExporter2 : FormattingExporterBase<DevExpress.XtraRichEdit.Model.ParagraphFormattingBase> {		
		public override void FillHashtable(Hashtable result, DevExpress.XtraRichEdit.Model.ParagraphFormattingBase info) {
			...
			result.Add("24", (int)info.UseValue);			
		}
		public override void RestoreInfo(Hashtable source, DevExpress.XtraRichEdit.Model.ParagraphFormattingBase info) {
			...
			info.BackColor = System.Drawing.Color.FromArgb((int)source["19"]);
			...
			info.UseValue = (DevExpress.XtraRichEdit.Model.ParagraphFormattingOptions.Mask)source["24"];
		}
	}
}
