...
namespace DevExpress.Web.ASPxRichEdit.Export {
	public static class BorderBaseExporter {		
		public static Hashtable ToHashtable(DevExpress.XtraRichEdit.Model.BorderBase info) {
		...
		public static void FromHashtable(Hashtable source, DevExpress.XtraRichEdit.Model.BorderBase info) {
