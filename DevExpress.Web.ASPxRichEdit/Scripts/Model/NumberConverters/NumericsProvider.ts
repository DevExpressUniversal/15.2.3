module __aspxRichEdit {
    export class NumericsProvider {
        ...
        constructor(separator: string[], singlesNumeral: string[], singles: string[], teens: string[], tenths: string[], hundreds: string[],
            thousands: string[], million: string[], billion: string[], trillion: string[], quadrillion: string[], quintillion: string[]) {
    ...
    export class OrdinalEnglishNumericsProvider extends NumericsProvider {
        constructor() {
            super([" ", "-"], ["first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "zeroth"],
                ["first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "zeroth"],
    ...
    export class CardinalEnglishNumericsProvider extends NumericsProvider {
        constructor() {
            super([" ", "-"], ["one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "zero"],
