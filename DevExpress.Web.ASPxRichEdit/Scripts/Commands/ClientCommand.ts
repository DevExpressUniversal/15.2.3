module __aspxRichEdit {
    export enum RichEditClientCommand {
        None = 0,
        FileNew = 1,
        FileOpen = 2,
        FileSave = 3,
        ...
        InsertPicture = 56,
        //InsertFloatingPicture = 57,
        ShowBookmarkForm = 58,
        ShowHyperlinkForm = 59,
        //EditPageHeader = 60,
        //EditPageFooter = 61,
        //InsertPageNumberField = 62,
        //InsertPageCountField = 63,
        //InsertTextBox = 64,
        ShowSymbolForm = 65,
        ...
        //ChangeSectionLineNumbering = 83,
        //SetSectionLineNumberingNone = 84,
        //SetSectionLineNumberingContinuous = 85,
        //SetSectionLineNumberingRestartNewPage = 86,
        //SetSectionLineNumberingRestartNewSection = 87,
        //ToggleParagraphSuppressLineNumbers = 88,
        //ShowLineNumberingForm = 89,
        ChangePageColor = 90,

        //SwitchToSimpleView = 91,
        //SwitchToDraftView = 92,
        //SwitchToPrintLayoutView = 93,
        ToggleShowHorizontalRuler = 94,
        //ToggleShowVerticalRuler = 95,
        //ZoomOut = 96,
        //ZoomIn = 97,
        FullScreen = 98,
        ...
        CreateField = 178,  // fields
        UpdateField = 179,
        ToggleFieldCodes = 180,
        //ShowInsertMergeFieldForm = 181,
        //InsertMailMergeField = 182,
        //InsertMailMergeFieldPlaceholder = 183,
        //InsertPageNumberField = 184,
        //InsertPageCountField = 185,
        ShowAllFieldCodes = 186,
        ShowAllFieldResults = 187,
        ToggleAllFields = 188, // fields end
