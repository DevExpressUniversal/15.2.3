...
namespace DevExpress.Web.ASPxRichEdit.Forms {
	public class SelectFolderForm : OpenFileForm {
		protected override void PopulateContentGroup(LayoutGroup group) {
			FileManager = new RichEditFolderManager();
		...
		protected override void PopulateBottomItemControls(List<Control> controls) {
			ASPxButton submitButton = CreateDialogButton("BtnSelect", ASPxRichEditStringId.SelectButton);
			submitButton.ID = SubmitButtonId;
			ASPxButton cancelButton = CreateDialogButton("BtnCancleSelect", ASPxRichEditStringId.CancelButton);
