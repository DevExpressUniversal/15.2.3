...
namespace DevExpress.Web.ASPxRichEdit {
	public class RichEditClientSideEvents : CallbackClientSideEventsBase {
		[
#if !SL
	DevExpressWebASPxRichEditLocalizedDescription("RichEditClientSideEventsCustomCommandExecuted"),
#endif
