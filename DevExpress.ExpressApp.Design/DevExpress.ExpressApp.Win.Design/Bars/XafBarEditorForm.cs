...
namespace DevExpress.ExpressApp.Win.Design.Bars {
	public class XafBarEditorForm : BarEditorForm {
		protected override void CreateDesigner() {
			ActiveDesigner = new XafBarAndDockingDesigner(EditingComponent);
		}
		public XafBarEditorForm() {
			InitializeComponent();
		}
		...
		private void InitializeComponent() {
			...
			this.Name = "XafBarEditorForm";
			this.Text = "XAF BarManager Designer";
