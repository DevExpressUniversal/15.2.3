...
namespace DevExpress.ExpressApp.Win.Design.Ribbon {
	public class XafRibbonEditorForm : RibbonEditorForm {
		protected override void CreateDesigner() {
			ActiveDesigner = new XafRibbonAndDockingDesigner(EditingComponent);
		}
		public XafRibbonEditorForm() {
			InitializeComponent();
		}
		...
		private new void InitializeComponent() {
			...
			this.Name = "XafRibbonEditorForm";
			this.Text = "XAF Ribbon Control Designer";
