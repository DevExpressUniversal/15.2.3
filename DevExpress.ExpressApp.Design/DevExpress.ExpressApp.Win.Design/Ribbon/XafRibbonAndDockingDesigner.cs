...
namespace DevExpress.ExpressApp.Win.Design.Ribbon {
	public class XafRibbonAndDockingDesigner : RibbonDesigner {
		Image navBarGroupImage;
		ImageList navBarItemsImages;
		protected override void CreateGroups() {
			base.CreateGroups();
			Groups["Toolbars"].GetItemByCaption("Ribbon Items").FrameType = typeof(XafRibbonItemsManagerBase);
			Groups["Toolbars"].GetItemByCaption("Quick Access Toolbar").FrameType = typeof(XafQuickAccessToolbarManager);
			Groups["Toolbars"].GetItemByCaption("Ribbon PageHeader Items").FrameType = typeof(XafPageHeaderItemsManager);
			Groups["Toolbars"].GetItemByCaption("Status Bar").FrameType = typeof(XafStatusBarManager);
			...
			actionControlsGroup.Add("Action Containers", "Customize Action containers.", typeof(RibbonActionContainersEditor), null, navBarItemsImages.Images[0], null);
		...
		public XafRibbonAndDockingDesigner(object component) : base(component) {
