...
namespace DevExpress.ExpressApp.Design.Commands {
	public class OpenModelEditorCommand : VSCommand {
		private string openModelEditorCommandName = "OpenModelEditor";
		public OpenModelEditorCommand(IServiceProvider serviceProvider) : base(serviceProvider) { }
		public override string CommandName {
			get { return openModelEditorCommandName; }
		}
		public override string CommandToolName {
			get { return "Open Model Editor"; }
		}
		public override CommandID CommandID {
			get { return new CommandID(ConstantList.guidMenuAndCommandsCmdSet, CommandIds.cmdidOpenModelEditorCommand); }
		}
		public override void InternalExec() {
			ProjectWrapper projectWrapper = ProjectWrapper.Create(FindSelectedProject());
			ProjectItem modelFile = projectWrapper.GetInvariantDiffsFile();
			projectWrapper.OpenProjectItem(modelFile);
		}
