...
namespace DevExpress.XtraPivotGrid {
	public abstract class PivotXlsExportOptionsBase : XlsExportOptionsEx, IPivotGridExportOptions {
		...
		protected PivotXlsExportOptionsBase() {
			Init();
		}
		protected PivotXlsExportOptionsBase(TextExportMode mode)
			: base(mode) {
			Init();
		}
		void Init() {
		...
		public override void Assign(ExportOptionsBase source) {
			base.Assign(source);
			PivotXlsExportOptionsBase options = source as PivotXlsExportOptionsBase;
			if(options != null) {
