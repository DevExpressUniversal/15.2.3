...
namespace DevExpress.XtraPivotGrid {
	public class PivotGridXmlaDataSource : OLAPDataSourceBase {
		public string ConnectionString {
			get { return OLAPMetadata.FullConnectionString; }
			set { OLAPMetadata.FullConnectionString = value; }
		}
		public PivotGridXmlaDataSource() : base((PivotGridData)null) {
		}
		protected PivotGridXmlaDataSource(OLAPMetadata metadata) : base(metadata) {
		}
		protected override void OnSuccessConnected() {
#if !SL
			RaiseConnectionChanged();
#endif
		}
		protected override OLAPMetadata CreateMetadata() {
			return new XmlaMetadata();
		}
		...
		protected override QueryDataSource<OLAPCubeColumn> CreateInstance() {
			return new PivotGridXmlaDataSource(OLAPMetadata);
		}
	}
}
