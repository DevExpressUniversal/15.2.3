...
namespace DevExpress.XtraPivotGrid.Data {
	public class PivotGridOLAPDataSource : OLAPDataSourceBase {
		PivotGridOLAPDataSource() { }
		public PivotGridOLAPDataSource(PivotGridData pivotGridData)
			: base(pivotGridData) {
		}
		protected PivotGridOLAPDataSource(OLAPMetadata metadata) : base(metadata) {
		}
		protected override OLAPMetadata CreateMetadata() {
#if DXPORTABLE
			return null;
#else
			return new OleDbMetadata();
#endif
		}
		...
		protected override QueryDataSource<OLAPCubeColumn> CreateInstance() {
			return new PivotGridOLAPDataSource(OLAPMetadata);
		}
	}
}
