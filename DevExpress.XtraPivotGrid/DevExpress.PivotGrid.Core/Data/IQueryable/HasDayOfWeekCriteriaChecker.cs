...
namespace DevExpress.PivotGrid.ServerMode.Queryable {
	class HasDayOfWeekChecker : BaseCriteriaChecker {
		public static bool Check(CriteriaOperator criteriaOperator) {
			return Check<HasDayOfWeekChecker>(criteriaOperator);
		}
		...
		public override bool Visit(FunctionOperator theOperator) {
			if(theOperator.OperatorType == FunctionOperatorType.GetDayOfWeek)
				return true;
