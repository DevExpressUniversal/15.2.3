...
namespace DevExpress.XtraGrid.Design {
	...
	public class DesignLevelSelector : XtraUserControl {
		...
		void CreateIcons() {
			ImageList iml = DevExpress.Utils.ResourceImageHelper.CreateImageListFromResources("DevExpress.XtraGrid.Design.Designer.GrayViewIcons.bmp", typeof(LevelSelector).Assembly, new Size(16, 16), Color.Magenta);
			tree.Images = iml;
		}
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DesignLevelSelector));
			this.panel = new DevExpress.XtraEditors.PanelControl();
			this.pnlClient = new DevExpress.XtraEditors.XtraScrollableControl();
			this.tree = new DevExpress.XtraGrid.Design.DesignViewTree();
			...
			this.lblLine.LineVisible = true;
			this.Controls.Add(this.panel);
			this.Name = "DesignLevelSelector";
