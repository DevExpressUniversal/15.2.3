...
namespace DevExpress.XtraGrid.Skins {
	public class GridSkinElementsPainter : GridElementsPainter {
		public GridSkinElementsPainter(BaseView view) : base(view) { }
		...
		protected override GridGroupRowPainter CreateGroupRowPainter() { return new SkinGridGroupRowPainter(View, this); }
	}
}
