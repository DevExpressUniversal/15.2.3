...
namespace DevExpress.Xpf.Carousel {
	...
	public class CarouselItemsControl : ItemsControl {
		...
		static CarouselItemsControl() {
			Type ownerType = typeof(CarouselItemsControl);
			CarouselProperty = DependencyProperty.Register("Carousel", typeof(CarouselPanel), ownerType, new FrameworkPropertyMetadata(null));
			DefaultStyleKeyProperty.OverrideMetadata(ownerType, new FrameworkPropertyMetadata(ownerType));
		}
#if !SL
	[DevExpressXpfCarouselLocalizedDescription("CarouselItemsControlCarousel")]
#endif
