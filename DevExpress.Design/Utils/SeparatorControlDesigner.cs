...
namespace DevExpress.XtraEditors.Design {
	public class SeparatorControlDesigner : BaseControlDesigner {
		protected override bool CanUseComponentSmartTags {
			get { return true; }
		}
		protected virtual new SeparatorControl Control {
			get { return base.Control as SeparatorControl; }
		}
		public override SelectionRules SelectionRules {
			get {
				if(!Control.AutoSizeMode) return base.SelectionRules;
				if(Control.LineOrientation == Orientation.Horizontal)
