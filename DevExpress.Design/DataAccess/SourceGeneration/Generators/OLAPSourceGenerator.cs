...
namespace DevExpress.Design.DataAccess {
	class OLAPSourceGenerator : DataSourceGeneratorBase {
		...
		protected override void SetCustomBindingProperties(IDataSourceGeneratorContext context) {
			...
			context.SetCustomBindingProperty(context.OLAPConnectionStringProperty, olapSettingsModel.ConnectionString);
			context.SetCustomBindingProperty(context.OLAPDataProviderProperty, olapSettingsModel.DataProvider);
		}
	}
}
