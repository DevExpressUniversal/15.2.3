...
namespace DevExpress.Design.DataAccess {
	...
	abstract class LocalizableDataAccessObject<TCodeName> : ILocalizableDataAccessObject<TCodeName>
		where TCodeName : struct {
		readonly TCodeName codeName;
		protected LocalizableDataAccessObject(TCodeName codeName) {
		...
		TCodeName ILocalizableDataAccessObject<TCodeName>.GetCodeName() {
			return codeName;
		}
		...
		public sealed override bool Equals(object obj) {
			ILocalizableDataAccessObject<TCodeName> source = obj as ILocalizableDataAccessObject<TCodeName>;
		...
		static LocalizableDataAccessObject() {
		...
		static class CodeNamesResolver<CodeName>
			...
			static string LoadName(CodeName name) {
				...
				string result = DataAccessLocalizer.GetString((DataAccessLocalizerStringId)Enum.Parse(typeof(DataAccessLocalizerStringId), strId));
