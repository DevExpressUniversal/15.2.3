...
namespace DevExpress.Web.Internal {
	...
	public class CallbackArgumentsReader {
		...
		protected bool ReadCallbackArgs(ref string eventArguments, string[] prefixes) {
			foreach(string prefix in prefixes) {
				...
				if(eventArguments.StartsWith(testPrefix, StringComparison.InvariantCulture)) {
	...
	public class GridCallbackArgumentsReader : CallbackArgumentsReader {
		public const string
			GridCallbackPrefix = "GB",
			FunctionCallbackPrefix = "FB",
			CallbackStatePrefix = "CB",
			EditValuesPrefix = "EV",
			SelectionRowsPrefix = "SR",
			FocusedRowPrefix = "FR",
			ColumnResizingPrefix = "CR",
			PageKeyValuesPrefix = "KV",
			ContextMenuPrefix = "CM";
		public GridCallbackArgumentsReader(string arguments)
			: base(arguments, new string[] { GridCallbackPrefix, ContextMenuPrefix, FunctionCallbackPrefix, PageKeyValuesPrefix, CallbackStatePrefix,
				EditValuesPrefix, SelectionRowsPrefix, FocusedRowPrefix, ColumnResizingPrefix }) {
		}
		...
		public string PageKeyValues { get { return this[GridCallbackArgumentsReader.PageKeyValuesPrefix]; } }
		...
		public string ContextMenuValues { get { return this[GridCallbackArgumentsReader.ContextMenuPrefix]; } }
	}
}
