...
namespace DevExpress.Data.Linq.Tests {
	[TestFixture]
	public class EntityServerModeTests {
		...
		[Test]
		public void EntityServerModeDataSource_Basic() {
			EntityServerModeDataSource ds = new EntityServerModeDataSource();
		...
		public void PrimaryKeyReported_S91845() {
			var viewSchema = new System.Web.UI.Design.DataSetViewSchema(DevExpress.Data.Linq.Design.EntityServerModeDataSourceDesignerView.CreateSchemaTable(typeof(Victim)));
			bool keyFound = false;
