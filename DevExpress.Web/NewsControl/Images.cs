...
namespace DevExpress.Web {
	public class NewsControlImages : ImagesBase {
		public const string BackToTopImageName = "ncBackToTop",
							ItemImageName = "ncItem";
		public NewsControlImages(ASPxNewsControl newsControl)
			: base(newsControl) {
		}
		[
#if !SL
	DevExpressWebLocalizedDescription("NewsControlImagesBackToTop"),
#endif
		...
		[
#if !SL
	DevExpressWebLocalizedDescription("NewsControlImagesItem"),
#endif
		NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty),
		DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
