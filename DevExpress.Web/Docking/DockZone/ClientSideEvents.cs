...
namespace DevExpress.Web {
	public class DockZoneClientSideEvents : ClientSideEvents {
		   const string
			 BeforeDockEventName = "BeforeDock",
			 AfterDockEventName = "AfterDock";
		   public DockZoneClientSideEvents()
			: base() {
		}
		[
#if !SL
	DevExpressWebLocalizedDescription("DockZoneClientSideEventsBeforeDock"),
#endif
		...
		[
#if !SL
	DevExpressWebLocalizedDescription("DockZoneClientSideEventsAfterDock"),
#endif
		DefaultValue(""), NotifyParentProperty(true), Localizable(false),
		Editor("DevExpress.Web.Design.CommonDesignerEditor, " + AssemblyInfo.SRAssemblyWebDesignFull,
			typeof(System.Drawing.Design.UITypeEditor))]
