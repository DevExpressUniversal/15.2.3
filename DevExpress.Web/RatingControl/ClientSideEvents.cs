...
namespace DevExpress.Web {
	public class RatingControlClientSideEvents : ItemClickClientSideEvents {
		public RatingControlClientSideEvents()
			: base() {
		}
		[
#if !SL
	DevExpressWebLocalizedDescription("RatingControlClientSideEventsItemMouseOver"),
#endif
		...
		[
#if !SL
	DevExpressWebLocalizedDescription("RatingControlClientSideEventsItemMouseOut"),
#endif
		DefaultValue(""), NotifyParentProperty(true), Localizable(false),
		Editor("DevExpress.Web.Design.CommonDesignerEditor, " + AssemblyInfo.SRAssemblyWebDesignFull, typeof(System.Drawing.Design.UITypeEditor))]
