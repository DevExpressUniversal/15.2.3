...
namespace DevExpress.Web {
	public class GridLookupClientSideEvents : DropDownClientSideEvents {
		public GridLookupClientSideEvents()
			: base() {
		}
		public GridLookupClientSideEvents(IPropertiesOwner owner) 
			: base(owner) {
		}
		[
#if !SL
	DevExpressWebLocalizedDescription("GridLookupClientSideEventsBeginCallback"),
#endif
		...
		[
#if !SL
	DevExpressWebLocalizedDescription("GridLookupClientSideEventsEndCallback"),
#endif
		DefaultValue(""), NotifyParentProperty(true), Localizable(false),
		Editor("DevExpress.Web.Design.CommonDesignerEditor, " + AssemblyInfo.SRAssemblyWebDesignFull, typeof(UITypeEditor))]
		...
		[
#if !SL
	DevExpressWebLocalizedDescription("GridLookupClientSideEventsRowClick"),
#endif
		DefaultValue(""), NotifyParentProperty(true), Localizable(false),
		Editor("DevExpress.Web.Design.CommonDesignerEditor, " + AssemblyInfo.SRAssemblyWebDesignFull, typeof(UITypeEditor))]
