...
namespace DevExpress.Web {
	public class StaticEditClientSideEvents : EditClientSideEventsBase {
		[
#if !SL
	DevExpressWebLocalizedDescription("StaticEditClientSideEventsClick"),
#endif
		...
		public StaticEditClientSideEvents(IPropertiesOwner owner)
			: base(owner) {
		}
