...
namespace DevExpress.Web {
	public class CallbackPanelClientSideEvents : CallbackClientSideEventsBase {
		[
#if !SL
	DevExpressWebLocalizedDescription("CallbackPanelClientSideEventsExpanded"),
#endif
		...
		[
#if !SL
	DevExpressWebLocalizedDescription("CallbackPanelClientSideEventsCollapsed"),
#endif
		DefaultValue(""), NotifyParentProperty(true), Localizable(false),
		Editor("DevExpress.Web.Design.CommonDesignerEditor, " + AssemblyInfo.SRAssemblyWebDesignFull, typeof(System.Drawing.Design.UITypeEditor))]
		...
		public CallbackPanelClientSideEvents()
			: base() {
		}
