...
namespace DevExpress.Web {
	public class ButtonImages : ImagesBase {
		public const string ImageName = "btnImage";
		public ButtonImages(ISkinOwner properties)
			: base(properties) {
		}
		[
#if !SL
	DevExpressWebLocalizedDescription("ButtonImagesImage"),
#endif
		...
		public CheckedButtonImageProperties Image {
			get { return (CheckedButtonImageProperties)GetImageBase(ImageName); }
		}
		protected override void PopulateImageInfoList(List<ImageInfo> list) {
			base.PopulateImageInfoList(list);
			list.Add(new ImageInfo(ImageName, ImageFlags.HasNoResourceImage, typeof(CheckedButtonImageProperties)));
		}
