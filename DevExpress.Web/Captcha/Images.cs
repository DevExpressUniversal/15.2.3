...
namespace DevExpress.Web.Captcha {
	public class CaptchaImages : ImagesBase {
		public const string RefreshButtonDefaultImageName = "caRefresh";
		public CaptchaImages(ASPxCaptcha owner)
			: base(owner) {
		}
		protected override Type GetResourceType() {
			return typeof(ASPxCaptcha);
		}
		...
		protected override void PopulateImageInfoList(List<ImageInfo> list) {
			...
			list.Add(new ImageInfo(RefreshButtonDefaultImageName, ImageFlags.Empty, 13, 13,
			   ASPxEditorsLocalizer.GetString(ASPxEditorsStringId.Captcha_RefreshText), 
			   RefreshButtonDefaultImageName));
		}
	}
}
