...
var ASPxClientTextEdit = ASPx.CreateClass(ASPxClientEdit, {
    ...
    Initialize: function(){
        ...
        if(ASPx.Browser.WebKitFamily)  //B156577, B190643
            ...
            var timeoutChecker = function() {
                ...
                if(ASPx.GetControlCollection().GetByName(this.name) !== this || inputElement == null) {
                    ...
                    if(!this.focused) {
                        ...
                        if(passwordNullTextInputElement.value != this.nullText && inputElement.value == "") { // T116444
	...
	HandleMaskKeyPress: function(evt) {
        ...
        if(printable || ASPx.MaskManager.keyDownHandled)            
            ASPx.Evt.PreventEvent(evt); // for browsers that cannot cancel key down
        this.maskPasteLock = false;
        this.UpdateMaskHintHtml();
	},
    ...
    OnKeyUp: function(evt) {
        ...
        if(this.NeedOnKeyEventEnd(evt, false)) {
            var proccessNextCommingPress = ASPx.Evt.GetKeyCode(evt) === ASPx.Key.Alt; // HACK alt-code processing
    ...
    AttachOnMouseClickIfNeeded: function () {
        ...
        if(this.GetValue() == "" || this.GetValue() == null) {//T113127
	...
	ChangeInputEnabledAttributes: function(element, method, enabled) {
	    ...
	    if(ieTabIndexFix) { //T147181, T245078
            window.setTimeout(function() {
...
var ASPxClientButtonEditBase = ASPx.CreateClass(ASPxClientTextBoxBase, {
    ...
    GetEmptyValueDisplayText: function() { // 4 clearbutton
...
var ASPxClientTextEditHelpText = ASPx.CreateClass(null, {
    ...
    setHelpTextZIndex: function (hide) { // TODO: move to ASPx.AnimationHelper
