...
var PopupUtils = {
    ...
    FindPopupElementById: function (id) {
        if(id == "")
            return null; // FIX Opera return element with id=""
    ...
    GetDocumentClientWidthForPopup: function () {
        return ASPx.Browser.WebKitTouchUI ? ASPx.GetDocumentWidth() : ASPx.GetDocumentClientWidth(); // B188579
    },
    GetDocumentClientHeightForPopup: function() {
        return ASPx.Browser.WebKitTouchUI ? ASPx.GetDocumentHeight() : ASPx.GetDocumentClientHeight(); // B234753
    },
    ...
    return {
        HideBodyScroll: function(windowId) {
            if(ASPx.Browser.WebKitTouchUI)
                return;
            if(isAnyWindowScrollLocked()) { //T125405
            ...
            } else if(ASPx.Browser.Firefox && ASPx.Browser.Version < 3) { //Q109177
        ...
        RestoreBodyScroll: function (windowId) {
            ...
            if(ASPx.Browser.WebKitFamily) { // B96454
                fixScrollsBug();
            }
        }
    }
