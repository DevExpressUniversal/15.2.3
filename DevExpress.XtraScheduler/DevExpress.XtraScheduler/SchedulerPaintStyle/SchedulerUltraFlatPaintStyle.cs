...
namespace DevExpress.XtraScheduler.Drawing {
	public class SchedulerUltraFlatPaintStyle : SchedulerPaintStyle {
		public override string Name { get { return "UltraFlat"; } }
		public override ViewPainterBase CreateDayViewPainter() {
			ViewPainterBase painter = new DayViewPainterUltraFlat();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateWorkWeekViewPainter() {
			ViewPainterBase painter = new WorkWeekViewPainterUltraFlat();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateWeekViewPainter() {
			ViewPainterBase painter = new WeekViewPainterUltraFlat();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateMonthViewPainter() {
			ViewPainterBase painter = new MonthViewPainterUltraFlat();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateTimelineViewPainter() {
			ViewPainterBase painter = new TimelineViewPainterUltraFlat();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateGanttViewPainter() {
			ViewPainterBase painter = new GanttViewPainterUltraFlat();
			painter.Initialize();
			return painter;
		}
