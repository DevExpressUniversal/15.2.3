...
namespace DevExpress.XtraScheduler.Drawing {
	public class SchedulerWindowsXPPaintStyle : SchedulerPaintStyle {
		public override string Name { get { return "WindowsXP"; } }
		public override bool IsAvailable { get { return DevExpress.Utils.WXPaint.Painter.ThemesEnabled; } }
		public override ViewPainterBase CreateDayViewPainter() {
			ViewPainterBase painter = new DayViewPainterWindowsXP();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateWorkWeekViewPainter() {
			ViewPainterBase painter = new WorkWeekViewPainterWindowsXP();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateWeekViewPainter() {
			ViewPainterBase painter = new WeekViewPainterWindowsXP();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateMonthViewPainter() {
			ViewPainterBase painter = new MonthViewPainterWindowsXP();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateTimelineViewPainter() {
			ViewPainterBase painter = new TimelineViewPainterWindowsXP();
			painter.Initialize();
			return painter;
		}
		public override ViewPainterBase CreateGanttViewPainter() {
			ViewPainterBase painter = new GanttViewPainterWindowsXP();
			painter.Initialize();
			return painter;
		}
