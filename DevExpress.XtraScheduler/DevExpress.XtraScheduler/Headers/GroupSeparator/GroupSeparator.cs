...
namespace DevExpress.XtraScheduler.Drawing {
	public abstract class GroupSeparator : SchedulerHeader {
		protected GroupSeparator(BaseHeaderAppearance appearance)
			: base(appearance) {
		...
		public override SchedulerHitTest HitTestType { get { return SchedulerHitTest.GroupSeparator; } }
		protected internal override bool RaiseCustomDrawEvent(GraphicsCache cache, ISupportCustomDraw customDrawProvider, DefaultDrawDelegate defaultDrawDelegate) {
			...
			try {
				...
				customDrawProvider.RaiseCustomDrawGroupSeparator(args);
				return args.Handled;
			} finally {
				this.Cache = null;
			}
