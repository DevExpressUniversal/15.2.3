...
namespace DevExpress.XtraScheduler.Drawing {
	public class UpperLeftCorner : SchedulerHeader {
		public UpperLeftCorner(BaseHeaderAppearance appearance)
			: base(appearance) {
		...
		public override SchedulerHitTest HitTestType { get { return SchedulerHitTest.UpperLeftCorner; } }
		protected internal override string CalcActualSkinElementName(bool hideSelection) {
			return SchedulerSkins.SkinUpperLeftCorner;
		}
		protected internal override bool RaiseCustomDrawEvent(GraphicsCache cache, ISupportCustomDraw customDrawProvider, DefaultDrawDelegate defaultDrawDelegate) {
			...
			try {
				...
				customDrawProvider.RaiseCustomDrawWeekViewTopLeftCorner(args);
				return args.Handled;
			} finally {
				this.Cache = null;
			}
		...
		protected override SchedulerHeader CreateCloneInstance() {
			return new UpperLeftCorner(Appearance);
		}
	}
}
