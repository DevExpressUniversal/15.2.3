...
namespace DevExpress.XtraScheduler.Drawing {
	public class DayHeader : SchedulerHeader {
		public DayHeader(BaseHeaderAppearance appearance)
			: base(appearance) {
		}
		public DayHeader()
			: base() {
...
#if !SL
	[DevExpressXtraSchedulerLocalizedDescription("DayHeaderHitTestType")]
#endif
		public override SchedulerHitTest HitTestType { get { return SchedulerHitTest.DayHeader; } }
		...
		protected internal override string GetActualCaption() {
