...
namespace DevExpress.XtraScheduler.Drawing {
	public class DayOfWeekHeader : SchedulerHeader, IDayOfWeekHeaderCaptionServiceObject {
		#region Fields
		DayOfWeek dayOfWeek;
		#endregion
		public DayOfWeekHeader(BaseHeaderAppearance appearance, DayOfWeek dayOfWeek)
			: base(appearance) {
			this.dayOfWeek = dayOfWeek;
		}
		#region Properties
#if !SL
	[DevExpressXtraSchedulerLocalizedDescription("DayOfWeekHeaderDayOfWeek")]
#endif
		public DayOfWeek DayOfWeek { get { return dayOfWeek; } }
#if !SL
	[DevExpressXtraSchedulerLocalizedDescription("DayOfWeekHeaderHitTestType")]
#endif
		public override SchedulerHitTest HitTestType { get { return SchedulerHitTest.DayOfWeekHeader; } }
		...
		protected internal override bool RaiseCustomDrawEvent(GraphicsCache cache, ISupportCustomDraw customDrawProvider, DefaultDrawDelegate defaultDrawDelegate) {
			...
			try {
				...
				customDrawProvider.RaiseCustomDrawDayOfWeekHeader(args);
				return args.Handled;
			} finally {
				this.Cache = null;
			}
