...
namespace DevExpress.XtraScheduler.Drawing {
	public class MonthViewGroupByNoneHeadersLayoutCalculator : WeekViewGroupByNoneHeadersLayoutCalculator {
		public MonthViewGroupByNoneHeadersLayoutCalculator(GraphicsCache cache, SchedulerViewInfoBase viewInfo, SchedulerHeaderPainter painter)
			: base(cache, viewInfo, painter) {
		}
		public override void CalcLayout(Rectangle bounds) {
			CalculateDateHeadersBounds(bounds, false);
