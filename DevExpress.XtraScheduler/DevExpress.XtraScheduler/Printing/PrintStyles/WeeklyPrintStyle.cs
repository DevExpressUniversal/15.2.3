...
namespace DevExpress.XtraScheduler.Printing {
	public class WeeklyPrintStyle : LayoutPrintStyle {
		const string topToBottomOnePageBitmapName = "weekonepage";
		const string topToBottomTwoPageBitmapName = "weektwopage";
		const string leftToRightOnePageBitmapName = "weeklefttorightonepage";
		const string leftToRightTwoPageBitmapName = "weeklefttorighttwopage";
		TimeSlotCollection timeSlots;
		protected internal WeeklyPrintStyle(bool registerProperties, bool baseStyle)
			: base(registerProperties, baseStyle) {
		}
		public WeeklyPrintStyle(bool baseStyle)
			: this(true, baseStyle) {
		}
		public WeeklyPrintStyle()
			: this(true) {
		}
		#region TimeSlots
		[
...
DesignerSerializationVisibility(DesignerSerializationVisibility.Content), XtraSerializableProperty(XtraSerializationVisibility.Collection, true, false, true)]
		...
		#endregion
		public override SchedulerPrintStyleKind Kind { get { return SchedulerPrintStyleKind.Weekly; } }
		#region properties and methods for UserInterfaceObject
		protected internal override string DefaultDisplayName { get { return SchedulerLocalizer.GetString(SchedulerStringId.Caption_WeeklyPrintStyle); } }
		protected override string GetStyleBitmapName() {
			if (ArrangeDays == ArrangeDaysKind.TopToBottom)
				return Layout == PageLayout.OnePage
					? topToBottomOnePageBitmapName : topToBottomTwoPageBitmapName;
			else
				return Layout == PageLayout.OnePage
					? leftToRightOnePageBitmapName : leftToRightTwoPageBitmapName;
		}
		#endregion
		#region ArragneDays
		static readonly object arrangeDaysProperty = new object();
		[DefaultValue(ArrangeDaysKind.TopToBottom)]
		[XtraSerializableProperty(XtraSerializationFlags.DefaultValue)]
		public ArrangeDaysKind ArrangeDays {
			get { return (ArrangeDaysKind)GetPropertyValue(arrangeDaysProperty); }
			set { SetPropertyValue(arrangeDaysProperty, value); }
		}
		#endregion
		#region PrintWeekends
		static readonly object printWeekendsProperty = new object();
		[DefaultValue(true)]
		[XtraSerializableProperty(XtraSerializationFlags.DefaultValue)]
		public bool PrintWeekends {
			get { return (bool)GetPropertyValue(printWeekendsProperty); }
			set { SetPropertyValue(printWeekendsProperty, value); }
		}
		#endregion
		...
		public bool PrintAllAppointments {
			...
			set { SetPropertyValue(printAllAppointmentsProperty, value); }
		}
		#endregion
		...
		protected internal override void RegisterProperties() {
			...
			RegisterProperty(arrangeDaysProperty, ArrangeDaysKind.TopToBottom);
			RegisterProperty(printWeekendsProperty, true);
			RegisterProperty(printAllAppointmentsProperty, true);
			RegisterProperty(useActiveViewTimeScaleProperty, false);
			RegisterProperty(printTimeProperty, TimeOfDayInterval.Day.Clone());
		}
