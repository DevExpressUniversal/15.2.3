...
namespace DevExpress.XtraScheduler.Printing {
	public class DayViewColumnFlatPrintPainter : DayViewColumnFlatPainter {
		...
		public override void DrawAllDayAreaCell(GraphicsCache cache, DayViewColumn column, AllDayAreaCell cell) {
			base.DrawAllDayAreaCell(cache, column, cell);
			cache.FillRectangle(cache.GetSolidBrush(Color.Black), RectUtils.GetTopSideRect(cell.Bounds, 1));
		}
	}
}
