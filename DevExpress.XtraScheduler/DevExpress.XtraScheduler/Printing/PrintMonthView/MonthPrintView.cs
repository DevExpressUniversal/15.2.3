...
namespace DevExpress.XtraScheduler.Printing {
	public class MonthPrintView : MonthView {
		ViewPart part;
		GraphicsInfo gInfo;
		PrintColorConverter colorConverter;
		Font headingsFont;
		Font appointmentFont;
		bool singleMonthOnly;
		DateTime month;
		public MonthPrintView(SchedulerControl control, ViewPart part, GraphicsInfo gInfo, SchedulerPrintStyle printStyle)
			: base(control) {
			if (gInfo == null)
		...
		protected internal virtual bool SingleMonthOnly { get { return singleMonthOnly; } set { singleMonthOnly = value; } }
		protected internal virtual DateTime Month { get { return month; } set { month = value; } }
		protected internal override ViewPainterBase CreatePainter(SchedulerPaintStyle paintStyle) {
			MonthPrintViewPainter painter = new MonthPrintViewPainter(colorConverter);
			painter.Initialize();
			return painter;
		}
		protected internal override SchedulerViewInfoBase CreateViewInfoCore() {
			return new MonthPrintViewInfo(this, part, gInfo);
		}
		protected internal override BaseViewAppearance CreateAppearance() {
			MonthViewAppearance appearance = (MonthViewAppearance)base.CreateAppearance();
