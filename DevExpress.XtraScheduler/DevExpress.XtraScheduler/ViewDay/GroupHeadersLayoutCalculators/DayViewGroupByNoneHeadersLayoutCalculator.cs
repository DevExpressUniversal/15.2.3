...
namespace DevExpress.XtraScheduler.Drawing {
	public class DayViewGroupByNoneHeadersLayoutCalculator : DayViewGroupHeadersLayoutCalculator {
		public DayViewGroupByNoneHeadersLayoutCalculator(GraphicsCache cache, SchedulerViewInfoBase viewInfo, SchedulerHeaderPainter painter)
		...
		protected internal override SchedulerHeaderCollection CreateTopLevelHeaders() {
			...
			ApplyHeaderSeparators(dateHeaders);
