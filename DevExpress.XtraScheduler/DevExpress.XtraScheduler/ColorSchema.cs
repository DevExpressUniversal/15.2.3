...
namespace DevExpress.XtraScheduler {
	...
	public class SchedulerColorSchema : SchedulerColorSchemaBase {
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaBaseColor"),
#endif
 RefreshProperties(RefreshProperties.All), NotifyParentProperty(true)]
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaCell"),
#endif
 AutoFormatEnable, NotifyParentProperty(true), XtraSerializableProperty]
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaCellBorder"),
#endif
 AutoFormatEnable, NotifyParentProperty(true), XtraSerializableProperty]
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaCellBorderDark"),
#endif
 AutoFormatEnable, NotifyParentProperty(true), XtraSerializableProperty]
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaCellLight"),
#endif
 AutoFormatEnable, NotifyParentProperty(true), XtraSerializableProperty]
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaCellLightBorder"),
#endif
 AutoFormatEnable, NotifyParentProperty(true), XtraSerializableProperty]
		...
		[
#if !SL
	DevExpressXtraSchedulerLocalizedDescription("SchedulerColorSchemaCellLightBorderDark"),
#endif
 AutoFormatEnable, NotifyParentProperty(true), XtraSerializableProperty]
