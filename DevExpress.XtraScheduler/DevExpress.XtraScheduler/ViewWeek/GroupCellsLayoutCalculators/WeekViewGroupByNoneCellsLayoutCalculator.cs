...
namespace DevExpress.XtraScheduler.Drawing {
	public class WeekViewGroupByNoneCellsLayoutCalculator : WeekViewGroupCellsLayoutCalculator {
		ResourceBaseCollection visibleResources;
		public WeekViewGroupByNoneCellsLayoutCalculator(GraphicsCache cache, SchedulerViewInfoBase viewInfo, ViewInfoPainterBase painter)
		...
		protected override SchedulerHeaderCollection GetHeadersByWeekNumber(int weekNumber) {
			return ViewInfo.ResourceHeaders;
		}
	}
}
