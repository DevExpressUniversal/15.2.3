...
namespace DevExpress.XtraScheduler.Drawing {
	public class HourScaleTimeCaptionItemsCalculator : TimeRulerTimeCaptionItemsBaseCalculator {
		#region Fields
		bool alwaysShowTimeDesignator;
		bool useTimeDesignator = true;
		#endregion
		public HourScaleTimeCaptionItemsCalculator(TimeRulerViewInfo ruler, DateTime[] actualTimes)
		...
		protected internal override ViewInfoItem CreateItem(Rectangle rowBounds, int rowIndex) {
			...
			this.useTimeDesignator = alwaysShowTimeDesignator || (rowIndex + 2) == RowsCount;
			return item;
		}
	}
}
