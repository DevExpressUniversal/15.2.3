...
namespace DevExpress.XtraScheduler.Drawing {
	public class TimeRulerWindowsXPPainter : TimeRulerPainter {
		...
		protected override void DrawBackground(GraphicsCache cache, TimeRulerViewInfo ruler) {
			...
			Brush br = cache.GetGradientBrush(bounds, SystemColors.ControlLightLight, SystemColors.Control, LinearGradientMode.Horizontal);
