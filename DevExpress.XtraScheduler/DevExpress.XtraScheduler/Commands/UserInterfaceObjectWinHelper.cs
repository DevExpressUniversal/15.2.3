...
namespace DevExpress.XtraScheduler {
	public static class UserInterfaceObjectWinHelper {
		public static Bitmap CreateBitmap(UserInterfaceObjectWin uiObject, int width, int height) {
			Rectangle r = new Rectangle(0, 0, width, height);
			Bitmap bmp = new Bitmap(r.Width, r.Height);
			using (Graphics gr = Graphics.FromImage(bmp)) {
				if (uiObject.Brush != null)
					gr.FillRectangle(uiObject.Brush, r);
