...
namespace DevExpress.XtraScheduler.Commands.Internal {
	public class NavigateScrollMoreButtonCommand : SchedulerMenuItemSimpleCommand {
		ScrollContainerController scrollController;
		bool goUp;
		public NavigateScrollMoreButtonCommand(SchedulerControl control, ScrollContainerController scrollController, bool goUp)
			: base(control) {
			Guard.ArgumentNotNull(scrollController, "scrollController");
			this.scrollController = scrollController;
			this.goUp = goUp;
		}
		internal ScrollContainerController ScrollController { get { return scrollController; } }
		internal bool GoUp { get { return goUp; } }
