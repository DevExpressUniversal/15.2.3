...
namespace DevExpress.XtraScheduler.Services.Internal {
	public class FileOperationService : IFileOperationService {
		...
		public Stream OpenRead(string fileName, string filter, int filterIndex) {
			...
			if (dialog.ShowDialog(scheduler) != DialogResult.OK)
				return null;
			return dialog.OpenFile();
		}
		public Stream OpenWrite(string fileName, string filter, int filterIndex) {
