...
namespace DevExpress.XtraScheduler.Services.Implementation {
	public class WinSchedulerCommandFactoryService : SchedulerCommandFactoryService {
		public WinSchedulerCommandFactoryService(DevExpress.XtraScheduler.Commands.ISchedulerCommandTarget target)
			: base(target) {			
		}
		protected internal override void PopulateConstructorTable(SchedulerCommandConstructorTable table) {
			...
			AddCommandConstructor(table, SchedulerCommandId.SplitAppointment, typeof(SplitAppointmentOperationCommand));
