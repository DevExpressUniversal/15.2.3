...
namespace $rootnamespace$ {
    public partial class $safeitemname$ : DevExpress.XtraEditors.XtraForm, IDXManagerPopupMenu {
        #region Fields
        ...
        public $safeitemname$(SchedulerControl control, Appointment apt)
            : this(control, apt, false) {
        }
        public $safeitemname$(SchedulerControl control, Appointment apt, bool openRecurrenceForm) {
