...
namespace DevExpress.XtraScheduler.Services.Implementation {
	#region SchedulerKeyboardHandlerService
	public class SchedulerKeyboardHandlerService : KeyboardHandlerService {
		readonly InnerSchedulerControl control;
		public SchedulerKeyboardHandlerService(InnerSchedulerControl control)
