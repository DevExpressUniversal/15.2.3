...
namespace DevExpress.XtraScheduler.UI {
	#region SchedulerRibbonCommandBarComponent (abstract class)
	[Designer("DevExpress.XtraScheduler.Design.SchedulerRibbonCommandBarComponentDesigner," + AssemblyInfo.SRAssemblySchedulerDesign)]
	public abstract class SchedulerRibbonCommandBarComponent : RibbonCommandBarComponentBase {
		#region Fields
		SchedulerControl schedulerControl;
		#endregion
		protected SchedulerRibbonCommandBarComponent()
			: base() {
		}
		protected SchedulerRibbonCommandBarComponent(IContainer container)
			: base(container) {
		}
		#region Properties
		[DefaultValue(null)]
