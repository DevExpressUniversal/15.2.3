...
namespace DevExpress.Web.Mvc {
	...
	[ToolboxItem(false)]
	public class MVCxCallbackPanel : ASPxCallbackPanel {
		public MVCxCallbackPanel()
			: base() {
		}
		public object CallbackRouteValues { get; set; }
		public new ImagesBase Images {
		...
		protected override string GetClientObjectClassName() {
			return "MVCxClientCallbackPanel";
		}
		protected override void RegisterIncludeScripts() {
			base.RegisterIncludeScripts();
			RegisterIncludeScript(typeof(MVCxCallbackPanel), Utils.UtilsScriptResourceName);
			RegisterIncludeScript(typeof(MVCxCallbackPanel), Utils.CallbackPanelScriptResourceName);
		}
