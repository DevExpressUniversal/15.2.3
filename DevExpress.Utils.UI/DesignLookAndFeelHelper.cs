...
namespace DevExpress.LookAndFeel.DesignService {
	public static class DesignLookAndFeelHelper {
		public static void SetParentLookAndFeel(ISupportLookAndFeel control, IServiceProvider provider) {
			LookAndFeelProviderHelper.SetParentLookAndFeel(control, provider);
		}
		public static UserLookAndFeel GetLookAndFeel(IServiceProvider provider) {
			return LookAndFeelProviderHelper.GetLookAndFeel(provider);
		}
		public static void SetLookAndFeel(DevExpress.XtraBars.BarManager barManager, IServiceProvider provider) {
			if(barManager.Controller == null)
				barManager.Controller = new DevExpress.XtraBars.BarAndDockingController();
			barManager.Controller.LookAndFeel.ParentLookAndFeel = GetLookAndFeel(provider);
		}
	}
}
