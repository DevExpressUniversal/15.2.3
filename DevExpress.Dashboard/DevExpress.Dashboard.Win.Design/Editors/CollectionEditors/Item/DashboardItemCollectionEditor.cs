...
namespace DevExpress.DashboardWin.Design {
	public class DashboardItemCollectionEditor : Utils.UI.CollectionEditor {
		public DashboardItemCollectionEditor(Type type)
			: base(type) {
		}
		...
		protected override Utils.UI.CollectionEditorFormBase CreateCollectionForm(IServiceProvider serviceProvider) {
			DashboardItemCollectionEditorForm form = new DashboardItemCollectionEditorForm(serviceProvider, this);
