...
namespace DevExpress.DashboardWin.Design {
	public class DataSourceCollectionEditor : Utils.UI.CollectionEditor {
		public DataSourceCollectionEditor(Type type)
			: base(type) {
		}
		protected override Utils.UI.CollectionEditorFormBase CreateCollectionForm(IServiceProvider serviceProvider) {
			DataSourceCollectionEditorForm form = new DataSourceCollectionEditorForm(serviceProvider, this);
