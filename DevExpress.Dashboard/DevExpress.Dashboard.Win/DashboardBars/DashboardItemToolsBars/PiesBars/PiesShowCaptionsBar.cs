...
namespace DevExpress.DashboardWin.Bars {
	public class PieShowCaptionsBarItem : CommandBarCheckItem {
		protected override DashboardCommandId CommandId { get { return DashboardCommandId.PieShowCaptions; } }
	}
}
namespace DevExpress.DashboardWin.Native {
	public class PieShowCaptionsBarItemBuilder : CommandBasedBarItemBuilder {
		public override void PopulateItems(List<BarItem> items, BarCreationContextBase creationContext) {
			items.Add(new PieShowCaptionsBarItem());
		}
	}
	public class PieShowCaptionsBarCreator : DashboardItemDesignBarCreator {
		...
		public override CommandBasedBarItemBuilder CreateBarItemBuilder() {
			return new PieShowCaptionsBarItemBuilder();
		}
