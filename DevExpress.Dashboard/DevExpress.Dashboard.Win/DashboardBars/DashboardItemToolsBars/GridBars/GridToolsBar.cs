...
namespace DevExpress.DashboardWin.Bars {
	public class GridToolsBar : DataDashboardItemToolsBar {
		public override string DefaultText { get { return DashboardWinLocalizer.GetString(DashboardWinStringId.RibbonPageCategoryGridToolsName); } }
		...
		protected override bool CheckBarVisibility(DashboardItemViewer viewer) {
			return viewer is GridDashboardItemViewer;
		}
	}
	public class GridToolsRibbonPageCategory : DashboardRibbonPageCategory {
		public override string DefaultText { get { return DashboardWinLocalizer.GetString(DashboardWinStringId.RibbonPageCategoryGridToolsName); } }
		...
		protected internal override bool CheckCurrentPage(string dashboardItemType) {
			return dashboardItemType == DashboardItemType.Grid;
		}
