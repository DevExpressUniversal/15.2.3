...
namespace DevExpress.DashboardWin.Bars {
	public class ImageToolsBar : DashboardCommandBar {
		public override string DefaultText { get { return DashboardWinLocalizer.GetString(DashboardWinStringId.RibbonPageCategoryImageToolsName); } }
		public ImageToolsBar() {
			Visible = false;
		}
		protected override bool CheckBarVisibility(DashboardItemViewer viewer) {
			return viewer is ImageDashboardItemViewer;
		}					
	}
	public class ImageToolsRibbonPageCategory : DashboardRibbonPageCategory {
		public override string DefaultText { get { return DashboardWinLocalizer.GetString(DashboardWinStringId.RibbonPageCategoryImageToolsName); } }
		...
		protected internal override bool CheckCurrentPage(string dashboardItemType) {
			return dashboardItemType == DashboardItemType.Image;
		}
