...
namespace DevExpress.DashboardWin.Bars {
	public class FilterElementToolsRibbonPageCategory : DashboardRibbonPageCategory {
		public override string DefaultText { get { return DashboardWinLocalizer.GetString(DashboardWinStringId.RibbonPageCategoryFilterElementToolsName); } }
		...
		protected internal override bool CheckCurrentPage(string dashboardItemType) {
			return dashboardItemType == DashboardItemType.Combobox || dashboardItemType == DashboardItemType.ListBox || dashboardItemType == DashboardItemType.TreeView;
		}
		protected override RibbonPageCategory CreateRibbonPageCategory() {
			return new FilterElementToolsRibbonPageCategory();
		}
	}
	public class FilterElementToolsBar : DataDashboardItemToolsBar {
		public override string DefaultText { get { return DashboardWinLocalizer.GetString(DashboardWinStringId.RibbonPageCategoryFilterElementToolsName); } }
		...
		protected override bool CheckBarVisibility(DashboardItemViewer viewer) {
			return viewer is FilterElementDashboardItemViewer;
		}
	}
}
