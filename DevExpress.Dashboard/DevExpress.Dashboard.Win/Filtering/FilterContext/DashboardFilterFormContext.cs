...
namespace DevExpress.DashboardWin.Native {
	public abstract class DashboardFilterFormContext : IFilteredComponent {
		public abstract CriteriaOperator FilterCriteria { get; set; }
		protected DashboardFilterFormContext() {
		}
		public abstract IBoundPropertyCollection GetFilterPropertyCollection();
		public abstract IHistoryItem CreateIHistoryItem(string newFilterString, DashboardParameterCollection parameters, ParameterChangesCollection parametersChanged);
