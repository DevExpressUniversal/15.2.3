...
namespace DevExpress.DashboardWin.Native {
	public abstract class DataItemMenuItemCommand {
		...
		protected DataItemMenuItemCommand(DashboardDesigner designer, DataDashboardItem dashboardItem, DataItem dataItem) {
