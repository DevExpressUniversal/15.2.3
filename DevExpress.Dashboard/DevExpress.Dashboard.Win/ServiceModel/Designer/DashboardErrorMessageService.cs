...
namespace DevExpress.DashboardWin.ServiceModel {
	public interface IDashboardErrorMessageService {
		DialogResult ShowMessage(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon);
	}
	public class DashboardErrorMessageService : IDashboardErrorMessageService {
		readonly DashboardDesigner designer;
		public DashboardErrorMessageService(DashboardDesigner designer) {
		...
		public DialogResult ShowMessage(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon) {
			return XtraMessageBox.Show(designer.LookAndFeel, designer.ParentForm, text, caption, buttons, icon);
		}
	}
}
