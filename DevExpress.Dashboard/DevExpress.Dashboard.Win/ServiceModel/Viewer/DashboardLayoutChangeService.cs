...
namespace DevExpress.DashboardWin.ServiceModel {
	public interface IDashboardLayoutChangeService {
		event EventHandler LayoutChanged;
	}
	public class DashboardLayoutChangeService : IDashboardLayoutChangeService, IDisposable {
		readonly DashboardLayoutControl layoutControl;
		public event EventHandler LayoutChanged;
		public DashboardLayoutChangeService(DashboardLayoutControl layoutControl) {
		...
		void SubscribeLayoutControlEvents() {
			layoutControl.DashboardLayoutChanged += OnLayoutChanged;
		}
