...
namespace DevExpress.DashboardWin.Native {
	[DXToolboxItem(false)]
	public partial class FormatRuleControlColorRangeBar : FormatRuleControlRangeSet, IFormatRuleControlColorRangeBarView {
		...
		public FormatRuleControlColorRangeBar() {
			InitializeComponent();
		...
		protected override void Initialize(IFormatRuleControlViewInitializationContext initializationContext) {
			...
			barOptionsPanel.AddLayoutItems(((IFormatRuleViewColorRangeBarContext)initializationContext).BarOptions);
		}
