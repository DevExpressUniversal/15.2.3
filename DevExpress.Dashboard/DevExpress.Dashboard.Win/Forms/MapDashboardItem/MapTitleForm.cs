...
namespace DevExpress.DashboardWin.Native {
	public partial class MapTitleForm : DashboardForm {
		readonly DashboardDesigner designer;
		readonly MapDashboardItem dashboardItem;
		readonly string currentShapeTitleAttributeName;
		MapShapeTitleAttributeHistoryItem historyItem;
		public MapTitleForm() {
			InitializeComponent();
		}
		public MapTitleForm(DashboardDesigner designer, MapDashboardItem dashboardItem)
			: this() {
		...
		void cbTitleAttribute_SelectedValueChanged(object sender, EventArgs e) {
			...
			historyItem = new MapShapeTitleAttributeHistoryItem(dashboardItem, selectedAttribute, currentShapeTitleAttributeName);
