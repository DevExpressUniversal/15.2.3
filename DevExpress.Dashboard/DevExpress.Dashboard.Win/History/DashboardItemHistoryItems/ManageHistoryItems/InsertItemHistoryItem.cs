...
namespace DevExpress.DashboardWin.Native {
	public class InsertItemHistoryItem : DashboardItemLayoutHistoryItem {
		readonly DashboardItem dashboardItem;
		public override string Caption { get { return String.Format(DashboardWinLocalizer.GetString(DashboardWinStringId.HistoryItemInsertItem), dashboardItem.Name); } }
		...
		public InsertItemHistoryItem(DashboardItem dashboardItem) {
