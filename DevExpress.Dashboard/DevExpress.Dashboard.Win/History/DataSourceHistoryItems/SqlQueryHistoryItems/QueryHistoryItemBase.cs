...
namespace DevExpress.DashboardWin.Native {
	public abstract class EditQueryHistoryItemBase : EditDataSourceHistoryItemBase {
		DashboardParametersHistoryItem dashboardParametersHistoryItem;
		public EditQueryHistoryItemBase(IDashboardDataSource dataSource, XElement previousState, 
			DashboardParameterCollection parameters, ParameterChangesCollection parametersChanged)
