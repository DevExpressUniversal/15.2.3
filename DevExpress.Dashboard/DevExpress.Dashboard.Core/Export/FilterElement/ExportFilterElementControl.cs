...
namespace DevExpress.DashboardExport {
	public class ExportFilterElementControl : IFilterElementControl{
		...
		int IFilterElementControl.EditorHeight { get { return 0; } }
		...
		void IFilterElementControl.Configure(FilterElementDashboardItemViewModel viewModel) {
			...
			lineSeparator = comboBoxModel != null ? ", " : Environment.NewLine;
		}
		public string BuildText(IList<string> lines) {
