...
namespace DevExpress.DashboardCommon {
	[
	DesignerSerializer(TypeNames.ColorDefinitionCodeDomSerializer, TypeNames.CodeDomSerializer)
	]
	public class ColorDefinition {
		readonly Color? color;
		readonly int? paletteIndex;
		public Color? Color { get { return color; } }
		public int? PaletteIndex { get { return paletteIndex; } }
		public ColorDefinition(Color color) {
			this.color = color;
		}
		public ColorDefinition(int paletteIndex) {
