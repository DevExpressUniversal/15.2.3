...
namespace DevExpress.DashboardCommon.Viewer {
	public class PieViewerArgumentsAndSeriesDataController : PieViewerDataControllerBase {
		public PieViewerArgumentsAndSeriesDataController(PieDashboardItemViewModel viewModel, MultiDimensionalData data, ChartSeriesConfiguratorCache configuratorCache, IDictionary<string, IList> drillDownState, bool isDesignMode) :
