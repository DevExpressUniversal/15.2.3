...
namespace DevExpress.DashboardCommon.Native {
	public class NameController<T> : ComponentNameControllerBase<T> where T : class, INameContainer {
		public NameController(NotifyingCollection<T> collection, IObjectNameGenerator context)
