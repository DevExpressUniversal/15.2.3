...
namespace DevExpress.Xpf.DemoBase {
	class ThemeSelectingLoadingControl : Control {
		...
		static ThemeSelectingLoadingControl() {
			Type ownerType = typeof(ThemeSelectingLoadingControl);
		...
		#endregion
		public ThemeSelectingLoadingControl() {
			this.SetDefaultStyleKey(typeof(ThemeSelectingLoadingControl));
