...
namespace DevExpress.Xpf.SpellChecker.Forms {
	...
	public abstract class SpellCheckerControlBase : Control, ILogicalOwner {
		SpellChecker spellChecker;
		protected SpellCheckerControlBase() { }
		protected SpellCheckerControlBase(SpellChecker spellChecker) {
			SpellChecker = spellChecker;
		}
		...
		protected virtual void OnSpellCheckerChanged() { }
#if SL
		...
		#region ILogicalOwner Members
		void ILogicalOwner.AddChild(object child) {
			if (LogicalTreeHelper.GetParent((DependencyObject)child) == null)
