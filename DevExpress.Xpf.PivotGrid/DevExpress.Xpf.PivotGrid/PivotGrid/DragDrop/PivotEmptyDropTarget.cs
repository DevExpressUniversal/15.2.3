...
namespace DevExpress.Xpf.PivotGrid.Internal {
	public class PivotEmptyDropTarget : PivotGridDropTargetBase {
		Control fieldListControl;
		public PivotEmptyDropTarget(Control excelFieldListControl)
			: base(GetAnyPanel(excelFieldListControl)) {
			this.fieldListControl = excelFieldListControl;
		}
		protected override DependencyObject PivotChild { get { return fieldListControl; } }
