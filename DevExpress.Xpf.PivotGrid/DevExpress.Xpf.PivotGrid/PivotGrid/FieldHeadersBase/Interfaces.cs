...
namespace DevExpress.Xpf.PivotGrid.Internal {
	public interface IFieldHeaders {
		bool IsLoaded { get; }
		FieldListArea Area { get; }
		PivotGridWpfData Data { get; }
		bool GetActualShowAll();
		void SetItems(PivotFieldsReadOnlyObservableCollection fields);
	}
	public interface IHeadersFieldsSource {
		void OnLoaded();
		void OnUnloaded();
		void Dispose();
		void EnsureItems();
