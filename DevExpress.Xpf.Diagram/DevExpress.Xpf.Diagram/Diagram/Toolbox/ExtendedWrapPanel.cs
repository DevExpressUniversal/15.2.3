...
namespace DevExpress.Xpf.Diagram {
	public class ExtendedWrapPanel : WrapPanel {
		public static readonly DependencyProperty ActualItemWidthProperty =
			DependencyProperty.Register("ActualItemWidth", typeof(double), typeof(ExtendedWrapPanel), new PropertyMetadata(0.0));
		...
		protected override Size MeasureOverride(Size constraint) {
			if (Children != null && Children.Count > 0) {
				double width = this.Children[0].DesiredSize.Width;
				if (width > 0)
					SetValue(ActualItemWidthProperty, width);
			}
