...
namespace DevExpress.ExpressApp.Reports.Win {
	public class WizPageXafWelcome : DevExpress.Utils.ExteriorWizardPage {
		INewXafReportWizardParameters wizardParameters;
		...
		public WizPageXafWelcome(XRWizardRunnerBase runner, XafApplication application, INewXafReportWizardParameters wizardParameters) {
			this.runner = runner;
			this.standardWizard = runner.Wizard;
			this.Name = "WizPageWelcome";
			this.wizardParameters = wizardParameters;
			paramsView = application.CreateDetailView(((XafReport)(standardWizard.DesignerHost.RootComponent)).ObjectSpace, wizardParameters);
