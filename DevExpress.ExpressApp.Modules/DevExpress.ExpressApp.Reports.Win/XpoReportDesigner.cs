...
namespace DevExpress.ExpressApp.Reports.Win {
	public class XpoReportDesigner : ReportDesigner {
		public override void Initialize(IComponent component) {
			base.Initialize(component);
			IDesignerHost designerHost = (IDesignerHost)GetService(typeof(IDesignerHost));
			if(designerHost == null) {
				throw new Exception(string.Format("Could not obtain {0} interface.", typeof(IDesignerHost).Name));
			}
			...
			designerHost.AddService(typeof(ITypeDescriptorFilterService), new XpoReportDesignerFilterService(typeDescriptorFilterService));
		}
		protected override void PreFilterProperties(IDictionary properties) {
			...
			properties.Remove("XmlDataPath");
			properties.Remove("DataSourceClassInfo");
		}
	}
}
