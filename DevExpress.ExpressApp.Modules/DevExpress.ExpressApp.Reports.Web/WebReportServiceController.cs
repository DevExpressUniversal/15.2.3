...
namespace DevExpress.ExpressApp.Reports.Web {
	public class WebReportServiceController : ReportServiceController {
		protected override void ShowPreviewCore(IReportData reportData, CriteriaOperator criteria) {
			...
			ReportViewerDialogController reportViewerDialogController = Application.CreateController<ReportViewerDialogController>();
			reportViewerDialogController.Setup(reportData, criteria);
			showViewParameters.Context = TemplateContext.PopupWindow;
			showViewParameters.CreatedView = reportViewerDialogController.CurrentView;
