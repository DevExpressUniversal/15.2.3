...
namespace DevExpress.ExpressApp.EasyTest.WinAdapter.TestControls.DevExpressControls {
	public class SchedulerTestHelper {
		...
		public void DragDrop(string source, string sourceId, string dropTo, string dropToValue) {
			testControl.GetInterface<IControlDragDrop>().DragDrop(source, sourceId, dropTo, dropToValue);
		}
		public SchedulerTestHelper(SchedulerControl scheduler) {
			testControl = TestControlFactoryWin.Instance.CreateControl(scheduler);
		}
	}
}
