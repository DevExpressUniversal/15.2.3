...
namespace DevExpress.ExpressApp.EasyTest.WebAdapter.TestControls {
	public class JSNavigationTabsTestControl : JSTabsTestControl, IGridBase {
		public JSNavigationTabsTestControl(IControlDescription controlDescription) : base(controlDescription) { }
		protected override string ScriptText {
			get {
				return ReadScriptFormResource("DevExpress.ExpressApp.EasyTest.WebAdapter.TestControls.JSNavigationTabsTestControl.js");
			}
		}
		protected override string JSControlName {
			get { return "NavigationTabsTestControl_JS"; }
		}
		protected override string RegisterControlType {
			get { return "DevExpress.ExpressApp.Web.Templates.ActionContainers.NavigationTabsActionContainer"; }
		}
