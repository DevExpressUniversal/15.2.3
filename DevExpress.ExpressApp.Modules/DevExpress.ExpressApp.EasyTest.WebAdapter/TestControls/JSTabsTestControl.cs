...
namespace DevExpress.ExpressApp.EasyTest.WebAdapter.TestControls {
	public class JSTabsTestControl : JSStandartTestControl, IControlAct, IControlActionItems {
		public JSTabsTestControl(IControlDescription controlDescription) : base(controlDescription) { }
		public void Act(string value) {
			ExecuteFunction("Act", new object[] { value });
		}
		protected override string ScriptText {
			get {
				return ReadScriptFormResource("DevExpress.ExpressApp.EasyTest.WebAdapter.TestControls.JSTabsTestControl.js");
			}
		}
		protected override string JSControlName {
			get { return "TabsTestControl_JS"; }
		}
		protected override string RegisterControlType {
			get { return "DevExpress.Web.ASPxPageControl"; }
		}
