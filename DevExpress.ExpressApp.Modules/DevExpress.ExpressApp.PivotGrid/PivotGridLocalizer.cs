...
namespace DevExpress.ExpressApp.PivotGrid {
	[System.ComponentModel.DisplayName("Pivot Grid List Editor")]
	public class PivotGridListEditorLocalizer : XtraPivotGrid.Localization.PivotGridResLocalizer, IXafResourceLocalizer {
		...
		public void Setup(IModelApplication applicationNode) {
			...
			SessionLocalizerProvider<PivotGridListEditorLocalizer, DevExpress.XtraPivotGrid.Localization.PivotGridStringId>.XafActiveLocalizer = this;
		}
		public void Reset() {
			logic.Reset();
		}
