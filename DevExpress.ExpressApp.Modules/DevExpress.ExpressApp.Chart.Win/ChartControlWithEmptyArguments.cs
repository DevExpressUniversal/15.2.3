...
namespace DevExpress.ExpressApp.Chart.Win {
	class ChartControlWithEmptyArguments : ChartControl {
		public ChartControlWithEmptyArguments() {
...
#if DebugTest
	public static class DebugTest_ChartControlWithEmptyArguments {
		public static ChartControl Create() {
			return new ChartControlWithEmptyArguments();
		}
	}
#endif
}
