...
namespace DevExpress.ExpressApp.Chart.Win {
	...
	public class ChartPropertyEditor : WinPropertyEditor {
		private ChartControlContainer chartControlContainer;
		private ChartControl chartControlCore;
		public ChartPropertyEditor(Type objectType, IModelMemberViewItem info) : base(objectType, info) { }
		protected override object CreateControlCore() {
			chartControlCore = new ChartControlWithEmptyArguments();
			chartControlContainer = new WinChartControlContainer(chartControlCore);
			return chartControlCore;
		}
