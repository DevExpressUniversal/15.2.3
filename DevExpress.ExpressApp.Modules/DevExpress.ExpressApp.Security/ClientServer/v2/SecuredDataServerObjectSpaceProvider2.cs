...
namespace DevExpress.ExpressApp.Security.ClientServer {
	public class DataServerObjectSpaceProvider2 : IObjectSpaceProvider { 
		...
		public DataServerObjectSpaceProvider2(ISecuredSerializableObjectLayer2 securedObjectLayer, IClientInfoProvider currentClientInfoProvider) {
		...
		private UnitOfWork CreateUnitOfWork() {
			SecuredSerializableObjectLayerClient2 securedObjectLayerClient = new SecuredSerializableObjectLayerClient2(currentClientInfoProvider.CreateClientInfo(), securedObjectLayer);
