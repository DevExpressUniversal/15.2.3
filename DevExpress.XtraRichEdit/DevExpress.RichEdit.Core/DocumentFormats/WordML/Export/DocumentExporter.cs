...
namespace DevExpress.XtraRichEdit.Export {
	#region WordMLDocumentExporter
	public class WordMLDocumentExporter : IExporter<DocumentFormat, bool> {
		internal static readonly FileDialogFilter filter = new FileDialogFilter(XtraRichEditLocalizer.GetString(XtraRichEditStringId.FileFilterDescription_WordMLFiles), "xml");
		...
		public bool SaveDocument(IDocumentModel documentModel, Stream stream, IExporterOptions options) {
			...
			model.InternalAPI.SaveDocumentWordMLContent(stream, (WordMLDocumentExporterOptions)options);
			return true;
		}
		#endregion
	}
