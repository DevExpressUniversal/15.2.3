...
namespace DevExpress.XtraRichEdit.Internal {
	...
	public class DocumentImportManagerService : ImportManagerService<DocumentFormat, bool>, IDocumentImportManagerService {
		...
		protected override void RegisterNativeFormats() {
			RegisterImporter(new RtfDocumentImporter());
			RegisterImporter(new PlainTextDocumentImporter());
			RegisterImporter(new HtmlDocumentImporter());
			RegisterImporter(new MhtDocumentImporter());
			RegisterImporter(new OpenXmlDocumentImporter());
			RegisterImporter(new OpenDocumentImporter());
			RegisterImporter(new WordMLDocumentImporter());
			RegisterImporter(new EPubDocumentImporter());
			RegisterImporter(new DocDocumentImporter());
		}
	}
	#endregion
}
