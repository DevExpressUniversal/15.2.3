...
namespace DevExpress.XtraRichEdit.Import {
	#region XamlDocumentImporter
	public class XamlDocumentImporter : IImporter<DocumentFormat, bool> {
		#region IDocumentImporter Members
		public FileDialogFilter Filter { get { return XamlDocumentExporter.filter; } }
		public DocumentFormat Format { get { return DocumentFormat.Xaml; } }
		public IImporterOptions SetupLoading() {
			return new XamlDocumentImporterOptions();
		}
		public bool LoadDocument(IDocumentModel documentModel, Stream stream, IImporterOptions options) {
			...
			model.InternalAPI.LoadDocumentXamlContent(stream, (XamlDocumentImporterOptions)options);
			return true;
		}
		#endregion
	}
