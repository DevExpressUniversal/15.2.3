...
namespace DevExpress.XtraRichEdit.Import {
	#region HtmlDocumentImporter
	public class HtmlDocumentImporter : IImporter<DocumentFormat, bool> {
		internal static readonly FileDialogFilter filter = new FileDialogFilter(XtraRichEditLocalizer.GetString(XtraRichEditStringId.FileFilterDescription_HtmlFiles), new string[] { "htm", "html" });
		...
		public bool LoadDocument(IDocumentModel documentModel, Stream stream, IImporterOptions options) {
			...
			model.InternalAPI.LoadDocumentHtmlContent(stream, (HtmlDocumentImporterOptions)options);
			return true;
		}
		#endregion
	}
