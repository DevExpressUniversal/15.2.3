...
namespace DevExpress.XtraRichEdit.Export {
	#region MhtDocumentExporter
	public class MhtDocumentExporter : IExporter<DocumentFormat, bool> {
		...
		public bool SaveDocument(IDocumentModel documentModel, Stream stream, IExporterOptions options) {
			...
			model.InternalAPI.SaveDocumentMhtContent(stream, (MhtDocumentExporterOptions)options);
			return true;
		}
		#endregion
	}
