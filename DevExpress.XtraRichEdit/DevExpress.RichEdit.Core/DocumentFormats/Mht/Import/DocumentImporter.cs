...
namespace DevExpress.XtraRichEdit.Import {
	#region MhtDocumentImporter
	public class MhtDocumentImporter : IImporter<DocumentFormat, bool> {
		#region IDocumentImporter Members
		public FileDialogFilter Filter { get { return MhtDocumentExporter.filter; } }
		...
		public bool LoadDocument(IDocumentModel documentModel, Stream stream, IImporterOptions options) {
			...
			model.InternalAPI.LoadDocumentMhtContent(stream, (MhtDocumentImporterOptions)options);
			return true;
		}
		#endregion
	}
