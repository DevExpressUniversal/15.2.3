...
namespace DevExpress.XtraRichEdit.Export {
	#region RtfDocumentExporter
	public class RtfDocumentExporter : IExporter<DocumentFormat, bool> {
		#region IDocumentExporter Members
		public FileDialogFilter Filter { get { return RtfDocumentImporter.filter; } }
		...
		public bool SaveDocument(IDocumentModel documentModel, Stream stream, IExporterOptions options) {
			...
			model.InternalAPI.SaveDocumentRtfContent(stream, (RtfDocumentExporterOptions)options);
			return true;
		}
		#endregion
	}
