...
namespace DevExpress.XtraRichEdit.Export.Rtf {
	#region MailMergePropertiesExporter
	public class MailMergePropertiesExporter {
		readonly RtfBuilder rtfBuilder;
		public MailMergePropertiesExporter(RtfBuilder rtfBuilder){
			Guard.ArgumentNotNull(rtfBuilder, "rtfBuilder");
			this.rtfBuilder = rtfBuilder;
		}
		public RtfBuilder RtfBuilder { get { return rtfBuilder; } }
		public void Export(MailMergeProperties properties) {
		}
	}
	#endregion
}
