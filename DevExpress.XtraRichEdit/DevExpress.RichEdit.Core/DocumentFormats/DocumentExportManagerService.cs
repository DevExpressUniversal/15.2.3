...
namespace DevExpress.XtraRichEdit.Internal {
	...
	public class DocumentExportManagerService : ExportManagerService<DocumentFormat, bool>, IDocumentExportManagerService {
		...
		protected override void RegisterNativeFormats() {
			RegisterExporter(new RtfDocumentExporter());
			RegisterExporter(new PlainTextDocumentExporter());
			RegisterExporter(new HtmlDocumentExporter());
			RegisterExporter(new MhtDocumentExporter());
			RegisterExporter(new OpenXmlDocumentExporter());
			RegisterExporter(new OpenDocumentExporter());
			RegisterExporter(new WordMLDocumentExporter());
			RegisterExporter(new EPubDocumentExporter());
			RegisterExporter(new DocDocumentExporter());
		}
	}
	#endregion
}
