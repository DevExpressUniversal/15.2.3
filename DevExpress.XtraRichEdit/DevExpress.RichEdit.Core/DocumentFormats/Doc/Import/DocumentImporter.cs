...
namespace DevExpress.XtraRichEdit.Import {
	#region DocDocumentImporter
	public class DocDocumentImporter : IImporter<DocumentFormat, bool> {
		#region IDocumentImporter Members
		public FileDialogFilter Filter { get { return DocDocumentExporter.filter; } }
		...
		public bool LoadDocument(IDocumentModel documentModel, Stream stream, IImporterOptions options) {
			...
			model.InternalAPI.LoadDocumentDocContent(stream, (DocDocumentImporterOptions)options);
			return true;
		}
		#endregion
		public static void Register(IServiceProvider provider) {
			...
			if (service != null)
				service.RegisterImporter(new DocDocumentImporter());
		}
	}
	#endregion
}
