...
namespace DevExpress.XtraRichEdit.Internal {
	public partial class InnerRichEditControl {
		RichEditMouseHandler defaultMouseHandler;
		Stack<MouseHandler> mouseHandlers;
		protected internal MouseHandler MouseHandler { get { return mouseHandlers.Peek(); } }
...
#region InitializeMouseHandlers
		...
		protected internal virtual void OnDragEnter(DragEventArgs e) {
			...
			RichEditMouseHandler handler = MouseHandler as RichEditMouseHandler;
			if (handler != null)
