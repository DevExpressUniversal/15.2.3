...
namespace DevExpress.XtraRichEdit.Layout {
	#region LineBreakBox
	public class LineBreakBox : SingleCharacterMarkBox {
		public override Box CreateBox() {
			return new LineBreakBox();
		}
		...
		protected internal override char MarkCharacter { get { return '\x2190'; } }
		public override void ExportTo(IDocumentLayoutExporter exporter) {
			exporter.ExportLineBreakBox(this);
		}
		public override BoxHitTestManager CreateHitTestManager(IBoxHitTestCalculator calculator) {
			return calculator.CreateLineBreakBoxHitTestManager(this);
		}
