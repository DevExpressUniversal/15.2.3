...
namespace DevExpress.XtraRichEdit.Layout {
	public class SeparatorBox : SingleCharacterMarkBox {
		...
		protected internal override char MarkCharacter { get { return Characters.SeparatorMark; } }
		public override Box CreateBox() {
			return new SeparatorBox();
		}
		public override void ExportTo(IDocumentLayoutExporter exporter) {
			exporter.ExportSeparatorBox(this);
		}
		public override BoxHitTestManager CreateHitTestManager(IBoxHitTestCalculator calculator) {
			return calculator.CreateSeparatorMarkBoxHitTestManager(this);
		}
	}
}
