...
namespace DevExpress.XtraRichEdit.Model {
	#region SectionRun
	public class SectionRun : ParagraphRun {
		public SectionRun(Paragraph paragraph)
			: base(paragraph) {
		}
		...
		public ParagraphRun CreateParagraphRun() {
			ParagraphRun result = new ParagraphRun(this.Paragraph);
			result.StartIndex = this.StartIndex;
			result.Length = this.Length;
			result.InheritStyleAndFormattingFromCore(this);
			return result;
		}
	}
	#endregion
