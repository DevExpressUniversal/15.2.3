...
namespace DevExpress.XtraRichEdit.Model.History {
	...
	public class CustomRunInsertedHistoryItem : TextRunInsertedBaseHistoryItem {
		#region Fields
		int notificationId;
		#endregion
		public CustomRunInsertedHistoryItem(PieceTable pieceTable)
			: base(pieceTable) {
		}
		#region Properties
		public ICustomRunObject CustomRunObject { get; set; }
		#endregion
		...
		protected override void RedoCore() {
			...
			CustomRun newRun = new CustomRun(runs[RunIndex].Paragraph);
			newRun.CustomRunObject = CustomRunObject;
