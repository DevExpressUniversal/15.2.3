...
namespace DevExpress.XtraRichEdit.Services.Implementation {
	public interface IBookmarkResolutionService {
		Bookmark FindBookmarkByName(string name);
	}
	public class BookmarkResolutionService : IBookmarkResolutionService {
		readonly PieceTable pieceTable;
		public BookmarkResolutionService(PieceTable pieceTable) {
			this.pieceTable = pieceTable;
		}
		#region IBookmarkResolutionService Members
