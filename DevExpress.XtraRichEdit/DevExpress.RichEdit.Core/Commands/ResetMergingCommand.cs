...
namespace DevExpress.XtraRichEdit.Commands {
	#region ResetMergingCommand
	public class ResetMergingCommand : RichEditMenuItemSimpleCommand {
		public ResetMergingCommand(IRichEditControl control)
			: base(control) {
		}
		#region Properties
		public override RichEditCommandId Id { get { return RichEditCommandId.ResetMerging; } }
