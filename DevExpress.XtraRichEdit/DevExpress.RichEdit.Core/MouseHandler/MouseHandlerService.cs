...
namespace DevExpress.XtraRichEdit.Mouse {
	#region RichEditMouseHandlerService
	public class RichEditMouseHandlerService : MouseHandlerService {
		readonly InnerRichEditControl control;
		public RichEditMouseHandlerService(InnerRichEditControl control)
