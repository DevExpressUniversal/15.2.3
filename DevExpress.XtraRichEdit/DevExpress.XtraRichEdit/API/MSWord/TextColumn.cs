...
namespace DevExpress.XtraRichEdit.API.Word {
	...
	public interface TextColumn : IWordObject {
		float Width { get; set; }
	...
	#region TextColumns
	[GeneratedCode("Suppress FxCop check", "")]
	public interface TextColumns : IWordObject, IEnumerable {
		int Count { get; }
		int EvenlySpaced { get; set; }
		int LineBetween { get; set; }
		float Width { get; set; }
		float Spacing { get; set; }
		TextColumn this[int Index] { get; }
		TextColumn Add(ref object Width, ref object Spacing, ref object EvenlySpaced);
		void SetCount(int NumColumns);
		WdFlowDirection FlowDirection { get; set; }
	}
	#endregion
	#region WdFlowDirection
	[GeneratedCode("Suppress FxCop check", "")]
