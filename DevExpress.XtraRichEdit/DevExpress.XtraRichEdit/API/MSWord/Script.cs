...
namespace DevExpress.XtraRichEdit.API.Word {
	...
	public interface Script : IMsoObject {
	...
	#region Scripts
	[GeneratedCode("Suppress FxCop check", "")]
	public interface Scripts : IMsoObject, IEnumerable {
		int Count { get; }
		Script Item(object Index);
		Script Add(object Anchor, MsoScriptLocation Location, MsoScriptLanguage Language, string Id, string Extended, string ScriptText);
		void Delete();
	}
	#endregion
}
