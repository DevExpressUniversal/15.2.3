...
namespace DevExpress.XtraDiagram.Adorners {
	public class DiagramGlueToPointAdorner : DiagramAdornerBase {
		Size pointSize;
		public DiagramGlueToPointAdorner(Size pointSize) {
			this.pointSize = pointSize;
		}
		public Size PointSize { get { return pointSize; } }
		public override DiagramAdornerObjectInfoArgsBase GetDrawArgs() {
			return new DiagramGlueToPointAdornerObjectInfoArgs();
		}
		public override DiagramAdornerPainterBase GetPainter() {
			return new DiagramGlueToPointAdornerPainter();
		}
