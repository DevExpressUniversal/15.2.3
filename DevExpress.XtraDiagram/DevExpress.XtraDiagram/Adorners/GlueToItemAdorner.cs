...
namespace DevExpress.XtraDiagram.Adorners {
	public class DiagramGlueToItemAdorner : DiagramAdornerBase {
		public DiagramGlueToItemAdorner() {
		}
		public override DiagramAdornerObjectInfoArgsBase GetDrawArgs() {
			return new DiagramGlueToItemAdornerObjectInfoArgs();
		}
		public override DiagramAdornerPainterBase GetPainter() {
			return new DiagramGlueToItemAdornerPainter();
		}
