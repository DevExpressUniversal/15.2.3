...
namespace DevExpress.XtraDiagram.Extensions {
	public static class ColorExtensions {
		public static bool IsWhite(this Color color) {
			return color.ToArgb() == (-1);
		}
		public static PlatformColor ToPlatformColor(this Color color) {
			return PlatformColor.FromArgb(color.A, color.R, color.G, color.B);
		}
		public static bool IsDefault(this Color color) {
			return color == Color.Empty || color.ToArgb() == 0x0;
		}
	}
	public static class PlatformColorExtensions {
		public static Color ToWinColor(this PlatformColor color) {
