...
namespace DevExpress.XtraDiagram.Extensions {
	public static class SizeGripKindExtensions {
		public static ResizeMode GetResizeMode(this SizeGripKind kind) {
			switch(kind) {
				case SizeGripKind.TopLeft:
					return ResizeMode.TopLeft;
				case SizeGripKind.Top:
					return ResizeMode.Top;
				case SizeGripKind.TopRight:
					return ResizeMode.TopRight;
				case SizeGripKind.Left:
					return ResizeMode.Left;
				case SizeGripKind.Right:
					return ResizeMode.Right;
				case SizeGripKind.BottomLeft:
					return ResizeMode.BottomLeft;
				case SizeGripKind.Bottom:
					return ResizeMode.Bottom;
				case SizeGripKind.BottomRight:
