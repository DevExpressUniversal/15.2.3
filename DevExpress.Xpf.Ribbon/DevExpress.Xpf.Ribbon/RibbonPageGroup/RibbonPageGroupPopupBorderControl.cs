...
namespace DevExpress.Xpf.Ribbon {
	public class RibbonPageGroupPopupBorderControl : PopupBorderControl, IToolTipPlacementTarget {
		public static readonly DependencyProperty ToolTipVerticalOffsetProperty = DependencyProperty.Register("ToolTipVerticalOffset", typeof(double), typeof(RibbonPageGroupPopupBorderControl), new PropertyMetadata(0d));		
		static RibbonPageGroupPopupBorderControl() {
			DefaultStyleKeyProperty.OverrideMetadata(typeof(RibbonPageGroupPopupBorderControl), new FrameworkPropertyMetadata(typeof(RibbonPageGroupPopupBorderControl)));
		}
		public RibbonPageGroupPopupBorderControl() {
		}
		#region dep props
