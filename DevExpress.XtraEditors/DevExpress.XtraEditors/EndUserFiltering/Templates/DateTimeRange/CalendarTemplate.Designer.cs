...
namespace DevExpress.XtraEditors.Filtering.Templates.DateTimeRange {
	partial class CalendarTemplate {
		...
		private void InitializeComponent() {
			...
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.Part_FromValue.Properties.CalendarView = DevExpress.XtraEditors.Repository.CalendarView.TouchUI;
			...
			this.Part_FromValue.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.Part_FromValue.Properties.VistaDisplayMode = DevExpress.Utils.DefaultBoolean.False;
			...
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.Part_ToValue.Properties.CalendarView = DevExpress.XtraEditors.Repository.CalendarView.TouchUI;
			...
			this.Part_ToValue.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.Part_ToValue.Properties.VistaDisplayMode = DevExpress.Utils.DefaultBoolean.False;
			this.Part_ToValue.Size = new System.Drawing.Size(81, 20);
			this.Part_ToValue.TabIndex = 3;
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.tableLayoutPanel);
			this.Name = "CalendarTemplate";
