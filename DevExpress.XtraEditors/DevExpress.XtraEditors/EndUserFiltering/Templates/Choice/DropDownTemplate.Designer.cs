...
namespace DevExpress.XtraEditors.Filtering.Templates.Choice {
	partial class DropDownTemplate {
		...
		private void InitializeComponent() {
			this.Part_Value = new DevExpress.XtraEditors.ImageComboBoxEdit();
			...
			this.Part_Value.EditValue = "";
			this.Part_Value.Location = new System.Drawing.Point(9, 3);
			this.Part_Value.Name = "Part_Value";
			this.Part_Value.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.Part_Value.Properties.Items.AddRange(new DevExpress.XtraEditors.Controls.ImageComboBoxItem[] {
			new DevExpress.XtraEditors.Controls.ImageComboBoxItem("Default", null, -1),
			...
			this.Part_Value.Size = new System.Drawing.Size(222, 20);
		...
		#endregion
		private ImageComboBoxEdit Part_Value;
	}
}
