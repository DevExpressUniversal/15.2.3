...
namespace DevExpress.XtraReports.Native {
	[ToolboxItem(false)]
	public class LayoutItemButton: SimpleButton {
		LayoutItemButtonPainter painter = new LayoutItemButtonPainter(ObjectState.Disabled, false);
		...
		class LayoutItemButtonPainter : BaseButtonPainter {
			...
			public LayoutItemButtonPainter(ObjectState notDrawButtonState, bool notDrawButtonOnNormalState) {
			...
			protected override void DrawContent(ControlGraphicsInfoArgs info) {
				...
				if(vi.ButtonInfo.Button.Image != null){
					...
					XPaint.Graphics.DrawImage(info.Graphics, vi.ButtonInfo.Button.ActualImage, x, y, 
						new Rectangle(Point.Empty, vi.ButtonInfo.Button.Image.Size), info.ViewInfo.State != ObjectState.Disabled);
				}
			}
		}
		public LayoutItemButton()
			: base() {
