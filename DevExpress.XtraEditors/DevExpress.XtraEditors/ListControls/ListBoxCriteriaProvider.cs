...
namespace DevExpress.XtraEditors.ListControls {
	public class ListBoxCriteriaProvider : SearchControlCriteriaProviderBase {
		BaseListBoxControl listBox;
		public ListBoxCriteriaProvider(BaseListBoxControl listBox)
			: base() {
		...
		protected override Data.Filtering.CriteriaOperator CalcActiveCriteriaOperatorCore(SearchControlQueryParamsEventArgs args, Data.Helpers.FindSearchParserResults result) {
			...
			if(listBox.DataSource != null && !string.IsNullOrEmpty(listBox.DisplayMember))
				columnName = listBox.DisplayMember;
			return DxFtsContainsHelper.Create(new string[] { columnName }, result, args.FilterCondition);
		}
	...
	interface ISupportSelectionDataAdapter {
