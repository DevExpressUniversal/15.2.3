...
namespace DevExpress.Utils.Filtering.Internal {
	...
	static class FilterPropertyAttributeBuilder {
		readonly static ConstructorInfo attributeCtor;
		static FilterPropertyAttributeBuilder() {
			var attributeType = typeof(Internal.FilterPropertyAttribute);
			attributeCtor = attributeType.GetConstructor(new Type[] { typeof(bool) });
		}
		internal static CustomAttributeBuilder Build(IEndUserFilteringMetric metric) {
			if(metric == null) return null;
			return Build(metric.IsVisible);
		}
