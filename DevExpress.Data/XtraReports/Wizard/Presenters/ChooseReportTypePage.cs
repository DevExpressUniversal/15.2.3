...
namespace DevExpress.Data.XtraReports.Wizard.Presenters {
	public class ChooseReportTypePage<TModel> : WizardPageBase<IChooseReportTypePageView, TModel> where TModel : ReportModel {
		...
		public ChooseReportTypePage(IChooseReportTypePageView view) : base(view) {
		}
		public override void Begin() {
			View.ReportType = Model.ReportType;
		}
		public override void Commit() {
			Model.ReportType = View.ReportType;
		}
		public override Type GetNextPageType() {
			switch(View.ReportType) {
				case ReportType.Label:
					return typeof(SelectLabelTypePage<TModel>);
				case ReportType.Standard:
					return typeof(SelectDataSourcePage<TModel>);
				default:
					throw new NotSupportedException("Unexpected report type " + View.ReportType);
			}
		}
	}
}
