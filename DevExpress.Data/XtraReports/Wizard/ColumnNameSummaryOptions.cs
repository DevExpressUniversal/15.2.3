...
namespace DevExpress.Data.XtraReports.Wizard {
	public class ColumnNameSummaryOptions : ICloneable {
		...
		public ColumnNameSummaryOptions()
			: this(null, SummaryOptionFlags.None) { }
		public ColumnNameSummaryOptions(string columnName)
			: this(columnName, SummaryOptionFlags.None) { }
		public ColumnNameSummaryOptions(string columnName, SummaryOptionFlags flags) {
			ColumnName = columnName;
			Flags = flags;
		}
		public object Clone() {
			ColumnNameSummaryOptions clone = new ColumnNameSummaryOptions(ColumnName, Flags);
			return clone;
		}
		public override bool Equals(object obj) {
			ColumnNameSummaryOptions other = obj as ColumnNameSummaryOptions;
			if(other == null)
				return false;
			return
		...
		public override int GetHashCode() {
			if(ColumnName != null)
				return HashCodeHelper.CalcHashCode(ColumnName.GetHashCode(), Flags.GetHashCode());
