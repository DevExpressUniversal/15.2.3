...
namespace DevExpress.Data {
	...
	public interface IFilterStringContainer {
		string FilterString {
			get;
			set;
		}
...
namespace DevExpress.Data.Browsing {
	public class DataPair {
		...
		public bool IsEmpty { get { return source == null || member == null; } }
	...
	public class DataInfo : DataPair {
		...
		public DataInfo(object source, string member, string displayName) : base(source, member) {
			this.displayName = displayName;
		}
	}
	public interface IDataInfoContainer {
		DataInfo[] GetData();
	}
}
