...
namespace DevExpress.Charts.Native {
	public class SimpleSeriesContainer : SingleSeriesContainer {
		readonly SimplePointInteraction interaction = new SimplePointInteraction();
		internal SimplePointInteraction Interaction { 
