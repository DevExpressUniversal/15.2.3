...
namespace DevExpress.Sparkline.Core {
	public class WinLossSparklineMapping : BarSparklineMapping {
		protected internal WinLossSparklineMapping(Rectangle bounds) : base(bounds) { }
		...
		protected override SparklineRangeData CorrectValueRange(SparklineRangeData range) {
			return new SparklineRangeData(-1, 1);			
		}
		protected override double CorrectValue(double value) {
