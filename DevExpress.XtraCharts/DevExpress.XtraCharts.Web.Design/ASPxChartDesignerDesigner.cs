...
namespace DevExpress.XtraCharts.Web.Design {
	public class ASPxChartDesignerDesigner : ASPxWebUIControlDesigner {
		static ASPxChartDesignerDesigner() {
		}
		...
		protected override ClientControlsDesignModeInfo CreateClientControlsDesignModeInfo() {
			return ChartDesignerDesignModeInfoGenerator.Generate();
		}
		protected override ASPxWebControlDesignerActionList CreateCommonActionList() {
			return new ASPxChartDesignerDesignerActionList(this);
		}
	}
	class ASPxChartDesignerDesignerActionList : XRWebControlDesignerActionListBase<ASPxChartDesigner> {
		...
		public ASPxChartDesignerDesignerActionList(ASPxChartDesignerDesigner designer)
			: base(designer) {
		}
