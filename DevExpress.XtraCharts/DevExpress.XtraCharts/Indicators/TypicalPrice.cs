...
namespace DevExpress.XtraCharts {
	...
	public class TypicalPrice : Indicator {
		public override string IndicatorName { get { return ChartLocalizer.GetString(ChartStringId.IndTypicalPrice); } }
		public TypicalPrice(string name) : base(name) {
		}
		public TypicalPrice() : this(String.Empty) {
		}
		protected override ChartElement CreateObjectForClone() {
			return new TypicalPrice();
		}
		protected override IndicatorBehavior CreateBehavior() {
			return new TypicalPriceBehavior(this);
		}
	}
}
namespace DevExpress.XtraCharts.Native {
	public class TypicalPriceBehavior : IndicatorBehavior {
		LineStrip medLineStrip;
		TypicalPrice TypicalPrice { get { return (TypicalPrice)Indicator; } }
		public TypicalPriceBehavior(TypicalPrice indicator)
			: base(indicator) {
		}
		public override IndicatorLayout CreateLayout(XYDiagramMappingBase diagramMapping, TextMeasurer textMeasurer) {
			...
			return new MultilineIndicatorLayout(TypicalPrice, screenPolyline);
		}
		protected override void Calculate(IRefinedSeries refinedSeries) {
			Visible = false;
			var calculator = new TypicalPriceCalculator();
