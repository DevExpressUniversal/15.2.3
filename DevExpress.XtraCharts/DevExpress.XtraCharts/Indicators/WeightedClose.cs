...
namespace DevExpress.XtraCharts {
	...
	public class WeightedClose : Indicator {
		public override string IndicatorName { get { return ChartLocalizer.GetString(ChartStringId.IndWeightedClose); } }
		public WeightedClose(string name) : base(name) {
		}
		public WeightedClose() : this(String.Empty) {
		}
		protected override ChartElement CreateObjectForClone() {
			return new WeightedClose();
		}
		protected override IndicatorBehavior CreateBehavior() {
			return new WeightedCloseBehavior(this);
		}
	}
}
namespace DevExpress.XtraCharts.Native {
	public class WeightedCloseBehavior : IndicatorBehavior {
		LineStrip medLineStrip;
		WeightedClose WeightedClose { get { return (WeightedClose)Indicator; } }
		public WeightedCloseBehavior(WeightedClose indicator)
			: base(indicator) {
		}
		public override IndicatorLayout CreateLayout(XYDiagramMappingBase diagramMapping, TextMeasurer textMeasurer) {
			...
			return new MultilineIndicatorLayout(WeightedClose, screenPolyline);
		}
		protected override void Calculate(IRefinedSeries refinedSeries) {
			Visible = false;
			var calculator = new WeightedCloseCalculator();
