...
namespace DevExpress.XtraCharts {
	...
	public class ExponentialMovingAverage : MovingAverage {
		public override string IndicatorName { get { return ChartLocalizer.GetString(ChartStringId.IndExponentialMovingAverage); } }
		public ExponentialMovingAverage(string name, ValueLevel valueLevel) 
		...
		protected override IndicatorBehavior CreateBehavior() {
			return new ExponentialMovingAverageBehavior(this);
		} 
	}
}
namespace DevExpress.XtraCharts.Native {
	public class ExponentialMovingAverageBehavior : MovingAverageIndicatorBehavior {
		public ExponentialMovingAverageBehavior(ExponentialMovingAverage exponentialMovingAverage) 
		...
		protected override void CalculateInternal(IRefinedSeries refinedSeries) {
			...
			if (indicator.Visible) {
				ExponentialMovingAverageCalculator calculator = new ExponentialMovingAverageCalculator();
