...
namespace DevExpress.XtraCharts {
	...
	public class SimpleMovingAverage : MovingAverage {
		public override string IndicatorName { get { return ChartLocalizer.GetString(ChartStringId.IndSimpleMovingAverage); } }
		public SimpleMovingAverage(string name, ValueLevel valueLevel) 
			: base(name, valueLevel) { }
		public SimpleMovingAverage(string name) 
			: base(name) { }
		...
		protected override IndicatorBehavior CreateBehavior() {
			return new SimpleMovingAverageBehavior(this);
		} 
	}
}
namespace DevExpress.XtraCharts.Native {
	public class SimpleMovingAverageBehavior : MovingAverageIndicatorBehavior {
		public SimpleMovingAverageBehavior(SimpleMovingAverage simpleMovingAverage) 
