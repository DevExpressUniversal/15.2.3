...
namespace DevExpress.XtraCharts {
	...
	public class WeightedMovingAverage : MovingAverage {
		public override string IndicatorName {
			get { return ChartLocalizer.GetString(ChartStringId.IndWeightedMovingAverage); }
		}
		public WeightedMovingAverage(string name, ValueLevel valueLevel) 
			: base(name, valueLevel) { }
		public WeightedMovingAverage(string name) 
			: base(name) { }
		...
		protected override IndicatorBehavior CreateBehavior() {
			return new WeightedMovingAverageBehavior(this);
		} 
	}
}
namespace DevExpress.XtraCharts.Native {
	public class WeightedMovingAverageBehavior : MovingAverageIndicatorBehavior {
		public WeightedMovingAverageBehavior(WeightedMovingAverage weightedMovingAverage) 
			: base(weightedMovingAverage) { }
		protected override void CalculateInternal(IRefinedSeries refinedSeries) {
			...
			if (indicator.Visible) {
				WeightedMovingAverageCalculator calculator = new WeightedMovingAverageCalculator();
