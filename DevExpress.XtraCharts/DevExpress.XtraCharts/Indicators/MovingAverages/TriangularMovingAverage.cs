...
namespace DevExpress.XtraCharts {
	...
	public class TriangularMovingAverage : MovingAverage {
		public override string IndicatorName {
			get { return ChartLocalizer.GetString(ChartStringId.IndTriangularMovingAverage); }
		}
		public TriangularMovingAverage(string name, ValueLevel valueLevel) 
			: base(name, valueLevel) { }
		public TriangularMovingAverage(string name) 
			: base(name) { }
		...
		protected override IndicatorBehavior CreateBehavior() {
			return new TriangularMovingAverageBehavior(this);
		} 
	}
}
namespace DevExpress.XtraCharts.Native {
	public class TriangularMovingAverageBehavior : MovingAverageIndicatorBehavior {
		public TriangularMovingAverageBehavior(TriangularMovingAverage simpleMovingAverage) 
			: base(simpleMovingAverage) { }
		protected override void CalculateInternal(IRefinedSeries refinedSeries) {
			...
			if (indicator.Visible) {
				TriangularMovingAverageCalculator calculator = new TriangularMovingAverageCalculator();
