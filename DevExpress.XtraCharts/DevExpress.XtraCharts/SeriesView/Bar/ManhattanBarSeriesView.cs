...
namespace DevExpress.XtraCharts {
	...
	public class ManhattanBarSeriesView : Bar3DSeriesView {
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnManhattanBar); } }
		protected override Type PointInterfaceType { get { return typeof(IXYPoint); } }
		protected override ChartElement CreateObjectForClone() {
			return new ManhattanBarSeriesView();
		}
