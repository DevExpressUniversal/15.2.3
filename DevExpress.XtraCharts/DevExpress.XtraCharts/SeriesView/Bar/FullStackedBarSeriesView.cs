...
namespace DevExpress.XtraCharts {
	...
	public class FullStackedBarSeriesView : StackedBarSeriesView {
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnFullStackedBar); } }
		...
		public FullStackedBarSeriesView() : base() {
		}
		protected override ChartElement CreateObjectForClone() {
			return new FullStackedBarSeriesView();
		}
		...
		protected internal override SeriesLabelBase CreateSeriesLabel() {
			return new FullStackedBarSeriesLabel();
		}
	}
}
