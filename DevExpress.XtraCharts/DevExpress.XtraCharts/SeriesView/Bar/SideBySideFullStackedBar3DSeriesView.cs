...
namespace DevExpress.XtraCharts {
	...
	public class SideBySideFullStackedBar3DSeriesView : FullStackedBar3DSeriesView, ISideBySideStackedBarSeriesView, ISupportStackedGroup {
		object stackedGroup;
		protected override bool NeedSeriesGroupsInteraction { get { return true; } }
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnSideBySideFullStackedBar3D); } }
		[
		Browsable(false),
		...
		[
#if !SL
	DevExpressXtraChartsLocalizedDescription("SideBySideFullStackedBar3DSeriesViewStackedGroup"),
#endif
		DXDisplayName(typeof(ResFinder), DXDisplayNameAttribute.DefaultResourceFile, "DevExpress.XtraCharts.SideBySideFullStackedBar3DSeriesView.StackedGroup"),
		...
		[
#if !SL
	DevExpressXtraChartsLocalizedDescription("SideBySideFullStackedBar3DSeriesViewBarDistance"),
#endif
		DXDisplayName(typeof(ResFinder), DXDisplayNameAttribute.DefaultResourceFile, "DevExpress.XtraCharts.SideBySideFullStackedBar3DSeriesView.BarDistance"),
		DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
		...
		[
#if !SL
	DevExpressXtraChartsLocalizedDescription("SideBySideFullStackedBar3DSeriesViewBarDistanceFixed"),
#endif
		DXDisplayName(typeof(ResFinder), DXDisplayNameAttribute.DefaultResourceFile, "DevExpress.XtraCharts.SideBySideFullStackedBar3DSeriesView.BarDistanceFixed"),
		DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
		RefreshProperties(RefreshProperties.All),
		XtraSerializableProperty(XtraSerializationVisibility.Hidden)
		]
		...
		[
#if !SL
	DevExpressXtraChartsLocalizedDescription("SideBySideFullStackedBar3DSeriesViewEqualBarWidth"),
#endif
		DXDisplayName(typeof(ResFinder), DXDisplayNameAttribute.DefaultResourceFile, "DevExpress.XtraCharts.SideBySideFullStackedBar3DSeriesView.EqualBarWidth"),
		...
		protected override ChartElement CreateObjectForClone() {
			return new SideBySideFullStackedBar3DSeriesView();
		}
		...
		public override bool Equals(object obj) {
			if (!base.Equals(obj))
				return false;
			SideBySideFullStackedBar3DSeriesView view = (SideBySideFullStackedBar3DSeriesView)obj;
