...
namespace DevExpress.XtraCharts {
	...
	public class StackedLineSeriesView : LineSeriesView, IStackedView {
		...
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnStackedLine); } }
		protected override Type PointInterfaceType { get { return typeof(IStackedPoint); } }
		public StackedLineSeriesView() : base() {
		}
		...
		protected override ChartElement CreateObjectForClone() {
			return new StackedLineSeriesView();
		}
