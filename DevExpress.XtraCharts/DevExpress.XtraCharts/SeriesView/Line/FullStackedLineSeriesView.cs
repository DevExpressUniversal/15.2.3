...
namespace DevExpress.XtraCharts {
	...
	public class FullStackedLineSeriesView : StackedLineSeriesView {
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnFullStackedLine); } }
