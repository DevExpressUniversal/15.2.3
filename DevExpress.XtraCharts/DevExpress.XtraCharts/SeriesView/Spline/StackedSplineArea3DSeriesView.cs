...
namespace DevExpress.XtraCharts {
	...
	public class StackedSplineArea3DSeriesView : StackedArea3DSeriesView, ISplineSeriesView, IStackedSplineView {
		...
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnSplineAreaStacked3D); } }
		[
#if !SL
	DevExpressXtraChartsLocalizedDescription("StackedSplineArea3DSeriesViewLineTensionPercent"),
#endif
		DXDisplayName(typeof(ResFinder), DXDisplayNameAttribute.DefaultResourceFile, "DevExpress.XtraCharts.StackedSplineArea3DSeriesView.LineTensionPercent"),
		...
		public StackedSplineArea3DSeriesView() { 
		}
		...
		protected override ChartElement CreateObjectForClone() {
			return new StackedSplineArea3DSeriesView();
		}
		...
		protected override List<PlanePolygon> CalculatePolygons(XYDiagram3DCoordsCalculator coordsCalculator, XYDiagram3DSeriesLayout seriesLayout, IList<IGeometryStrip> strips) {
			...
			double maxLimitNotTransformed = Series.IsNegative() ? Double.MinValue : Double.MaxValue;
		...
		public override bool Equals(object obj) {
			if (!base.Equals(obj))
				return false;
			return lineTensionPercent == ((StackedSplineArea3DSeriesView)obj).lineTensionPercent;
		}
