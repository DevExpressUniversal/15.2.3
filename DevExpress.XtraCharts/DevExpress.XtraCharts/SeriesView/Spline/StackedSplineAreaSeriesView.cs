...
namespace DevExpress.XtraCharts {
	...
	public class StackedSplineAreaSeriesView : StackedAreaSeriesView, ISplineSeriesView, IStackedSplineView {
		...
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnSplineStackedArea); } }
		[
#if !SL
	DevExpressXtraChartsLocalizedDescription("StackedSplineAreaSeriesViewLineTensionPercent"),
#endif
		DXDisplayName(typeof(ResFinder), DXDisplayNameAttribute.DefaultResourceFile, "DevExpress.XtraCharts.StackedSplineAreaSeriesView.LineTensionPercent"),
		...
		protected override ChartElement CreateObjectForClone() {
			return new StackedSplineAreaSeriesView();
		}
