...
namespace DevExpress.XtraCharts {
	...
	public class AreaSeriesView : AreaSeriesViewBase {
		protected internal override string StringId { get { return ChartLocalizer.GetString(ChartStringId.SvnArea); } }
