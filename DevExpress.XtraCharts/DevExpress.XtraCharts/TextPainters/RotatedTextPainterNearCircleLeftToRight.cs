...
namespace DevExpress.XtraCharts.Native {
	public class RotatedTextPainterNearCircleLeftToRight : RotatedTextPainterNearCircle {
		public RotatedTextPainterNearCircleLeftToRight(float angleOnCircleDegree, Point basePoint, string text, SizeF textSize, ITextPropertiesProvider propertiesProvider, bool mixColorByHitTestState, bool parseText, TextMeasurer textMeasurer, int maxWidth, int maxLineCount)
		...
		protected override Point CalculateLeftTopPoint() {
			if (AngleOnCircleDegree == 0)
				...
				throw new InternalException("RotatedTextPainterNearCircleLeftToRight error");
		}
