...
namespace DevExpress.XtraCharts.Native {
	public class RotatedTextPainterNearCircleTopToBottom : RotatedTextPainterNearCircle {
		public RotatedTextPainterNearCircleTopToBottom(float angleOnCircleDegree, Point basePoint, string text, SizeF textSize, ITextPropertiesProvider propertiesProvider, bool mixColorByHitTestState, bool parseText, TextMeasurer textMeasurer, int maxWidth, int maxLineCount)
