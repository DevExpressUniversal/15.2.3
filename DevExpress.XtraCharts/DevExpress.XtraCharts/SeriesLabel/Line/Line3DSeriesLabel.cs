...
namespace DevExpress.XtraCharts {
	[
	TypeConverter(typeof(Line3DSeriesLabelTypeConverter)),
	DesignerSerializer("DevExpress.XtraCharts.Design.ChartItemSerializer," + AssemblyInfo.SRAssemblyChartsExtensions,
					   "System.ComponentModel.Design.Serialization.CodeDomSerializer,System.Design")
	]
	public class Line3DSeriesLabel : SeriesLabelBase {
		...
		public Line3DSeriesLabel() : base() {
		}
		protected virtual double CalcConnectorAngle(MinMaxValues values, out DiagramVector direction) {
		...
		protected internal override void CalculateLayout(SeriesLabelLayoutList labelLayoutList, RefinedPointData pointData, TextMeasurer textMeasurer) {
			...
			Line3DSeriesView view = Series.View as Line3DSeriesView;
			if (view == null) {
				ChartDebug.Fail("Line3DSeriesView expected.");
				return;
			}
			MinMaxValues values = view.GetSeriesPointValues(pointData.RefinedPoint);
			DiagramVector connectorDirection;
			double connectorAngle = CalcConnectorAngle(values, out connectorDirection);
			SeriesLabelHelper.CalculateLayoutForLine3DLabel(xyLabelLayoutList, textMeasurer, pointData, values.Max, connectorAngle, connectorDirection);
		}
	}
}
