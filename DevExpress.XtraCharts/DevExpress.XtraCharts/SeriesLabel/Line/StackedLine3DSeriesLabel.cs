...
namespace DevExpress.XtraCharts {
	...
	public class StackedLine3DSeriesLabel : Line3DSeriesLabel {
		public StackedLine3DSeriesLabel() : base() {
		}
		protected internal override void CalculateLayout(SeriesLabelLayoutList labelLayoutList, RefinedPointData pointData, TextMeasurer textMeasurer) {
			StackedLine3DSeriesView view = Series.View as StackedLine3DSeriesView;
			if (view == null)
				ChartDebug.Fail("StackedLine3DSeriesView expected.");
			else {
