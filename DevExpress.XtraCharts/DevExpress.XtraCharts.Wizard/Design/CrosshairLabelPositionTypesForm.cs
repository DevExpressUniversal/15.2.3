...
namespace DevExpress.XtraCharts.Design {
	public partial class CrosshairLabelPositionTypesForm : ItemKindChoosingForm {
		CrosshairLabelPosition currentPosition;
		public CrosshairLabelPosition EditValue { 
		...
		public CrosshairLabelPositionTypesForm() {
			InitializeComponent();
		}
		void AddItem(CrosshairLabelPosition position) {
		...
		protected override void Initialize() {
			AddItem(new CrosshairMousePosition());
			AddItem(new CrosshairFreePosition());
		}
		protected override void SelectedIndexChanged() {
			if (listView.SelectedItems.Count > 0) {
				if (listView.SelectedIndices[0] == 0)
					currentPosition = new CrosshairMousePosition();
				else if (listView.SelectedIndices[0] == 1)
					currentPosition = new CrosshairFreePosition();
			}
		}
	}
}
