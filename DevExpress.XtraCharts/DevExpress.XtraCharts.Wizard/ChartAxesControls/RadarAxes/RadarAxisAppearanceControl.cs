...
namespace DevExpress.XtraCharts.Wizard.ChartAxesControls {
	internal partial class RadarAxisAppearanceControl : ChartUserControl {
		RadarAxis axis;
		public RadarAxisAppearanceControl() {
			InitializeComponent();
		}
		public void Initialize(RadarAxis axis) {
			this.axis = axis;
			...
			if (axis is RadarAxisY) {
				this.txtThickness.EditValue = ((RadarAxisY)axis).Thickness;
				this.ceColor.EditValue = ((RadarAxisY)axis).Color;
			}
			UpdateControls();
		}
		public void UpdateControls() {
			this.grAppearance.Visible = this.axis is RadarAxisY;
			this.sepAppearance.Visible = this.axis is RadarAxisY;
		...
		private void ceColor_EditValueChanged(object sender, EventArgs e) {
			((RadarAxisY)this.axis).Color = (Color)this.ceColor.EditValue;
		}
		...
		private void txtThickness_EditValueChanged(object sender, EventArgs e) {
			((RadarAxisY)this.axis).Thickness = Convert.ToInt32(this.txtThickness.EditValue);
		}
	}
}
