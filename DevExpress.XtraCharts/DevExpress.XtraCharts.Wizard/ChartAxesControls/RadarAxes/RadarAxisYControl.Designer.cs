...
namespace DevExpress.XtraCharts.Wizard.ChartAxesControls {
	partial class RadarAxisYControl {
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RadarAxisYControl));
			...
			this.radarAxisYLabelControl = new DevExpress.XtraCharts.Wizard.ChartAxesControls.LabelsGeneralControl();
			...
			this.tbLabels.Controls.Add(this.radarAxisYLabelControl);
			this.tbLabels.Name = "tbLabels";
			resources.ApplyResources(this.tbLabels, "tbLabels");
			resources.ApplyResources(this.radarAxisYLabelControl, "radarAxisYLabelControl");
			this.radarAxisYLabelControl.Name = "radarAxisYLabelControl";
			resources.ApplyResources(this, "$this");
			this.Controls.Add(this.xtraTabControl);
			this.Name = "RadarAxisYControl";
		...
		private LabelsGeneralControl radarAxisYLabelControl;
