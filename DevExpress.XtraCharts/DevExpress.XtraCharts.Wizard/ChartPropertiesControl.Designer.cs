...
namespace DevExpress.XtraCharts.Wizard {
	partial class ChartPropertiesControl {
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ChartPropertiesControl));
			this.tabPanel = new DevExpress.XtraEditors.PanelControl();
			...
			this.splitter.SplitterPosition = 377;
			...
			this.Name = "ChartPropertiesControl";
		...
		#endregion
		private DevExpress.XtraEditors.PanelControl tabPanel;
	}
}
