...
namespace DevExpress.XtraCharts.Wizard.SeriesViewControls {
	partial class Doughnut3DGeneralOptionsControl {
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Doughnut3DGeneralOptionsControl));
			...
			this.pie3DOptionsControl = new DevExpress.XtraCharts.Wizard.SeriesViewControls.Pie3DGeneralOptionsControl();
			...
			resources.ApplyResources(this.pie3DOptionsControl, "pie3DOptionsControl");
			this.pie3DOptionsControl.Name = "pie3DOptionsControl";
			resources.ApplyResources(this, "$this");
			this.Controls.Add(this.pie3DOptionsControl);
			this.Controls.Add(this.sepSeparator);
			this.Controls.Add(this.doughnutOptionsControl);
			this.Name = "Doughnut3DGeneralOptionsControl";
		...
		private Pie3DGeneralOptionsControl pie3DOptionsControl;
	}
}
