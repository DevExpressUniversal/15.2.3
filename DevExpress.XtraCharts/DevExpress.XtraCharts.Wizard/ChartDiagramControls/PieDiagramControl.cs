...
namespace DevExpress.XtraCharts.Wizard.ChartDiagramControls {
	internal partial class PieDiagramControl : DiagramControlBase {
		SimpleDiagram SimpleDiagram { get { return (SimpleDiagram)base.Diagram; } }
		public PieDiagramControl() {
			InitializeComponent();
		}
		...
		protected override void Initialize(UserLookAndFeel lookAndFeel) {
			...
			marginsControl.Initialize(SimpleDiagram.Margins);
			bool isAutomaticSettingsDisabled = Chart == null || !PivotGridDataSourceUtils.HasDataSource(Chart.DataContainer.PivotGridDataSourceOptions) ||
				!Chart.DataContainer.PivotGridDataSourceOptions.AutoLayoutSettingsEnabled;
			pnlDimension.Enabled = isAutomaticSettingsDisabled;
			pnlDirection.Enabled = isAutomaticSettingsDisabled;
		}
		protected override void InitializeTags() {
			tbGeneral.Tag = DiagramPageTab.SimpleDiagramGeneral;
		}
	}
}
