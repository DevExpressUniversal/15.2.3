...
namespace DevExpress.XtraCharts.Designer.Native {
	public class DesignerFormLayout {
		const string DefaultKey = "DesignerFormLayout";
		...
		void LoadLayoutFromRegistry() {
			try {
				LoadLayout(ChartDesigner.XtraChartsRegistryPath);
				defaultSize = size;
		...
		public void SaveLayoutToRegistry() {
			if (SizeChanged || MaximizedChanged)
				SaveLayout(ChartDesigner.XtraChartsRegistryPath);
		}
	}
}
