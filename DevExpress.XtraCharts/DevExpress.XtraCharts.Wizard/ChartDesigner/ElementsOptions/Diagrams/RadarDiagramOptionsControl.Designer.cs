...
namespace DevExpress.XtraCharts.Designer.Native  {
	partial class RadarDiagramOptionsControl {
		...
		private void InitializeComponent() {
			...
			this.labelControl1.Text = "Start Angle In Degrees:";
			...
			this.labelControl2.Text = "Rotation Direction:";
			enumElementPresentation1.EnamType = typeof(DevExpress.XtraCharts.RadarDiagramRotationDirection);
			enumElementPresentation1.Name = "Counterclockwise";
			enumElementPresentation1.Value = DevExpress.XtraCharts.RadarDiagramRotationDirection.Counterclockwise;
			...
			enumElementPresentation2.EnamType = typeof(DevExpress.XtraCharts.RadarDiagramRotationDirection);
			enumElementPresentation2.Name = "Clockwise";
			enumElementPresentation2.Value = DevExpress.XtraCharts.RadarDiagramRotationDirection.Clockwise;
			...
			this.comboBoxEdit1.Tag = "RotationDirection";
			...
			this.labelControl3.Text = "Drawing Style:";
			enumElementPresentation3.EnamType = typeof(DevExpress.XtraCharts.RadarDiagramDrawingStyle);
			enumElementPresentation3.Name = "Circle";
			enumElementPresentation3.Value = DevExpress.XtraCharts.RadarDiagramDrawingStyle.Circle;
			this.comboBoxEdit2.EditValue = enumElementPresentation3;
			this.comboBoxEdit2.Location = new System.Drawing.Point(152, 93);
			this.comboBoxEdit2.Name = "comboBoxEdit2";
			this.comboBoxEdit2.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			enumElementPresentation4.EnamType = typeof(DevExpress.XtraCharts.RadarDiagramDrawingStyle);
			enumElementPresentation4.Name = "Polygon";
			enumElementPresentation4.Value = DevExpress.XtraCharts.RadarDiagramDrawingStyle.Polygon;
			...
			this.comboBoxEdit2.Tag = "DrawingStyle";
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(300, 174);
			...
			this.emptySpaceItem1.Size = new System.Drawing.Size(300, 58);
			this.emptySpaceItem1.TextSize = new System.Drawing.Size(0, 0);
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.layoutControl1);
			this.Name = "RadarDiagramOptionsControl";
			propertyLink1.Editor = this.spinEdit1;
			propertyLink1.PropertyName = "StartAngleInDegrees";
			...
			propertyLink2.PropertyName = "RotationDirection";
			propertyLink2.PropertyType = typeof(DevExpress.XtraCharts.RadarDiagramRotationDirection);
			propertyLink2.TitleControl = this.labelControl2;
			propertyLink3.Editor = this.comboBoxEdit2;
			propertyLink3.PropertyName = "DrawingStyle";
			propertyLink3.PropertyType = typeof(DevExpress.XtraCharts.RadarDiagramDrawingStyle);
