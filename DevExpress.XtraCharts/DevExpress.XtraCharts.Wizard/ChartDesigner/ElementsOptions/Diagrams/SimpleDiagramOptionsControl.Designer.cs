...
namespace DevExpress.XtraCharts.Designer.Native {
	partial class SimpleDiagramOptionsControl {
		...
		private void InitializeComponent() {
			...
			this.SuspendLayout();
			enumElementPresentation1.EnamType = typeof(DevExpress.XtraCharts.LayoutDirection);
			enumElementPresentation1.Name = "Horizontal";
			enumElementPresentation1.Value = DevExpress.XtraCharts.LayoutDirection.Horizontal;
			...
			enumElementPresentation2.EnamType = typeof(DevExpress.XtraCharts.LayoutDirection);
			enumElementPresentation2.Name = "Vertical";
			enumElementPresentation2.Value = DevExpress.XtraCharts.LayoutDirection.Vertical;
			...
			this.comboBoxEdit1.Tag = "LayoutDirection";
			...
			this.labelControl1.Text = "Layout Direction:";
			...
			this.labelControl2.Text = "Dimension:";
			this.spinEdit1.EditValue = new decimal(new int[] {
			0,
			0,
			0,
			0});
			this.spinEdit1.Location = new System.Drawing.Point(152, 67);
			...
			this.GeneralGroup.Size = new System.Drawing.Size(300, 90);
			...
			this.emptySpaceItem1.Size = new System.Drawing.Size(300, 360);
			this.emptySpaceItem1.TextSize = new System.Drawing.Size(0, 0);
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.layoutControl1);
			this.Name = "SimpleDiagramOptionsControl";
			propertyLink1.Editor = this.comboBoxEdit1;
			propertyLink1.PropertyName = "LayoutDirection";
			propertyLink1.PropertyType = typeof(DevExpress.XtraCharts.LayoutDirection);
			propertyLink1.TitleControl = this.labelControl1;
			propertyLink2.Editor = this.spinEdit1;
			propertyLink2.PropertyName = "Dimension";
