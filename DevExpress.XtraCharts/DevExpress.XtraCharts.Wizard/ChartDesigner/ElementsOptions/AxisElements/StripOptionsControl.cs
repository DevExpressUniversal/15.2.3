...
namespace DevExpress.XtraCharts.Designer.Native {
	[
	ModelBinding(typeof(StripModel)),
	DesignerSerializer("DevExpress.XtraCharts.Design.ChartItemSerializer," + AssemblyInfo.SRAssemblyChartsExtensions,
					 "System.ComponentModel.Design.Serialization.CodeDomSerializer,System.Design")
	]
	public partial class StripOptionsControl : ElementsOptionsControlBase {
		public StripOptionsControl() {
			InitializeComponent();
			AddDependence<System.Boolean>("ShowInLegend", "LegendText", visible => visible);
			AddDependence<System.Boolean>("ShowAxisLabel", "AxisLabelText", visible => visible);
			AddDependence<System.Boolean>("MinLimit.Enabled", "MinLimit.AxisValue", visible => visible);
			AddDependence<System.Boolean>("MaxLimit.Enabled", "MaxLimit.AxisValue", visible => visible);
