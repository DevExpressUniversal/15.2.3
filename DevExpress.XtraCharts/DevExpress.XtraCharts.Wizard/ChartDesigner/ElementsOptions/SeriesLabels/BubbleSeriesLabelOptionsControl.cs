...
namespace DevExpress.XtraCharts.Designer.Native {
	[
	ModelBinding(typeof(BubbleSeriesLabelModel)),
	DesignerSerializer("DevExpress.XtraCharts.Design.ChartItemSerializer," + AssemblyInfo.SRAssemblyChartsExtensions,
					 "System.ComponentModel.Design.Serialization.CodeDomSerializer,System.Design")
	]
	public partial class BubbleSeriesLabelOptionsControl : ElementsOptionsControlBase {
		new BubbleSeriesLabelModel Model { get { return (BubbleSeriesLabelModel)base.Model; } }
		public BubbleSeriesLabelOptionsControl() {
			InitializeComponent();
			...
			AddDependence<DefaultBoolean>("LabelsVisibility", "IndentFromMarker", visibility => visibility == DefaultBoolean.True);
