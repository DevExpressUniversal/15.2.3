...
namespace DevExpress.XtraCharts.Designer.Native {
	[
	ModelBinding(typeof(RangeBarSeriesLabelModel)),
	DesignerSerializer("DevExpress.XtraCharts.Design.ChartItemSerializer," + AssemblyInfo.SRAssemblyChartsExtensions,
					 "System.ComponentModel.Design.Serialization.CodeDomSerializer,System.Design")
	]
	public partial class RangeBarSeriesLabelOptionsControl : ElementsOptionsControlBase {
		new RangeBarSeriesLabelModel Model { get { return (RangeBarSeriesLabelModel)base.Model; } }
		public RangeBarSeriesLabelOptionsControl() {
			InitializeComponent();
			...
			AddDependence<DefaultBoolean>("LabelsVisibility", "Kind", visibility => visibility == DefaultBoolean.True);
			AddDependence<DefaultBoolean>("LabelsVisibility", "Position", visibility => visibility == DefaultBoolean.True);
			AddDependence<DefaultBoolean>("LabelsVisibility", "Indent", visibility => visibility == DefaultBoolean.True);
