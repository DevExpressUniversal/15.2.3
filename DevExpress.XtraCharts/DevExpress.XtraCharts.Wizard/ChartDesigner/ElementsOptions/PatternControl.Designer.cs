...
namespace DevExpress.XtraCharts.Designer.Native {
	partial class PatternControl {
		...
		private void InitializeComponent() {
			...
			this.button.Size = new System.Drawing.Size(150, 20);
			this.button.TabIndex = 0;
			this.button.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.button_ButtonClick);
		...
		#endregion
		private XtraEditors.ButtonEdit button;
	}
}
