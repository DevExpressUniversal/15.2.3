...
namespace DevExpress.XtraCharts.Designer.Native {
	partial class Funnel3DSeriesViewOptionsControl {
		...
		private void InitializeComponent() {
			...
			this.labelControl3.Text = "Point Distance:";
			...
			this.Name = "Funnel3DSeriesViewOptionsControl";
			...
			propertyLink3.PropertyName = "PointDistance";
