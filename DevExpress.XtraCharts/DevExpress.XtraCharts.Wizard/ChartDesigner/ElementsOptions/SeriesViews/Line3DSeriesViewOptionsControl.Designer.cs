...
namespace DevExpress.XtraCharts.Designer.Native {
	partial class Line3DSeriesViewOptionsControl {
		...
		private void InitializeComponent() {
			...
			this.labelControl1.Text = "Line Thickness:";
			...
			this.Name = "Line3DSeriesViewOptionsControl";
			propertyLink1.Editor = this.spinEdit1;
			propertyLink1.PropertyName = "LineThickness";
