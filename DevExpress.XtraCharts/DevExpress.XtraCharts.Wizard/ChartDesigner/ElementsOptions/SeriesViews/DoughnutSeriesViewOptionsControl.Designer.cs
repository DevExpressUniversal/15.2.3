...
namespace DevExpress.XtraCharts.Designer.Native {
	partial class DoughnutSeriesViewOptionsControl {
		...
		private void InitializeComponent() {
			...
			this.layoutControl1.Size = new System.Drawing.Size(300, 206);
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(300, 206);
			...
			this.GeneralGroup.Size = new System.Drawing.Size(300, 180);
			...
			this.labelControl1.Text = "Hole Radius Percent:";
			...
			this.labelControl2.Text = "Height To Width Ratio:";
			...
			0,
			0});
			this.spinEdit3.Location = new System.Drawing.Point(152, 105);
			...
			this.labelControl3.Text = "Min Allowed Size Percentage:";
			...
			0,
			0});
			this.spinEdit4.Location = new System.Drawing.Point(152, 131);
			this.spinEdit4.Name = "spinEdit4";
			this.spinEdit4.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "0", -1, true, true, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, null, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), serializableAppearanceObject4, "", null, null, false)});
			...
			this.labelControl4.Text = "Rotation:";
			...
			this.layoutControlItem9.Control = this.spinEdit4;
			...
			enumElementPresentation1.EnamType = typeof(DevExpress.XtraCharts.PieSweepDirection);
			enumElementPresentation1.Name = "Counterclockwise";
			enumElementPresentation1.Value = DevExpress.XtraCharts.PieSweepDirection.Counterclockwise;
			this.comboBoxEdit1.EditValue = enumElementPresentation1;
			this.comboBoxEdit1.Location = new System.Drawing.Point(152, 157);
			this.comboBoxEdit1.Name = "comboBoxEdit1";
			this.comboBoxEdit1.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			enumElementPresentation2.EnamType = typeof(DevExpress.XtraCharts.PieSweepDirection);
			enumElementPresentation2.Name = "Clockwise";
			enumElementPresentation2.Value = DevExpress.XtraCharts.PieSweepDirection.Clockwise;
			...
			this.comboBoxEdit1.Tag = "SweepDirection";
			...
			this.labelControl5.Text = "Sweep Direction:";
			...
			this.layoutControlItem11.Location = new System.Drawing.Point(150, 154);
			...
			this.Name = "DoughnutSeriesViewOptionsControl";
			propertyLink1.Editor = this.spinEdit1;
			propertyLink1.PropertyName = "HoleRadiusPercent";
			propertyLink1.PropertyType = typeof(int);
			propertyLink1.TitleControl = this.labelControl1;
			propertyLink2.Editor = this.spinEdit2;
			propertyLink2.PropertyName = "HeightToWidthRatio";
			propertyLink2.PropertyType = typeof(double);
			propertyLink2.TitleControl = this.labelControl2;
			propertyLink3.Editor = this.spinEdit3;
			propertyLink3.PropertyName = "MinAllowedSizePercentage";
			propertyLink3.PropertyType = typeof(double);
			propertyLink3.TitleControl = this.labelControl3;
			propertyLink4.Editor = this.spinEdit4;
			propertyLink4.PropertyName = "Rotation";
			...
			propertyLink5.PropertyName = "SweepDirection";
			propertyLink5.PropertyType = typeof(DevExpress.XtraCharts.PieSweepDirection);
