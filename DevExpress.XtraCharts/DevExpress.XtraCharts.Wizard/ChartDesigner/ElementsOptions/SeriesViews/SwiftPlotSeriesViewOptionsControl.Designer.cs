...
namespace DevExpress.XtraCharts.Designer.Native {
	partial class SwiftPlotSeriesViewOptionsControl {
		...
		private void InitializeComponent() {
			...
			this.swiftPlotAxisControl1 = new DevExpress.XtraCharts.Designer.Native.SwiftPlotAxisControl();
			this.labelControl2 = new DevExpress.XtraEditors.LabelControl();
			this.layoutControlItem4 = new DevExpress.XtraLayout.LayoutControlItem();
			this.layoutControlItem5 = new DevExpress.XtraLayout.LayoutControlItem();
			this.swiftPlotAxisControl2 = new DevExpress.XtraCharts.Designer.Native.SwiftPlotAxisControl();
			...
			this.layoutControl1.Controls.Add(this.swiftPlotAxisControl1);
			this.layoutControl1.Controls.Add(this.labelControl3);
			this.layoutControl1.Controls.Add(this.swiftPlotAxisControl2);
			...
			this.titleElement1.Title = "LAYOUT";
			...
			this.layoutControlItem3.Control = this.paneControl1;
			...
			this.swiftPlotAxisControl1.Axis = null;
			this.swiftPlotAxisControl1.DiagramModel = null;
			this.swiftPlotAxisControl1.IsArgumentAxis = true;
			this.swiftPlotAxisControl1.Location = new System.Drawing.Point(152, 79);
			this.swiftPlotAxisControl1.Name = "swiftPlotAxisControl1";
			this.swiftPlotAxisControl1.Size = new System.Drawing.Size(136, 20);
			this.swiftPlotAxisControl1.TabIndex = 8;
			...
			this.labelControl2.Text = "Axis X:";
			...
			this.layoutControlItem5.Control = this.swiftPlotAxisControl1;
			...
			this.swiftPlotAxisControl2.Axis = null;
			this.swiftPlotAxisControl2.DiagramModel = null;
			this.swiftPlotAxisControl2.IsArgumentAxis = false;
			this.swiftPlotAxisControl2.Location = new System.Drawing.Point(152, 105);
			this.swiftPlotAxisControl2.Name = "swiftPlotAxisControl2";
			this.swiftPlotAxisControl2.Size = new System.Drawing.Size(136, 20);
			this.swiftPlotAxisControl2.TabIndex = 10;
			...
			this.labelControl3.Text = "Axis Y:";
			...
			this.layoutControlItem7.Control = this.swiftPlotAxisControl2;
			...
			this.layoutControlGroup2.Size = new System.Drawing.Size(300, 76);
			...
			this.titleElement2.Title = "LINE STYLE";
			...
			this.labelControl4.Text = "Thickness:";
			...
			this.Name = "SwiftPlotSeriesViewOptionsControl";
		...
		"Thickness"};
			...
			propertyLink2.Editor = this.paneControl1;
			propertyLink2.PropertyName = "Pane";
			propertyLink2.PropertyType = typeof(DevExpress.XtraCharts.Designer.Native.XYDiagramPaneBaseModel);
			propertyLink2.TitleControl = this.labelControl1;
			propertyLink3.Editor = this.swiftPlotAxisControl1;
			propertyLink3.PropertyName = "AxisX";
			propertyLink3.PropertyType = typeof(DevExpress.XtraCharts.Designer.Native.SwiftPlotDiagramAxisXBaseModel);
			propertyLink3.TitleControl = this.labelControl2;
			propertyLink4.Editor = this.swiftPlotAxisControl2;
			propertyLink4.PropertyName = "AxisY";
			propertyLink4.PropertyType = typeof(DevExpress.XtraCharts.Designer.Native.SwiftPlotDiagramAxisYBaseModel);
			propertyLink4.TitleControl = this.labelControl3;
			propertyLink5.Editor = this.colorPickEdit1;
			propertyLink5.PropertyName = "Color";
		...
		private SwiftPlotAxisControl swiftPlotAxisControl1;
		private XtraEditors.LabelControl labelControl3;
		private SwiftPlotAxisControl swiftPlotAxisControl2;
