...
namespace DevExpress.XtraCharts.Wizard.SeriesLabelsControls {
	internal partial class BubbleSeriesLabelOptionsControl : ChartUserControl {
		...
		public void Initialize(BubbleSeriesLabel label, MethodInvoker updateMethod) {
			...
			spnIndent.EditValue = label.IndentFromMarker;
			UpdateControls();
		}
		void spnIndent_EditValueChanged(object sender, EventArgs e) {
			label.IndentFromMarker = Convert.ToInt32(spnIndent.EditValue);
		}
		void UpdateControls() {
