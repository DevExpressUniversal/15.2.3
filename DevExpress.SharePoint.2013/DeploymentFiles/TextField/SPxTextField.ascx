...
<%@ Register TagPrefix="spxhe"      Assembly="DevExpress.SharePoint.2013.v15.2"                                                         Namespace="DevExpress.SharePoint"  %>
<%@ Register TagPrefix="dx"       Assembly="DevExpress.Web.ASPxHtmlEditor.v15.2"                                                      Namespace="DevExpress.Web.ASPxHtmlEditor"  %>
<%@ Register TagPrefix="dx"        Assembly="DevExpress.Web.v15.2"                                                                     Namespace="DevExpress.Web"  %>
<%@ Register TagPrefix="dx"      Assembly="DevExpress.Web.ASPxSpellChecker.v15.2"                                                    Namespace="DevExpress.Web.ASPxSpellChecker"  %>
