...
namespace DevExpress.Persistent.BaseImpl.EF.StateMachine {
	[DefaultProperty("Caption")]
	[DisplayName("StateMachine Transition")]
	[ImageName("BO_Transition")]
	public class StateMachineTransition : ITransition, ITransitionUISettings, IMasterObjectInitializer {
