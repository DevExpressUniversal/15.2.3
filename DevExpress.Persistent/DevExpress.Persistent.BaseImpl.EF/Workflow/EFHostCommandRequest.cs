...
namespace DevExpress.ExpressApp.Workflow.EF {
	...
	public class EFWorkflowInstanceControlCommandRequest : EFWBaseObject, IWorkflowInstanceControlCommandRequest {
		[Browsable(false)]
		public int Id { get; protected set; }
		public string TargetWorkflowUniqueId { get; set; }
		public Guid TargetActivityInstanceId { get; set; }
		public WorkflowControlCommand Command { get; set; }
