...
namespace DevExpress.Persistent.BaseImpl.EF {
	...
	public class SecuritySystemMemberPermissionsObject : ICheckedListBoxItemsProvider, IOwnerInitializer {
		...
		public bool AllowRead {
			...
			set {
				allowRead = value;
				if(Owner != null && !Owner.IsCalledSetAssociationPermissions) {
					if(Owner.Role != null && Role.AutoAssociationPermissions) {
						Owner.IsCalledSetAssociationPermissions = true;
						Owner.Role.SetAssociationMemberPermissions(Owner, this, "Read");
					}
				}
			} 
		}
		...
		public bool AllowWrite {
			...
			set {
				...
				if(Owner != null && !Owner.IsCalledSetAssociationPermissions) {
					if(Owner.Role != null && Role.AutoAssociationPermissions) {
						Owner.IsCalledSetAssociationPermissions = true;
						Owner.Role.SetAssociationMemberPermissions(Owner, this, "Write");
					}
				}
			}
		}
