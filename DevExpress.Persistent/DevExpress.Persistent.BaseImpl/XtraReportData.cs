...
namespace DevExpress.Persistent.BaseImpl {
	...
	public class XtraReportData : XPObject, IReportDataV2Writable, IInplaceReportV2 {
		...
		public XtraReportData(Session session) : base(session) { }
		[Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
		public XtraReportData(Session session, Type dataType)
			: base(session) {
