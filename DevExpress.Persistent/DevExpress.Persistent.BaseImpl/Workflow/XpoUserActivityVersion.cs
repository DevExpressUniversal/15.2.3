...
namespace DevExpress.ExpressApp.Workflow.Versioning {
	[System.ComponentModel.DisplayName("User Activity Version")]
	public class XpoUserActivityVersion : WFBaseObject, IUserActivityVersion {
		public XpoUserActivityVersion(Session session)
			: base(session) { }
		...
		public int Version {
			...
			set { SetPropertyValue<int>("Version", value); }
		}
