...
namespace DevExpress.Xpf.Reports.UserDesigner.Native.Metadata {
	public class BarCodeGeneratorBaseMetadata : IMetadataProvider<BarCodeGeneratorBase> {
		public void BuildMetadata(MetadataBuilder<BarCodeGeneratorBase> builder) {
