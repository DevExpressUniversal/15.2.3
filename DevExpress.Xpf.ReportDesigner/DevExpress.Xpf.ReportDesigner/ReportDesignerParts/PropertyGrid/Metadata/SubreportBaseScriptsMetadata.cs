...
namespace DevExpress.Xpf.Reports.UserDesigner.Native.Metadata {
	public class SubreportBaseScriptsMetadata : IMetadataProvider<SubreportBaseScripts> {
		public void BuildMetadata(MetadataBuilder<SubreportBaseScripts> builder) {
