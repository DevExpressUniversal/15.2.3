...
namespace DevExpress.Xpf.Reports.UserDesigner.Native.Metadata {
	public class XRTableOfContentsTitleMetadata : IMetadataProvider<XRTableOfContentsTitle> {
		public void BuildMetadata(MetadataBuilder<XRTableOfContentsTitle> builder) {
