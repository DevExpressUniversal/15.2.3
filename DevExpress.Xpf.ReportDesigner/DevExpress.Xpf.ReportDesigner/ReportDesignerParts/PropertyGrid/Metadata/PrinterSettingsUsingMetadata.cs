...
namespace DevExpress.Xpf.Reports.UserDesigner.Native.Metadata {
	public class PrinterSettingsUsingMetadata : IMetadataProvider<PrinterSettingsUsing> {
		public void BuildMetadata(MetadataBuilder<PrinterSettingsUsing> builder) {
