...
namespace DevExpress.Xpf.Reports.UserDesigner.Native.Metadata {
	public class XRControlXRControlStylesMetadata : IMetadataProvider<XRControl.XRControlStyles> {
		public void BuildMetadata(MetadataBuilder<XRControl.XRControlStyles> builder) {
