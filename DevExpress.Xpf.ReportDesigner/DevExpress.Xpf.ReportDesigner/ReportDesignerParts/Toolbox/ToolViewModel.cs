...
namespace DevExpress.Xpf.Reports.UserDesigner.Toolbox {
	public class ToolViewModel : ImmutableObject {
		public ToolViewModel(IXRTool tool, ImageSource icon) {
			Guard.ArgumentNotNull(tool, "tool");
			this.tool = tool.Tool;
			this.diagram = tool.Diagram;
			this.icon = icon;
		}
		readonly DiagramTool tool;
		public DiagramTool Tool { get { return tool; } }
		readonly ImageSource icon;
		public ImageSource Icon { get { return icon; } }
		readonly XRDiagramControl diagram;
		public XRDiagramControl Diagram { get { return diagram; } }
	}
}
