...
namespace DevExpress.Xpf.Reports.UserDesigner.ReportWizard.Pages {
	[POCOViewModel]
	public class ChooseObjectMemberPageEx : ChooseObjectMemberPage {
		public static new ChooseObjectMemberPage Create(DataSourceWizardModelBase model) {
			return ViewModelSource.Create(() => new ChooseObjectMemberPageEx(model));
		}
		bool canChooseColumns = false;
		protected ChooseObjectMemberPageEx(DataSourceWizardModelBase model) : base(model) { }
		public override bool CanFinish {
			get { return base.CanFinish; }
			protected set { canChooseColumns = true; }
		}
