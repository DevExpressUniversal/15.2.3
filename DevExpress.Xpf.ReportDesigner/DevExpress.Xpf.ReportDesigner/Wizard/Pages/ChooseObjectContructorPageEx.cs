...
namespace DevExpress.Xpf.Reports.UserDesigner.ReportWizard.Pages {
	public class ChooseObjectConstructorPageEx : ChooseObjectConstructorPage {
		public static new ChooseObjectConstructorPage Create(DataSourceWizardModelBase model) {
			return ViewModelSource.Create(() => new ChooseObjectConstructorPageEx(model));
		}
		bool canChooseColumns = false;
		protected ChooseObjectConstructorPageEx(DataSourceWizardModelBase model) : base(model) { }
