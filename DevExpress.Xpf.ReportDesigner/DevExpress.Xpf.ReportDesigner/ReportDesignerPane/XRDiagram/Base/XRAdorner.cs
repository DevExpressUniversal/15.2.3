...
namespace DevExpress.Xpf.Reports.UserDesigner.XRDiagram {
	public class XRAdorner : Control {
		public static readonly DependencyProperty DiagramItemProperty;
		static XRAdorner() {
			DependencyPropertyRegistrator<XRAdorner>.New()
				.Register(d => d.DiagramItem, out DiagramItemProperty, null)
				.OverrideDefaultStyleKey()
			;
		}
		public XRAdorner(DiagramItem item) {
			AdornerLayer.SetForceBoundsRounding(this, true);
			DiagramItem = item;
		}
		public DiagramItem DiagramItem {
			get { return (DiagramItem)GetValue(DiagramItemProperty); }
			set { SetValue(DiagramItemProperty, value); }
		}
		public bool ShowBorders {
			get { return XRDiagramItemBase.GetShowBorders(DiagramItem); }
		}
		public bool ShowBindingIcon {
			get { return XRDiagramItemBase.GetShowBindingIcon(DiagramItem); }
		}
	}
}
