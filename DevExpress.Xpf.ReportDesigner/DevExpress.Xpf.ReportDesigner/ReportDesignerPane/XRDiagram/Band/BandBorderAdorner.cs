...
namespace DevExpress.Xpf.Reports.UserDesigner.XRDiagram {
	public class BandBorderAdorner : Control<BandBorderAdorner> {
		public static readonly DependencyProperty DiagramItemProperty;
		static BandBorderAdorner() {
			DependencyPropertyRegistrator<BandBorderAdorner>.New()
				.Register(d => d.DiagramItem, out DiagramItemProperty, null);
		}
		public BandBorderAdorner(DiagramItem diagramItem) {
			XRDiagramControl diagram = diagramItem.GetXRDiagram();
