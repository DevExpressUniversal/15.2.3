...
namespace DevExpress.Xpf.Reports.UserDesigner.XRDiagram {
	public class BandMarginAdorner : Control<BandMarginAdorner> {
		public static readonly DependencyProperty DiagramItemProperty;
		static BandMarginAdorner() {
			DependencyPropertyRegistrator<BandMarginAdorner>.New()
		...
		public BandMarginAdorner(BandDiagramItem diagramItem) {
		...
		public static double GetMarginWidth(Thickness margin) {
			return -margin.Left;
		}
	}
}
