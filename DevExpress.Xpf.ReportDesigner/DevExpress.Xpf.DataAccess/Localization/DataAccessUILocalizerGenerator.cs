...
namespace DevExpress.DataAccess.UI.Localization {
	...
	public partial class DataAccessUILocalizer {
		void AddStrings() {
			...
			AddString(DataAccessUIStringId.WizardPageChooseObjectBindingMode_RetrieveSchemaDescription, "Only the data source schema is retrieved from the specified object, without feeding the actual data to the report until it is published.\r\n\r\nTo manually retrieve the actual data, create a data source object’s instance in code and assign it to the ObjectDataSource.DataSource property or directly to the DataSource property of the report.");
