...
namespace DevExpress.Office.Internal {
	#region ImageImportHelper
	public abstract class ImageImportHelper : ImportHelper<OfficeImageFormat, OfficeImage> {
		protected ImageImportHelper(IDocumentModel documentModel)
			: base(documentModel) {
		}
		protected internal override OfficeImageFormat UndefinedFormat { get { return OfficeImageFormat.None; } }
		protected internal override OfficeImageFormat FallbackFormat { get { return UndefinedFormat; } }
