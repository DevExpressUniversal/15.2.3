...
namespace DevExpress.Office.NumberConverters {
	#region AlphabetBasedNumberConverter (abstract class)
	public abstract class AlphabetBasedNumberConverter : OrdinalBasedNumberConverter {
		...
		protected internal override long MaxValue { get { return 780; } }
		...
		public override string ConvertNumberCore(long value) {
			if (value == 0)
				return String.Empty;
			value--;
			int count = (int)value / AlphabetSize + 1;
			char symbol = Alphabet[value % AlphabetSize];
