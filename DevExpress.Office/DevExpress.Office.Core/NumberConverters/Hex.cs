...
namespace DevExpress.Office.NumberConverters {
	...
	public class HexNumberConverter : OrdinalBasedNumberConverter {
		...
		protected internal override NumberingFormat Type { get { return NumberingFormat.Hex; } }
		public override string ConvertNumberCore(long value) {
			StringBuilder result = new StringBuilder();
			while (value != 0) {
#if SL
				result.Insert(0, new String(hexdigit[value % 16], 1));
#else
				result.Insert(0, hexdigit[value % 16]);
#endif
				value = value >> 4;
			}
