...
namespace DevExpress.Xpf.TreeMap {
	public class PredefinedPalette : PaletteBase {
	...
	public class Office2016Palette : PredefinedPalette {
		public override string PaletteName { get { return "Office 2016"; } }
		public Office2016Palette()
			: base(new Color[] {
			Color.FromArgb(0xFF,  98, 157, 209),
			Color.FromArgb(0xFF,  44,  61, 103),
			Color.FromArgb(0xFF, 157, 144, 160),
			Color.FromArgb(0xFF, 127, 143, 169),
			Color.FromArgb(0xFF,  42,  95, 142),
			Color.FromArgb(0xFF,  90, 162, 174),
			Color.FromArgb(0xFF,  74, 102, 172),
			Color.FromArgb(0xFF,  41, 127, 213) }) {
		}
	}
	public class DXTreeMapPalette : PredefinedPalette {
		public override string PaletteName { get { return "DX Tree Map"; } }
		public DXTreeMapPalette()
			: base(new Color[] {
